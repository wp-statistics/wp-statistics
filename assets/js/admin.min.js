...
wps_js.exist_tag=function(e){return jQuery(e).length},wps_js.date_picker=function(){var e=jQuery("input[data-wps-date-picker]");e.length&&(e.daterangepicker({singleDatePicker:!0,showDropdowns:!0,minYear:1998,drops:"up",opens:document.getElementById("TB_window")?"center":"right",maxYear:parseInt((new Date).getFullYear()+1),locale:{format:"YYYY-MM-DD"}}),e.on("show.daterangepicker",function(e,t){t=t.container;jQuery(t).addClass(e.target.className)}))},wps_js.formatNumber=function(e,t=0){if(null===e)return null;if(0===e)return"0";t=!t||t<0?0:t;var o=parseInt(e).toPrecision(2).split("e"),o=1===o.length?0:Math.floor(Math.min(o[1].slice(1),14)/3),e=o<1?e.toFixed(0+t):(e/Math.pow(10,3*o)).toFixed(1+t);return(e<0?e:Math.abs(e))+["","K","M","B","T"][o]},wps_js.select2=function(){jQuery("select[data-type-show=select2]").select2()};const wpsSelect2=jQuery(".wps-select2"),wpsBody=jQuery("body"),wpsDropdown=jQuery(".wps-dropdown");if(wpsSelect2.length){const m=jQuery(".wps-filter-page"),n=jQuery(".wps-filter-visitor"),o=wpsBody.hasClass("rtl")?"rtl":"ltr",p=m.length?m:n,q=(e,a)=>{wpsSelect2.select2({dropdownParent:e,dir:o,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown",minimumInputLength:1,ajax:{delay:500,url:wps_js.global.ajax_url,dataType:"json",data:function(e){var t,e={wps_nonce:wps_js.global.rest_api_nonce,search:e.term,action:a,paged:e.page||1};return wps_js.isset(wps_js.global,"request_params")&&((t=wps_js.global.request_params).author_id&&(e.author_id=t.author_id),t.page&&(e.page=t.page),t.pt&&(e.post_type=t.pt),t.pid)&&(e.post_id=t.pid),e},processResults:function(e){return e&&Array.isArray(e.results)?{results:e.results.map(e=>({id:e.id,text:e.text})),pagination:{more:!1}}:(console.error("Expected an array of results but got:",e),{results:[]})},error:function(e,t,o){console.error("AJAX request error:",t,o)}}})};wpsSelect2.select2({dropdownParent:p,dir:o,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown"}),wpsSelect2.on("select2:open",()=>wpsDropdown.addClass("active")),wpsSelect2.on("select2:close",()=>wpsDropdown.removeClass("active")),wpsSelect2.on("change",function(){var e=jQuery(this).find("option:selected").val();e&&(window.location.href=e)}),m.length&&(q(m,"wp_statistics_get_page_filter_items"),m.on("click",()=>wpsSelect2.select2("open"))),n.length&&(q(n,"wp_statistics_search_visitors"),n.on("click",()=>wpsSelect2.select2("open")))}wps_js.tooltip=function(){jQuery(".wps-tooltip").tooltipster({theme:"tooltipster-flat",contentCloning:!0}),jQuery("body").on("mouseenter touchstart",".wps-tooltip:not(.tooltipstered)",function(){$(this).tooltipster({theme:"tooltipster-flat"}).tooltipster("open")})},wps_js.tooltip(),wps_js.redirect=function(e){window.location.replace(e)},wps_js.line_chart=function(e,t,o,a,r){e=document.getElementById(e).getContext("2d"),wps_js.is_active("rtl")&&(Chart.defaults.global={defaultFontFamily:"Tahoma"}),o={type:"line",data:{labels:o,datasets:a},options:{responsive:!0,legend:{position:"bottom"},animation:{duration:1500},title:{display:!0,text:t},tooltips:{mode:"index",intersect:!1},interaction:{intersect:!1,mode:"index"},scales:{y:{ticks:{stepSize:1}}},plugins:{zoom:{pan:{enabled:!0,mode:"xy"},zoom:{wheel:{enabled:!0,speed:.05,modifierKey:"ctrl"},pinch:{enabled:!0},mode:"xy"}}}}},a=Object.assign({},o,r);new Chart(e,a)},wps_js.pie_chart=function(e,t,o,a=!1,r=!1){e=document.getElementById(e).getContext("2d");wps_js.is_active("rtl")&&(Chart.defaults.global={defaultFontFamily:"Tahoma"}),!1===a&&(a=function(e){return e.formattedValue}),!1===r&&(r=function(e){return e.label}),new Chart(e,{type:"pie",data:{labels:t,datasets:o},options:{responsive:!0,plugins:{legend:{position:function(e){return 400<e.chart.width?"left":"top"}},tooltip:{enable:!0,callbacks:{label:a,title:r}}},animation:{duration:1500}},plugins:[{afterDraw:function(e){var t,o,a;!0===e.data.datasets[0].data.every(e=>0==e)&&(t=e.ctx,o=e.width,a=e.height,e.clear(),t.save(),t.textAlign="center",t.textBaseline="middle",t.font="14px normal 'Tahoma'",t.fillText(wps_js._("no_data"),o/2,a/2),t.restore())}}]})},wps_js.horizontal_bar=function(e,o,a,r){e=document.getElementById(e);if(e){var t=e.parentNode,n=e.nextSibling,i=(t.removeChild(e),a.reduce((e,t)=>e+t,0)),s=document.createElement("div");s.classList.add("wps-horizontal-bar");for(let t=0;t<a.length;t++){var l=i?a[t]/i*100:0;let e=l%1==0?l.toFixed(0):l.toFixed(1);e.endsWith(".0")&&(e=e.slice(0,-2));var d=document.createElement("div"),c=(d.classList.add("wps-horizontal-bar__item"),document.createElement("div")),p=(c.classList.add("wps-horizontal-bar__label-image-container"),r&&r[t]&&"undefined"!==r[t]&&((p=document.createElement("img")).src=r[t],p.alt=o[t],p.classList.add("wps-horizontal-bar__image"),c.appendChild(p)),document.createElement("div")),c=(p.innerHTML=o[t],p.setAttribute("title",o[t]),p.classList.add("wps-horizontal-bar__label"),c.appendChild(p),d.appendChild(c),document.createElement("div")),u=(c.classList.add("wps-horizontal-bar__data-percent-container"),document.createElement("div")),u=(u.innerHTML=`<span>${wps_js.formatNumber(a[t])}</span><span>${e}%</span>`,u.classList.add("wps-horizontal-bar__data"),c.appendChild(u),d.appendChild(c),document.createElement("div"));u.classList.add("wps-horizontal-bar__background"),u.style.width=l+"%",d.appendChild(u),s.appendChild(d)}n?t.insertBefore(s,n):t.appendChild(s)}},wps_js.chart_id=function(e){return"wp-statistics-"+e+"-meta-box-chart"},wps_js.random_color=function(e=!1){var t=[[243,156,18,"#f39c12"],[52,152,219,"#3498db"],[192,57,43,"#c0392b"],[155,89,182,"#9b59b6"],[39,174,96,"#27ae60"],[230,126,34,"#e67e22"],[142,68,173,"#8e44ad"],[46,204,113,"#2ecc71"],[41,128,185,"#2980b9"],[22,160,133,"#16a085"],[211,84,0,"#d35400"],[44,62,80,"#2c3e50"],[241,196,15,"#f1c40f"],[231,76,60,"#e74c3c"],[26,188,156,"#1abc9c"],[46,204,113,"#2ecc71"],[52,152,219,"#3498db"],[155,89,182,"#9b59b6"],[52,73,94,"#34495e"],[22,160,133,"#16a085"],[39,174,96,"#27ae60"],[44,62,80,"#2c3e50"],[241,196,15,"#f1c40f"],[230,126,34,"#e67e22"],[231,76,60,"#e74c3c"],[236,240,241,"#9b9e9f"],[149,165,166,"#a65d20"]];return t[!1===e?Math.floor(Math.random()*t.length):e]},wps_js.wordpress_postbox_ajax=function(e="enable"){var t=jQuery(".postbox .hndle, .postbox .handlediv");"enable"===e?t.on("click",window.postboxes.handle_click):t.off("click",window.postboxes.handle_click)},wps_js.isset=function(t){var o=Array.prototype.slice.call(arguments,1);for(let e=0;e<o.length;e++){if(!t||!t.hasOwnProperty(o[e]))return!1;t=t[o[e]]}return!0},wps_js.number_format=function(e,t,o,a){var r;if(null!=e&&isFinite(e))return t||(t=1<(r=e.toString().split(".").length)?r:0),o=o||".",a=a||",",(r=(e=(e=parseFloat(e).toFixed(t)).replace(".",o)).split(o))[0]=r[0].replace(/\B(?=(\d{3})+(?!\d))/g,a),r.join(o);throw new TypeError("number is not valid")},wps_js.set_equal_height=function(e,t){var o=jQuery(e).height(),a=jQuery(t).height();let r=t,n=o;o<a&&(r=e,n=a),jQuery(r).css("height",n+"px")},wps_js.Create_Half_PostBox=function(e,t){return`<div class="postbox-container wps-postbox-half ${e}"><div class="metabox-holder"><div class="meta-box-sortables"> <div class="postbox" id="${t}"> <div class="inside"></div></div></div></div></div>`},wps_js.isIP=function(e){var t="(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]?|0)";return new RegExp(`^${t}\\.${t}\\.${t}\\.${t}$`).test(e)},wps_js.getLinkParams=function(e,t=!1){t=(t=t||window.location.href).match(new RegExp("(?:[?&]"+e+"=)([^&]+)"));return t?t[1]:null},wps_js.sum=function(e){return e.reduce(function(e,t){return e+t},0)},wps_js.no_results=function(){return'<div class="o-wrap o-wrap--no-data wps-center">'+wps_js._("no_result")+"</div>"},wps_js.hex_to_rgba=function(e,t){e=e.replace("#","");var o=parseInt(e.substring(0,2),16),a=parseInt(e.substring(2,4),16),e=parseInt(e.substring(4,6),16);return wps_js.rgba_to_hex(o,a,e,t)},wps_js.rgba_to_hex=function(e,t,o,a){return"#"+e.toString(16).padStart(2,"0")+t.toString(16).padStart(2,"0")+o.toString(16).padStart(2,"0")+Math.round(255*a).toString(16).padStart(2,"0")};const getOrCreateTooltip=e=>{let t=e.canvas.parentNode.querySelector("div");var o;return t||((t=document.createElement("div")).classList.add("wps-chart-tooltip"),t.style.opacity=1,t.style.pointerEvents="none",t.style.position="absolute",t.style.transition="all .1s ease",(o=document.createElement("table")).style.margin="0px",t.appendChild(o),e.canvas.parentNode.appendChild(t)),t},externalTooltipHandler=(o,e,t,n)=>{var{chart:o,tooltip:a}=o,i=getOrCreateTooltip(o);if(0===a.opacity)i.style.opacity=0;else if(a.body){var s=a.title||[];const h=a.dataPoints[0].dataIndex;var l=o.data.datasets;let r="<div>";s.forEach(e=>{var{date:t,day:o}=(n.data||n).labels[h];r+=`<div class="chart-title">${t} (${o})</div>`}),l.forEach((e,t)=>{var o=e.data[h],a=e.label.includes("(Previous)");a||(r+=`
                <div class="current-data">
                    <div>
                        <span class="current-data__color" style="background-color: ${e.hoverPointBackgroundColor};"></span>
                        ${e.label}
                    </div>
                    <span class="current-data__value">${o.toLocaleString()}</span>
                </div>`),n?.previousData&&void 0!==(o=n.previousData[e.label.replace(" (Previous)","")]?.[h])&&""!==o&&!a&&(a=n.previousData.labels[h].date,r+=`
                    <div class="previous-data">
                        ...
                        <span class="previous-data__value"> ${o.toLocaleString()}</span>
                    </div>`)}),r+="</div>",i.innerHTML=r;var{offsetLeft:s,offsetTop:l,clientWidth:o,clientHeight:d}=o.canvas,{caretX:a,caretY:c}=a,p=i.offsetWidth,u=i.offsetHeight;let e=s+a+16,t=l+c-u/2;(e=e+p+16>s+o?s+a-p-16:e)<s+16&&(e=s+16),(t=t<l+16?l+16:t)+u+16>l+d&&(t=l+d-u-16),i.style.opacity=1,i.style.left=e+"px",i.style.top=t+"px"}},drawVerticalLinePlugin={id:"drawVerticalLine",beforeDatasetDraw(e){var{ctx:e,scales:{},tooltip:t,chartArea:{top:o,bottom:a}}=e;t&&t._active&&t._active.length&&(t=t._active[0].element.x,e.beginPath(),e.strokeStyle="#A9AAAE",e.lineWidth=1,e.setLineDash([6,6]),e.moveTo(t,o),e.lineTo(t,a),e.stroke(),e.setLineDash([]))}};function moveFeedbackBird(){var e=window.outerWidth||document.documentElement.clientWidth,t=document.getElementById("feedback-bird-app"),o=document.querySelector(".c-fbb-widget__header__title"),a=document.querySelector(".wps-mobileMenuContent .wps-bundle"),r=document.querySelector(".wps-adminHeader__side");t&&document.body.classList.contains("wps_page")&&(e<=1030?(e=t.parentNode.removeChild(t),a.parentNode.insertBefore(e,a)):(e=t.parentNode.removeChild(t),r.appendChild(e)),t.style.display="block",t.setAttribute("title",o.innerHTML))}wps_js.new_line_chart=function(s,e,t){let o={Total:"#27A765",views:"#7362BF",visitors:"#3288D7",Other1:"#3288D7",Other2:"#7362BF",Other3:"#8AC3D0"};var a=document.getElementById(e).getContext("2d"),r=null!==document.getElementById(e).closest("#dashboard-widgets");const n=[];Object.keys(s.data).forEach((e,t)=>{"labels"!==e&&(t=o[e]||o["Other"+t],n.push({type:"line",cubicInterpolationMode:"monotone",label:e,data:s.data[e],borderColor:t,backgroundColor:t,fill:!1,yAxisID:"y",borderWidth:2,pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:t,pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:t,hoverPointBorderWidth:4}),s.previousData[e])&&n.push({type:"line",cubicInterpolationMode:"monotone",label:e+" (Previous)",data:s.previousData[e],borderColor:wps_js.hex_to_rgba(t,.7),hoverBorderColor:t,backgroundColor:t,fill:!1,yAxisID:"y",borderWidth:1,borderDash:[5,5],pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:t,pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:t,hoverPointBorderWidth:4})});r={interaction:{intersect:!1,mode:"index"},plugins:{legend:!1,tooltip:{enabled:!1,external:e=>externalTooltipHandler(e,n,o,s),callbacks:{title:e=>e[0].label,label:e=>e.formattedValue}}},scales:{x:{offset:s.data.labels.map(e=>e.date).length<=1,min:0,grid:{display:!1,drawBorder:!1,tickLength:0,drawTicks:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:r?5:9,fontColor:"#898A8E",fontStyle:"italic",fontWeight:"lighter ",fontSize:13,padding:8,fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',lineHeight:15}},y:{min:0,ticks:{maxTicksLimit:r?4:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15},border:{color:"transparent",width:0},type:"linear",position:"right",grid:{display:!0,tickMarkLength:0,drawBorder:!1,tickColor:"#EEEFF1",color:"#EEEFF1"},gridLines:{drawTicks:!1},title:{display:!1}}}},r=Object.assign({},r,t);const l=new Chart(a,{type:"line",data:{labels:s.data.labels.map(e=>e.date),datasets:n},plugins:[drawVerticalLinePlugin],options:r});{const d=document.getElementById(e).parentElement.parentElement.querySelector(".wps-postbox-chart--items");d&&(d.innerHTML="",n.sort((e,t)=>"Total"===e.label?-1:"Total"===t.label?1:"Total (Previous)"===e.label?-1:"Total (Previous)"===t.label?1:0),n.forEach((e,t)=>{if(!e.label.includes("(Previous)")){var o=e.data.reduce((e,t)=>Number(e)+Number(t),0),a=s.previousData[e.label]?s.previousData[e.label].reduce((e,t)=>Number(e)+Number(t),0):null,r=document.createElement("div"),a=(r.className="wps-postbox-chart--item",null!==a?`
            <div class="previous-data">
                <span>
                    <span class="wps-postbox-chart--item--color" style="border-color: ${e.borderColor}"></span>
                    <span class="wps-postbox-chart--item--color" style="border-color: ${e.borderColor}"></span>
                </span>
                ${a.toLocaleString()}
            </div>`:"");r.innerHTML=`
            ...
            <div>
                ...
                ${a}
            </div>`;const n=r.querySelector(".current-data"),i=(n.addEventListener("click",function(){var e=l.getDatasetMeta(t);e.hidden=!e.hidden,n.classList.toggle("wps-line-through"),l.update()}),r.querySelector(".previous-data"));i&&i.addEventListener("click",function(){var e=l.getDatasetMeta(t+1);e&&e.label.includes("(Previous)")&&(i.classList.toggle("wps-line-through"),e.hidden=!e.hidden),l.update()}),d.appendChild(r)}}))}},wps_js.performance_chart=function(t,e,o){const a=["#3288D7","#7362BF","#8AC3D0"];var r="content-single"===o,e=document.getElementById(e).getContext("2d");let n=[{type:"line",cubicInterpolationMode:"monotone",label:wps_js._("visits"),data:t.views,borderColor:wps_js.hex_to_rgba(a[1],.8),pointStyle:"circle",yAxisID:"y",borderWidth:2,pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:a[1],pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:a[1],hoverPointBorderWidth:4},{type:"line",cubicInterpolationMode:"monotone",label:wps_js._("visitors"),data:t.visitors,borderColor:wps_js.hex_to_rgba(a[0],.8),yAxisID:"y",borderWidth:2,pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:a[0],pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:a[0],hoverPointBorderWidth:4}];r||n.push({type:"bar",label:"content"===o?wps_js._("published")+" Posts":wps_js._("published")+" Contents",data:t.posts,backgroundColor:wps_js.hex_to_rgba(a[2],.5),hoverBackgroundColor:a[2],hoverPointBackgroundColor:a[2],yAxisID:"y1"});var i,s={x:{offset:!r,ticks:{maxTicksLimit:9,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15},border:{color:"transparent",width:0},grid:{display:!1,drawBorder:!1,tickLength:0}},y:{border:{color:"transparent",width:0},ticks:{maxTicksLimit:9,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15},type:"linear",position:r?"left":"right",grid:{display:!0,borderDash:[5,5],tickColor:"#EEEFF1",color:"#EEEFF1"},title:{display:!0,text:wps_js._("visits"),color:"#898A8E",fontSize:13}}},r=(r||(s.y1={type:"linear",position:"left",border:{color:"transparent",width:0},grid:{display:!1,drawBorder:!1,tickLength:0},ticks:{maxTicksLimit:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15},title:{display:!0,text:"content"===o?wps_js._("published")+" Posts":wps_js._("published")+" Contents",color:"#898A8E",fontSize:13}}),new Chart(e,{type:"bar",data:{labels:t.labels.map(e=>e.date),datasets:n},options:{interaction:{intersect:!1},plugins:{legend:!1,tooltip:{enabled:!1,external:e=>externalTooltipHandler(e,n,a,t),callbacks:{title:e=>e[0].label,label:e=>e.formattedValue}}},scales:s},plugins:[drawVerticalLinePlugin]}));i=r,document.querySelectorAll(".js-wps-performance-chart__item").forEach((t,o)=>{t.addEventListener("click",()=>{var e=i.data.datasets[o];e.hidden=!e.hidden,i.update(),t.classList.toggle("hidden",e.hidden)})})},jQuery(document).ready(function(){var e=document.querySelectorAll(".wps-head-filters__item"),t=(e.forEach(function(o){o.classList.remove("loading"),o.addEventListener("click",function(e){var t=o.querySelector(".dropdown-content");t&&t.classList.toggle("show")})}),jQuery(".wps-search-dropdown"));t.on("click",function(e){e.stopPropagation()}),t.on("input",function(){let e=jQuery(this).val().toLowerCase();jQuery(this).parent().find(".dropdown-item").each(function(){-1<(jQuery(this).text()||jQuery(this).innerText).toLowerCase().indexOf(e)?jQuery(this).show():jQuery(this).hide()})}),window.addEventListener("click",function(o){e.forEach(function(e){var t=e.querySelector(".dropdown-content");t&&!e.contains(o.target)&&t.classList.remove("show")})})}),jQuery(document).ready(function(){var e=document.querySelector(".wp-header-end"),t=document.querySelector(".notice.notice-warning.update-nag");e&&t&&e.parentNode.insertBefore(t,e.nextSibling),jQuery(document).on("click",".wps-privacy-list__item .wps-privacy-list__title",e=>{var t=jQuery(e.currentTarget),o=t.siblings(".wps-privacy-list__content");jQuery(e.target).is(".wps-privacy-list__button")||(t.toggleClass("open"),o.hasClass("show")?o.removeClass("show"):o.addClass("show"))})}),window.onload=moveFeedbackBird,window.addEventListener("resize",moveFeedbackBird),jQuery(document).ready(function(){var e=document.querySelector(".wp-header-end"),t=document.querySelector(".notice.notice-warning.update-nag");e&&t&&e.parentNode.insertBefore(t,e.nextSibling)});
...
wps_js.countries_meta_box={view:function(t=[]){let l="",a=(l+=`<div class="o-table-wrapper"><table width="100%" class="o-table o-table--layout-fixed o-table--link table-stats wps-report-table"><tbody>
        <tr>
             <td>${wps_js._("country")}</td>
            <td>${wps_js._("visitor_count")}</td>
        </tr>`,1);return t.countries.forEach(function(t){l+=`<tr>
 			<td><img src="${t.flag}" title="${t.name}" alt="${t.name}" class="wps-flag wps-flag--first"/> ${t.name}</td>
			<td><a href="${t.link}" title="${t.name}" target="_blank">${wps_js.number_format(t.number)} <svg style="margin-top: 3px;" width="10" height="10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
wps_js.pages_meta_box={view:function(s=[]){let t="";t+=`<div class="o-table-wrapper"><table width="100%" class="o-table wps-new-table o-table--pages ">
        <thead>
            <tr>
        ...
        <tbody> `;wps_js.global.admin_url.replace("/wp-admin/","");let a=1;return s.pages.forEach(function(s){t+=`<tr>
			<td class="wps-pd-l"><div class="wps-ellipsis-parent" title="${s.title}"><span class="wps-ellipsis-text">${s.title}</span></div></td>
			<td class="wps-pd-l"><a href="${s.hits_page}">${s.number}</a></td>
		    <td class="wps-pd-l"><a target="_blank" class="wps-view-content" href="${s.link}">${wps_js._("view_content")}</a></td>
			</tr>`,a++}),t+="</tbody></table></div>"}};
...
wps_js.post_summary_meta_box={params:function(){return{ID:wps_js.global.page.ID}},view:function(t=[]){var a=void 0!==t.summary.postChartData&&null!==t.summary.postChartData&&Object.keys(t.summary.postChartData).length?'<div class="c-wps-post-summary-panel-chart"><canvas id="'+wps_js.chart_id("post_summary")+'" height="100"></canvas></div>':"";return t.hasOwnProperty("content")?'<div class="wps-center" style="padding: 15px;"> '+t.content+"</div>":'<p class="wps-wrap wps-meta-box-header">'+t.output+a},meta_box_init:function(t=[]){t.hasOwnProperty("content")?jQuery("#"+wps_js.getMetaBoxKey("post_summary")+" button[onclick]").remove():void 0!==t.summary.postChartData&&null!==t.summary.postChartData&&Object.keys(t.summary.postChartData).length&&this.post_summary_chart(wps_js.chart_id("post_summary"),t.summary)},post_summary_chart:function(t,a=[]){let e=a.postChartData;let s="Visitors",o="#A5AAEA",r="#2C36D7",i;void 0!==a.postChartSettings&&null!==a.postChartSettings&&((a=a.postChartSettings).color&&(o=a.color),a.border&&(r=a.border),a.label)&&(s=a.label);var a={animation:!1,responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{enabled:!1,displayColors:!1,position:"nearest",intersect:!1,external:a=>{var{chart:a,tooltip:s}=a;let o=a.canvas.parentNode.querySelector("div");if(o||((o=document.createElement("div")).classList.add("c-wps-mini-chart-post-summary-tooltip"),a.canvas.parentNode.appendChild(o)),0===s.opacity)o.style.opacity=0;else if(s.body){var r=s.title||[],i=s.body.map(t=>t.lines);let e="<div>";r.forEach(t=>{e+=`<div class="chart-title">${t}</div>`}),i.forEach((t,a)=>{t=t.join(": ");e+=`<div>${t}</div>`}),o.innerHTML=e;var{offsetLeft:r,offsetTop:a,offsetWidth:n,offsetHeight:l}=a.canvas,i=(o.style.opacity=0===i[0].length?0:1,o.offsetWidth);let t=r+s.caretX-i/2;s=a+l;(t=t<r?r:t)+i>r+n&&(t=r+n-i),o.style.left=t+"px",o.style.top=s+"px"}},callbacks:{title:t=>e[t[0].label].fullDate,label:t=>{t=t.formattedValue;return`<div class="content-itemss"> <div class="content-item"><span>${s}</span> <span>${t}</span></div>`}}}},scales:{x:{offset:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:4,fontColor:"#898A8E",fontSize:12,padding:5}},y:{position:"right",beginAtZero:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:5,fontColor:"#898A8E",fontSize:12,padding:8,stepSize:1}}},layout:{padding:{left:0,right:0,top:0,bottom:0}}},t=jQuery("#"+t)[0].getContext("2d"),n=Object.entries(e).map(([,t])=>t.hits),l=n.length<=30?"bar":"line";"line"==l&&((i=t.createLinearGradient(0,0,0,t.canvas.height-10)).addColorStop(0,wps_js.hex_to_rgba(o,1)),i.addColorStop(.5,wps_js.hex_to_rgba(o,.25)),i.addColorStop(.75,wps_js.hex_to_rgba(o,0)),i.addColorStop(1,wps_js.hex_to_rgba(o,0)));new Chart(t,{type:l,data:{labels:Object.entries(e).map(([t])=>t),datasets:[{data:n,backgroundColor:"line"==l?i:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":wps_js.hex_to_rgba(o,.5)}),hoverBackgroundColor:"line"==l?i:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":o}),pointBackgroundColor:r,fill:"line"==l,barPercentage:.9,categoryPercentage:1,tension:.5,minBarLength:1,borderWidth:"line"==l?1:0,pointRadius:"line"==l?0:void 0,pointHoverRadius:"line"==l?5:void 0,borderColor:r}]},options:a})}};
...
wps_js.recent_meta_box={view:function(t=[]){let e="";return e=(e+='<div class="o-table-wrapper">')+(`<table width="100%" class="o-table o-table--visitors"><thead>
        ...
        </tr></thead><tbody>`),t.forEach(function(t,s){e+=`<tr>
            <td><a class="is-normal-text" href="${t.browser.link}" title="${t.browser.name}"><img src="${t.browser.logo}" alt="${t.browser.name}" class='wps-flag log-tools' title='${t.browser.name}'/> ${t.browser.name}</a></td>
            `+(wps_js.is_active("geo_ip")?`<td><img src='${t.country.flag}' alt='${t.country.name}' title='${t.country.name}' class='wps-flag'/> ${t.country.name}</td>`:"")+`
            `+(wps_js.is_active("geo_city")?`<td>${t.city}</td>`:"")+`
            <td>${t.date}</td>
            <td class="o-table__td--sm-width">${t.hits}</td>
            <td class="o-table__link o-table__ip">`+(t.hash_ip||`<a href='${t.ip.link}'>${t.ip.value}</a>`)+`</td>
            <td class="o-table__referred">${t.referred}</td>
			</tr>`}),e=e+"</tbody></table>"+"</div>"}};
wps_js.referring_meta_box={view:function(t=[]){let e='<div class="o-table-wrapper">';return e+=`<table width="100%" class="o-table o-table--link o-table--space-between"><thead>
        <tr>
            <th>${wps_js._("address")}</th>
            <th>${wps_js.meta_box_lang("referring","references")}</th>
        </tr></thead><tbody>`,t.referring.forEach(function(t){e+=`<tr>
			<td><a href='//${t.domain}' title='${t.title}' target="_blank">${t.domain} <span class="dashicons dashicons-external" style="font-size: 15px; vertical-align: middle"></span></a></td>
			<td class="wps-middle-vertical"><a style="justify-content: flex-end;" href="${t.page_link}">${t.number} 
...
wps_js.search_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(a=0){var s="";return s+='<div class="o-wrap"><div class="wps-postbox-chart--data"><div class="wps-postbox-chart--items"></div><div class="wps-postbox-chart--previousPeriod">'+wps_js._("previous_period")+'</div></div><div class="wps-postbox-chart--container"><canvas id="'+wps_js.chart_id("search")+'"></canvas></div></div>'},meta_box_init:function(a=[]){a={data:{labels:a.data?.labels,...a.data.datasets.reduce((a,s)=>(a[s.label]=s.data,a),{})},previousData:{labels:a.previousData?.labels,...a.previousData.datasets.reduce((a,s)=>(a[s.label]=s.data,a),{})}};wps_js.new_line_chart(a,wps_js.chart_id("search"),null)}};
wps_js.summary_meta_box={summary_statistics:function(a=[]){let i="<thead>";if(i+='<tr><th width="50%">'+wps_js._("time")+"</th>",["visitors","visits"].forEach(function(t){i+="<th>"+(wps_js.is_active(t)?wps_js._(t):"")+"</th>"}),i=(i+="</tr>")+"</thead>"+"<tbody>",Object.keys(a).length){let e=["today","yesterday","this-week","last-week","this-month","last-month","7days","30days","90days","6months","this-year","total"];for(let s=0;s<e.length;s++)i+=`<tr><td><b>${wps_js._(e[s])}</b></td>`,["visitors","visits"].forEach(function(t){void 0===a[t]?i+="<td></td>":i+="<td>"+(wps_js.is_active(t)?`<a href="${a[t][e[s]].link}"><span class="quickstats-values">${a[t][e[s]].value}</span></a>`:"")+"</td>"}),i+="</tr>";i+="</tbody>"}return i},user_online:function(t=[]){let s="";return t.user_online&&(s=`<div class="c-live">
                <div>                    
                    <span class="c-live__status"></span> 
                    <span class="c-live__title">${wps_js._("online_users")}:</span>
                    <span><a class="c-live__value" href="${t.user_online.link}">${t.user_online.value}</a></span>
                </div>`,t.real_time_button&&(s+=`
                <a target="_blank" class="${t.real_time_button.class}" href="${t.real_time_button.link}" title="${t.real_time_button.title}">
                    ${wps_js._("Realtime")} 
                </a>`),s+="</div>"),s},view:function(t=[]){var s="";return s+this.user_online(t)+'<div class="o-table-wrapper"><table width="100%" class="o-table o-table--wps-summary-stats">'+this.summary_statistics(t)+"</table></div>"}};
...
wps_js.top_visitors_meta_box={view:function(t=[]){let s="",e=(s=(s+='<div class="o-table-wrapper">')+(`<table width="100%" class="o-table o-table--responsive"><tbody>
        <tr>
...
if(wps_js.isset(wps_js.global,"request_params","page")&&"searches"===wps_js.global.request_params.page){let s;s=wps_js.isset(wps_js.global,"request_params","from")&&wps_js.isset(wps_js.global,"request_params","to")?{from:wps_js.global.request_params.from,to:wps_js.global.request_params.to}:{from:wps_js.global.user_date_range.from,to:wps_js.global.user_date_range.to},wps_js.run_meta_box("search",s,!1)}
...
if(wps_js.isset(wps_js.global,"request_params","page")&&"settings"===wps_js.global.request_params.page&&(jQuery("#wp-statistics-settings-form ul.tabs li").click(function(t){t.preventDefault();t=$(this).attr("data-tab");"undefined"!=typeof localStorage&&localStorage.setItem("wp-statistics-settings-active-tab",t)}),"undefined"!=typeof localStorage)&&wps_js.isset(wps_js.global,"request_params","save_setting")&&"yes"===wps_js.global.request_params.save_setting){let t=localStorage.getItem("wp-statistics-settings-active-tab");t&&0<t.length&&$("#wp-statistics-settings-form ul.tabs li[data-tab="+t+"]").click()}
