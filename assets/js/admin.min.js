...
`},wps_js.line_placeholder=function(p=1){let c='<div class="wps-ph-item">';for(let s=0;s<p;s++)c+=`
                <div class="wps-ph-col-12">
            ...
            `;return c+="</div>"},wps_js.circle_placeholder=function(){return`
<div class="wps-ph-item">
     ${wps_js.placeholder_content("circle")}
</div>
`},wps_js.rectangle_placeholder=function(s=""){return`
...
wps_js.exist_tag=function(t){return jQuery(t).length},wps_js.loading_button=function(t){t.classList.add("wps-loading-button")},wps_js.date_picker=function(){var t=jQuery("input[data-wps-date-picker]");t.length&&(t.daterangepicker({singleDatePicker:!0,showDropdowns:!0,minYear:1998,drops:"up",opens:document.getElementById("TB_window")?"center":"right",maxYear:parseInt((new Date).getFullYear()+1),locale:{format:"YYYY-MM-DD"}}),t.on("show.daterangepicker",function(t,e){e=e.container;jQuery(e).addClass(t.target.className)}))},wps_js.formatNumber=function(t,e=0){if(null===t)return null;if(t=parseFloat(t.toString().trim().replace(/[, ]/g,"")),isNaN(t))return null;if(0===t)return"0";e=!e||e<0?0:e;var a=parseInt(t).toPrecision(2).split("e"),a=1===a.length?0:Math.floor(Math.min(a[1].slice(1),14)/3),t=a<1?t.toFixed(0+e):(t/Math.pow(10,3*a)).toFixed(1+e);return(t<0?t:Math.abs(t))+["","K","M","B","T"][a]},wps_js.select2=function(){jQuery("select[data-type-show=select2]").select2()};const wpsSelect2=jQuery(".wps-select2"),wpsBody=jQuery("body"),wpsDropdown=jQuery(".wps-dropdown");if(wpsSelect2.length){const n=jQuery(".wps-filter-page"),o=jQuery(".wps-filter-user-role"),p=jQuery(".wps-filter-visitor"),q=wpsBody.hasClass("rtl")?"rtl":"ltr",r=n.length?n:p,s=(t,a)=>{wpsSelect2.select2({dropdownParent:t,dir:q,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown",minimumInputLength:1,ajax:{delay:500,url:wps_js.global.ajax_url,dataType:"json",data:function(t){var e,t={wps_nonce:wps_js.global.rest_api_nonce,search:t.term,action:a,paged:t.page||1};return wps_js.isset(wps_js.global,"request_params")&&((e=wps_js.global.request_params).author_id&&(t.author_id=e.author_id),e.page&&(t.page=e.page),e.pt&&(t.post_type=e.pt),e.pid)&&(t.post_id=e.pid),t},processResults:function(t){return t&&Array.isArray(t.results)?{results:t.results.map(t=>({id:t.id,text:t.text})),pagination:{more:!1}}:(console.error("Expected an array of results but got:",t),{results:[]})},error:function(t,e,a){console.error("AJAX request error:",e,a)}}})};wpsSelect2.select2({dropdownParent:r,dir:q,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown"}),wpsSelect2.on("select2:open",()=>wpsDropdown.addClass("active")),wpsSelect2.on("select2:close",()=>wpsDropdown.removeClass("active")),wpsSelect2.on("change",function(){var t=jQuery(this).find("option:selected").val();t&&(window.location.href=t)}),n.length&&(s(n,"wp_statistics_get_page_filter_items"),n.on("click",()=>wpsSelect2.select2("open"))),o.length&&(s(o,"wp_statistics_get_page_filter_items"),o.on("click",()=>wpsSelect2.select2("open"))),p.length&&(s(p,"wp_statistics_search_visitors"),p.on("click",()=>wpsSelect2.select2("open")))}wps_js.tooltip=function(){jQuery(".wps-tooltip").tooltipster({theme:"tooltipster-flat",contentCloning:!0}),jQuery("body").on("mouseenter touchstart",".wps-tooltip:not(.tooltipstered)",function(){$(this).tooltipster({theme:"tooltipster-flat"}).tooltipster("open")})},wps_js.tooltip(),wps_js.redirect=function(t){window.location.replace(t)},wps_js.line_chart=function(t,e,a,o,s){t=document.getElementById(t).getContext("2d"),wps_js.is_active("rtl")&&(Chart.defaults.global={defaultFontFamily:"Tahoma"}),a={type:"line",data:{labels:a,datasets:o},options:{responsive:!0,legend:{position:"bottom"},animation:{duration:1500},title:{display:!0,text:e},tooltips:{mode:"index",intersect:!1},interaction:{intersect:!1,mode:"index"},scales:{y:{ticks:{stepSize:1}}}}},o=Object.assign({},a,s);new Chart(t,o)},wps_js.horizontal_bar=function(t,a,o,s){t=document.getElementById(t);if(t){var e=t.parentNode,r=t.nextSibling,n=(e.removeChild(t),o.reduce((t,e)=>t+e,0)),i=document.createElement("div");i.classList.add("wps-horizontal-bar");for(let e=0;e<o.length;e++){var l=n?o[e]/n*100:0;let t=l%1==0?l.toFixed(0):l.toFixed(1);t.endsWith(".0")&&(t=t.slice(0,-2));var d=document.createElement("div"),c=(d.classList.add("wps-horizontal-bar__item"),document.createElement("div")),p=(c.classList.add("wps-horizontal-bar__label-image-container"),s&&s[e]&&"undefined"!==s[e]&&((p=document.createElement("img")).src=s[e],p.alt=a[e],p.classList.add("wps-horizontal-bar__image"),c.appendChild(p)),document.createElement("div")),c=(p.innerHTML=a[e],p.setAttribute("title",a[e]),p.classList.add("wps-horizontal-bar__label"),c.appendChild(p),d.appendChild(c),document.createElement("div")),u=(c.classList.add("wps-horizontal-bar__data-percent-container"),document.createElement("div")),u=(u.innerHTML=`<span>${wps_js.formatNumber(o[e])}</span><span>${t}%</span>`,u.classList.add("wps-horizontal-bar__data"),c.appendChild(u),d.appendChild(c),document.createElement("div"));u.classList.add("wps-horizontal-bar__background"),u.style.width=l+"%",d.appendChild(u),i.appendChild(d)}r?e.insertBefore(i,r):e.appendChild(i)}},wps_js.chart_id=function(t){return"wp-statistics-"+t+"-meta-box-chart"},wps_js.random_color=function(t=!1){var e=[[243,156,18,"#f39c12"],[52,152,219,"#3498db"],[192,57,43,"#c0392b"],[155,89,182,"#9b59b6"],[39,174,96,"#27ae60"],[230,126,34,"#e67e22"],[142,68,173,"#8e44ad"],[46,204,113,"#2ecc71"],[41,128,185,"#2980b9"],[22,160,133,"#16a085"],[211,84,0,"#d35400"],[44,62,80,"#2c3e50"],[241,196,15,"#f1c40f"],[231,76,60,"#e74c3c"],[26,188,156,"#1abc9c"],[46,204,113,"#2ecc71"],[52,152,219,"#3498db"],[155,89,182,"#9b59b6"],[52,73,94,"#34495e"],[22,160,133,"#16a085"],[39,174,96,"#27ae60"],[44,62,80,"#2c3e50"],[241,196,15,"#f1c40f"],[230,126,34,"#e67e22"],[231,76,60,"#e74c3c"],[236,240,241,"#9b9e9f"],[149,165,166,"#a65d20"]];return e[!1===t?Math.floor(Math.random()*e.length):t]},wps_js.wordpress_postbox_ajax=function(t="enable"){var e=jQuery(".postbox .hndle, .postbox .handlediv");"enable"===t?e.on("click",window.postboxes.handle_click):e.off("click",window.postboxes.handle_click)},wps_js.isset=function(e){var a=Array.prototype.slice.call(arguments,1);for(let t=0;t<a.length;t++){if(!e||!e.hasOwnProperty(a[t]))return!1;e=e[a[t]]}return!0},wps_js.number_format=function(t,e,a,o){var s;if(null!=t&&isFinite(t))return e||(e=1<(s=t.toString().split(".").length)?s:0),a=a||".",o=o||",",(s=(t=(t=parseFloat(t).toFixed(e)).replace(".",a)).split(a))[0]=s[0].replace(/\B(?=(\d{3})+(?!\d))/g,o),s.join(a);throw new TypeError("number is not valid")},wps_js.set_equal_height=function(t,e){var a=jQuery(t).height(),o=jQuery(e).height();let s=e,r=a;a<o&&(s=t,r=o),jQuery(s).css("height",r+"px")},wps_js.Create_Half_PostBox=function(t,e){return`<div class="postbox-container wps-postbox-half ${t}"><div class="metabox-holder"><div class="meta-box-sortables"> <div class="postbox" id="${e}"> <div class="inside"></div></div></div></div></div>`},wps_js.isIP=function(t){var e="(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]?|0)";return new RegExp(`^${e}\\.${e}\\.${e}\\.${e}$`).test(t)},wps_js.getLinkParams=function(t,e=!1){e=(e=e||window.location.href).match(new RegExp("(?:[?&]"+t+"=)([^&]+)"));return e?e[1]:null},wps_js.sum=function(t){return t.reduce(function(t,e){return t+e},0)},wps_js.no_results=function(){return'<div class="o-wrap o-wrap--no-data wps-center">'+wps_js._("no_result")+"</div>"},wps_js.hex_to_rgba=function(t,e){t=(t=4===(t="string"!=typeof t||"#"!==t[0]||7!==t.length&&4!==t.length?"#3288D7":t).length?"#"+t[1].repeat(2)+t[2].repeat(2)+t[3].repeat(2):t).replace("#","");var a=parseInt(t.substring(0,2),16),o=parseInt(t.substring(2,4),16),t=parseInt(t.substring(4,6),16);return wps_js.rgba_to_hex(a,o,t,e)},wps_js.rgba_to_hex=function(t,e,a,o){return"#"+t.toString(16).padStart(2,"0")+e.toString(16).padStart(2,"0")+a.toString(16).padStart(2,"0")+Math.round(255*o).toString(16).padStart(2,"0")};const getOrCreateTooltip=t=>{let e=t.canvas.parentNode.querySelector("div");var a;return e||((e=document.createElement("div")).classList.add("wps-chart-tooltip"),e.style.opacity=1,e.style.pointerEvents="none",e.style.position="absolute",e.style.transition="all .1s ease",(a=document.createElement("table")).style.margin="0px",e.appendChild(a),t.canvas.parentNode.appendChild(e)),e},externalTooltipHandler=(a,t,e,i,o,s,r)=>{const{chart:l,tooltip:d}=a;a=getOrCreateTooltip(l);if(0===d.opacity)a.style.opacity=0;else if(d.body){var c=d.title||[];const v=d.dataPoints[0].dataIndex,b=l.data.datasets;let n="<div>";c.forEach(t=>{var{date:e,day:a}=(i.data||i).labels[v];n+="day"===o?`<div class="chart-title">${e} (${a})</div>`:"month"===o?`<div class="chart-title">${r[v]} </div>`:`<div class="chart-title">${s[v]} </div>`}),b.forEach((e,a)=>{var t=l.getDatasetMeta(a),o=l.data.datasets.find((t,e)=>t.label===b[a].label+" (Previous)"&&l.getDatasetMeta(e)),s=e.data[v],r=e.label.includes("(Previous)");t.hidden||r||(n+=`
                <div class="current-data">
                    <div>
                        <span class="current-data__color" style="background-color: ${e.hoverPointBackgroundColor};"></span>
                        ${e.label}
                    </div>
                    <span class="current-data__value">${s.toLocaleString()}</span>
                </div>`),i?.previousData&&o&&!l.getDatasetMeta(l.data.datasets.indexOf(o)).hidden&&void 0!==(t=i.previousData.datasets.find(t=>t.label===e.label.replace(" (Previous)","")))&&""!==t&&t.data&&!r&&(s=t.data[v],o=i.previousData.labels[v].date,n+=`
                    <div class="previous-data">
                        <div>
                            <span class="previous-data__colors">
                                <span class="previous-data__color" style="background-color: ${e.hoverPointBackgroundColor};"></span>
                                <span class="previous-data__color" style="background-color: ${e.hoverPointBackgroundColor};"></span>
                            </span>
                            ${o}
                        </div>
                        <span class="previous-data__value"> ${s.toLocaleString()}</span>
                    </div>`)}),n+="</div>",a.innerHTML=n;var{offsetLeft:c,offsetTop:p,clientWidth:u,clientHeight:h}=l.canvas,{caretX:g,caretY:w}=d,m=a.offsetWidth,f=a.offsetHeight;let t=c+g+16,e=p+w-f/2;(t=t+m+16>c+u?c+g-m-16:t)<c+16&&(t=c+16),(e=e<p+16?p+16:e)+f+16>p+h&&(e=p+h-f-16),a.style.opacity=1,a.style.left=t+"px",a.style.top=e+"px"}},drawVerticalLinePlugin={id:"drawVerticalLine",beforeDatasetDraw(t){var{ctx:t,scales:{},tooltip:e,chartArea:{top:a,bottom:o}}=t;e&&e._active&&e._active.length&&(e=e._active[0].element.x,t.beginPath(),t.strokeStyle="#A9AAAE",t.lineWidth=1,t.setLineDash([6,6]),t.moveTo(e,a),t.lineTo(e,o),t.stroke(),t.setLineDash([]))}},phpToMomentFormat=t=>{const e={d:"DD",j:"D",S:"Do",n:"M",m:"MM",F:"MMM",M:"MMM",y:"YY",Y:"YYYY"};return t.replace(/([a-zA-Z])/g,t=>e[t]||t)};wps_js.new_line_chart=function(d,t,e=null,a="line"){var o=wps_js.isset(wps_js.global,"options","wp_date_format")?wps_js.global.options.wp_date_format:"MM/DD/YYYY";let w=phpToMomentFormat(o);const m=null!==document.getElementById(t).closest("#dashboard-widgets");o=(i,l,d)=>{const c=[];let p=[];const u=l.map(()=>[]);let h=[],g=i[0]?.date;return i.forEach((t,e)=>{var a,o,s,r,n=moment(t.date);n.isValid()?(n="week"===d&&0===n.day()||"month"===d&&n.date()===n.daysInMonth(),h.push({...t,index:e}),!n&&e!==i.length-1||(n=i[e]?.date||g,c.push((a=g,o=n,s=d,r=w.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,""),"month"===s?moment(a).format("MMM YYYY"):m?moment(a).format(r)+" to "+moment(o).format(r):moment(a).format(r)+" to "+moment(o).format(w))),"month"===d&&p.push((s=g,a=n,r=w.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,""),moment(s).format(r)+" to "+moment(a).format(w))),l.forEach((a,t)=>{var e=h.reduce((t,e)=>{e=a.data[e.index];return isNaN(e)||null==e?t:t+e},0);u[t].push(e)}),h=[],g=i[e+1]?.date||"")):console.error(`Invalid date found at index ${e}:`,t.date)}),{aggregatedLabels:c,aggregatedData:u,monthTooltipTitle:p}};let s=d.data.labels.map(t=>t.formatted_date),r=[];var n=s.length;const i="performance"===a&&2<d.data.datasets.length;let l=n<=("performance"===a?30:60)?"day":n<=180?"week":"month";if("week"==l||"month"==l){const g=o(d.data.labels,d.data.datasets,l);if(s=g.aggregatedLabels,d.data.datasets.forEach((t,e)=>{t.data=g.aggregatedData[e]}),d.previousData&&0<d.previousData.datasets.length){const f=o(d.data.labels,d.previousData.datasets,l);d.previousData.datasets.forEach((t,e)=>{t.data=f.aggregatedData[e]})}r=g.monthTooltipTitle}let c={Total:"#27A765",Views:"#7362BF",Visitors:"#3288D7",Posts:"#8AC3D0",Other1:"#3288D7",Other2:"#7362BF",Other3:"#8AC3D0"};const p=[.1,.3,.5,.7];a=document.getElementById(t).getContext("2d");const u=[];Object.keys(d.data.datasets).forEach((t,e)=>{var a=c[d.data.datasets[t].label]||c["Other"+(e+1)],o=p[e%p.length];i&&2===e?u.push({type:"bar",label:d.data.datasets[t].label,data:d.data.datasets[t].data,backgroundColor:a,hoverBackgroundColor:a,hoverPointBackgroundColor:a,yAxisID:"y1"}):u.push({type:"line",label:d.data.datasets[t].label,data:d.data.datasets[t].data,borderColor:a,backgroundColor:a,fill:!1,yAxisID:"y",borderWidth:2,pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:a,pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:a,hoverPointBorderWidth:4,tension:o,hitRadius:10})}),d?.previousData&&Object.keys(d.previousData.datasets).forEach((t,e)=>{var a=c[d.previousData.datasets[t].label]||c["Other"+e],e=p[e%p.length];u.push({type:"line",label:d.previousData.datasets[t].label+" (Previous)",data:d.previousData.datasets[t].data,borderColor:wps_js.hex_to_rgba(a,.7),hoverBorderColor:a,backgroundColor:a,fill:!1,yAxisID:"y",borderWidth:1,borderDash:[5,5],pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:a,pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:a,hoverPointBorderWidth:4,tension:e,hitRadius:10})});n={maintainAspectRatio:!1,resizeDelay:200,animation:{duration:0},responsive:!0,interaction:{intersect:!1,mode:"index"},plugins:{legend:!1,tooltip:{enabled:!1,external:t=>externalTooltipHandler(t,u,c,d,l,s,r),callbacks:{title:t=>t[0].label,label:t=>t.formattedValue}}},scales:{x:{offset:s.length<=1,grid:{display:!1,drawBorder:!1,tickLength:0,drawTicks:!1},border:{color:"transparent",width:0},ticks:{align:"inner",autoSkip:!0,maxTicksLimit:m?"week"==l?2:4:"week"==l?3:"month"==l?7:9,font:{color:"#898A8E",style:"italic",weight:"lighter",size:m?"week"==l?9:11:"week"==l?11:13},padding:8}},y:{min:0,ticks:{maxTicksLimit:m?4:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},border:{color:"transparent",width:0},type:"linear",position:"right",grid:{display:!0,tickMarkLength:0,drawBorder:!1,tickColor:"#EEEFF1",color:"#EEEFF1"},gridLines:{drawTicks:!1},title:{display:!1}}}},i&&(n.scales.y1={type:"linear",position:"left",border:{color:"transparent",width:0},grid:{display:!1,drawBorder:!1,tickLength:0},ticks:{maxTicksLimit:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},title:{display:!0,text:wps_js._("published")+" Posts",color:"#898A8E",fontSize:13}},n.scales.y={border:{color:"transparent",width:0},ticks:{maxTicksLimit:9,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},position:i?"right":"left",grid:{display:!0,borderDash:[5,5],tickColor:"#EEEFF1",color:"#EEEFF1"},title:{display:!0,text:wps_js._("visits"),color:"#898A8E",fontSize:13}}),o=Object.assign({},n,e);const h=new Chart(a,{type:i?"bar":"line",data:{labels:s,datasets:u},plugins:[drawVerticalLinePlugin],options:o});{const v=document.getElementById(t).parentElement.parentElement.querySelector(".wps-postbox-chart--items");if(v){v.innerHTML="",u.sort((t,e)=>"Total"===t.label?-1:"Total"===e.label?1:"Total (Previous)"===t.label?-1:"Total (Previous)"===e.label?1:0);n=document.querySelectorAll(".wps-postbox-chart--previousPeriod");if(0<n.length){let e=!1;u.forEach(t=>{t.label.includes("(Previous)")&&(e=!0)}),e&&n.forEach(t=>{t.style.display="flex"})}u.forEach((o,s)=>{if(!o.label.includes("(Previous)")){var e=o.data.reduce((t,e)=>Number(t)+Number(e),0);let t=null,a=null;0<d?.previousData?.datasets.length&&(r=d.previousData.datasets.find((t,e)=>t.label===o.label&&(a=e,!0)))&&r.data&&(t=r.data.reduce((t,e)=>Number(t)+Number(e),0));var r=document.createElement("div"),n=(r.className="wps-postbox-chart--item",null!==t?`
            <div class="previous-data">
                <span>
            ...
            <div>
                ...
                ${n}
            </div>`;const i=r.querySelector(".current-data"),l=(i.addEventListener("click",function(){var t=h.getDatasetMeta(s);t.hidden=!t.hidden,i.classList.toggle("wps-line-through"),h.update()}),r.querySelector(".previous-data"));l&&null!==a&&l.addEventListener("click",function(){var t=h.data.datasets.find((t,e)=>t.label===u[s].label+" (Previous)"&&h.getDatasetMeta(e));t&&(t=h.data.datasets.indexOf(t),(t=h.getDatasetMeta(t)).hidden=!t.hidden,l.classList.toggle("wps-line-through"),h.update())}),v.appendChild(r)}})}}},jQuery(document).ready(function(){var t=document.querySelectorAll(".wps-head-filters__item"),e=(t.forEach(function(a){a.classList.remove("loading"),a.addEventListener("click",function(t){var e=a.querySelector(".dropdown-content");e&&e.classList.toggle("show")})}),jQuery(".wps-search-dropdown"));e.on("click",function(t){t.stopPropagation()}),e.on("input",function(){let t=jQuery(this).val().toLowerCase();jQuery(this).parent().find(".dropdown-item").each(function(){-1<(jQuery(this).text()||jQuery(this).innerText).toLowerCase().indexOf(t)?jQuery(this).show():jQuery(this).hide()})}),window.addEventListener("click",function(a){t.forEach(function(t){var e=t.querySelector(".dropdown-content");e&&!t.contains(a.target)&&e.classList.remove("show")})})}),jQuery(document).ready(function(){var t=document.querySelector(".wp-header-end"),e=document.querySelector(".notice.notice-warning.update-nag");t&&e&&t.parentNode.insertBefore(e,t.nextSibling),jQuery(document).on("click",".wps-privacy-list__item .wps-privacy-list__title",t=>{var e=jQuery(t.currentTarget),a=e.siblings(".wps-privacy-list__content");jQuery(t.target).is(".wps-privacy-list__button")||(e.toggleClass("open"),a.hasClass("show")?a.removeClass("show"):a.addClass("show"))})});
function moveFeedbackBird(){var e=window.outerWidth||document.documentElement.clientWidth,t=document.getElementById("feedback-bird-app"),n=document.querySelector(".c-fbb-widget__header__title"),i=document.querySelector(".wps-mobileMenuContent>div:last-child"),o=document.querySelector(".wps-adminHeader__side");t&&document.body.classList.contains("wps_page")&&(e<=1030?(e=t.parentNode.removeChild(t),i.parentNode.insertBefore(e,i)):(e=t.parentNode.removeChild(t),o.appendChild(e)),t.style.display="block",t.setAttribute("title",n.innerHTML))}window.addEventListener("resize",moveFeedbackBird),jQuery(document).ready(function(){moveFeedbackBird();const e=document.querySelectorAll(".wps-admin-header__link--has-dropdown");e.forEach(function(t){t.addEventListener("click",function(e){e.preventDefault();e=this.nextElementSibling;e&&(e.classList.toggle("is-open"),t.classList.toggle("is-open"))})}),document.addEventListener("click",function(n){e.forEach(function(e){var t=e.nextElementSibling;!t||e.contains(n.target)||t.contains(n.target)||t.classList.remove("is-open")})});var t=document.querySelector(".wp-header-end"),n=document.querySelector(".notice.notice-warning.update-nag");t&&n&&t.parentNode.insertBefore(n,t.nextSibling)});
const skipButtons=document.querySelectorAll(".js-wps-premiumModalClose"),modal=document.querySelector(".js-wps-premiumModal"),welcomeContent=document.querySelector(".js-wps-premiumModalWelcomeContent"),premiumStepsContent=document.querySelector(".js-wps-premiumModalSteps"),premiumSteps=document.querySelectorAll(".js-wps-premiumModalStep"),premiumWelcomeSteps=document.querySelectorAll(".js-wps-premiumModal-welcome .js-wps-premiumModalStep"),exploreButton=document.querySelector(".js-wps-premiumModalExploreBtn"),premiumFeatures=document.querySelectorAll(".js-wps-premiumStepFeature"),premiumBtn=document.querySelectorAll(".js-wps-openPremiumModal"),upgradeButtonBox=document.querySelectorAll(".wps-premium-step__action-container"),premiumStepsTitle=document.querySelectorAll(".js-wps-premium-steps__title"),firstStepHeader=document.querySelectorAll(".js-wps-premium-first-step__head"),stepsHeader=document.querySelectorAll(".js-wps-premium-steps__head");let autoSlideInterval,currentStepIndex=1;const closeModal=()=>{modal&&(modal.style.display="none",document.body.style.overflow="")},setMaxHeightForAllSteps=()=>{if(0!==premiumSteps.length){let s=0;premiumSteps.forEach(e=>{var t=e.style.display,r=(e.style.display="block",e.style.minHeight="auto",e.getBoundingClientRect().height);s=Math.max(s,r),e.style.display=t}),premiumSteps.forEach(e=>{e.style.minHeight=s+"px"})}},openModal=(window.addEventListener("resize",setMaxHeightForAllSteps),(t,e)=>{modal&&(modal.style.display="block",document.body.style.overflow="hidden");var r=Array.from(premiumFeatures).findIndex(e=>e.getAttribute("data-modal")===t);-1!==r&&(currentStepIndex=r,welcomeContent&&(welcomeContent.style.display="none"),loadModalImages(),showStep(currentStepIndex+1),premiumStepsContent.style.display="block",stopAutoSlide())}),loadModalImages=(0<premiumBtn.length&&premiumBtn.forEach(r=>{r.addEventListener("click",e=>{e.preventDefault();var e=r.getAttribute("href"),t=r.getAttribute("data-target");openModal(t,e)})}),0<skipButtons.length&&skipButtons.forEach(e=>{e.addEventListener("click",closeModal)}),premiumSteps.forEach(e=>{e.classList.remove("wps-modal__premium-step--active")}),exploreButton&&exploreButton.addEventListener("click",function(){currentStepIndex=0,loadModalImages(),welcomeContent.style.display="none",premiumStepsContent.style.display="block",showStep(currentStepIndex),startAutoSlide()}),()=>{document.querySelectorAll(".wps-premium-step__image").forEach(e=>{e.src=e.dataset.src})}),showStep=e=>{var t;setTimeout(()=>{setMaxHeightForAllSteps()},100),e<0||e>=premiumSteps.length||(premiumSteps.forEach(e=>e.classList.remove("wps-modal__premium-step--active")),upgradeButtonBox&&0<upgradeButtonBox.length&&(upgradeButtonBox.forEach(e=>{e&&e.classList.remove("active")}),upgradeButtonBox[e-1])&&upgradeButtonBox[e-1].classList.add("active"),premiumStepsTitle&&0<premiumStepsTitle.length&&(premiumStepsTitle.forEach(e=>{e&&e.classList.remove("active")}),premiumStepsTitle[e-1])&&premiumStepsTitle[e-1].classList.add("active"),premiumFeatures.forEach(e=>e.classList.remove("active")),premiumSteps[e].classList.add("wps-modal__premium-step--active"),t=(e,t)=>{e.forEach(e=>{e.style.display=t})},0<e?(t(firstStepHeader,"none"),t(stepsHeader,"block"),premiumFeatures[e-1].classList.add("active")):(t(firstStepHeader,"block"),t(stepsHeader,"none")))},startAutoSlide=()=>{autoSlideInterval=setInterval(()=>{currentStepIndex=(currentStepIndex+1)%premiumWelcomeSteps.length,showStep(currentStepIndex)},5e3)},stopAutoSlide=()=>{clearInterval(autoSlideInterval)};0<premiumFeatures.length&&premiumFeatures.forEach((e,t)=>{e.addEventListener("click",function(){stopAutoSlide(),currentStepIndex=t+1,showStep(currentStepIndex)})});
const unlockColumnExists=document.querySelector(".wps-admin-column__unlock"),tbodyElement=document.querySelector(".wp-list-table");unlockColumnExists&&tbodyElement&&tbodyElement.classList.add("wps-admin-mini-chart__unlock");
...
wps_js.browsers_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(s=0){var t="";return t+='<div class="o-wrap"><div class="c-chart c-chart--limited-height"><canvas id="'+wps_js.chart_id("browsers")+'" height="220"></canvas></div></div>'},meta_box_init:function(r=[]){var s=[{data:r.browsers_value}];if(wps_js.horizontal_bar(wps_js.chart_id("browsers"),r.browsers_name,s[0].data,r.browsers_logos),wps_js.exist_tag("#"+wps_js.getMetaBoxKey("browsers-table"))){["browsers-table","browsers"].forEach(s=>{jQuery("#"+wps_js.getMetaBoxKey(s)+" .inside").removeAttr("style")});let t=`<div class="title-center">${r.title}</div>
                    <table width="100%" class="o-table">
                        ...
                        </tr>`;for(let s=0;s<r.browsers_name.length;s++)t+=`
                 <tr>
                        <td>${r.browsers_name[s]}</td>
                        <td>${0<parseInt(r.browsers_value[s])?`${"other"!==r.info.agent[s]?'<a href="'+r.info.visitor_page+"&agent="+r.info.agent[s]+"&from="+r.from+"&to="+r.to+'" target="_blank">':""} ${wps_js.number_format(r.browsers_value[s])} `+("other"!==r.info.agent[s]?"</a>":""):r.browsers_value[s]}</td>
                        <td>${wps_js.number_format(r.browsers_value[s]/r.total*100)}%</td>
                 </tr>
                `;t=t+` <tr><td>${wps_js._("total")}</td><td>${wps_js.number_format(r.total)}</td><td></td></tr>`+"</table>",jQuery("#"+wps_js.getMetaBoxKey("browsers-table")+" .inside").html(t),wps_js.set_equal_height(".postBox-table .inside",".postBox-chart .inside");let e="";for(let s=0;s<r.browsers_name.length;s++)0<parseInt(r.browsers_value[s])&&r.info.agent[s]&&(e=(e=(e+=`<div class="wps-title-group"><img src="${r.info.logo[s]}" alt="${r.browsers_name[s]}" style="vertical-align: -3px;" class="wps-flag log-tools"> ${r.browsers_name[s]}</div><div class="wp-clearfix"></div>`)+wps_js.Create_Half_PostBox("postBox-chart-"+r.info.agent[s],"browser-"+r.info.agent[s]+"-chart"))+wps_js.Create_Half_PostBox("postBox-table-"+r.info.agent[s],"browser-"+r.info.agent[s]+"-table")+'<div class="wp-clearfix"></div>');jQuery(e).insertAfter("#browsers-table");for(let s=0;s<r.browsers_name.length;s++)0<parseInt(r.browsers_value[s])&&r.info.agent[s]&&this.run_custom_browser(r.info.agent[s])}},run_custom_browser:function(s){["browser-"+s+"-chart","browser-"+s+"-table"].forEach(s=>{jQuery("#"+s+" .inside").css("height","430px")}),jQuery("#browser-"+s+"-table .inside").html(wps_js.placeholder()),jQuery("#browser-"+s+"-chart .inside").html(wps_js.circle_placeholder()),jQuery(".wps-ph-picture").attr("style","height: 310px;");let t={name:"browsers",browser:s};["from","to"].forEach(s=>{wps_js.isset(wps_js.global,"request_params",s)&&(t[s]=wps_js.global.request_params[s])}),wps_js.ajaxQ(wps_js.global.meta_box_api,t,"show_custom_agent","error_custom_agent","GET",!1)}},wps_js.show_custom_agent=function(e){var r=e.info.agent[0];jQuery("#browser-"+r+"-chart .inside").html('<canvas id="'+wps_js.chart_id("browser-"+r)+'" height="220"></canvas>'),setTimeout(function(){var s=[{data:e.browsers_value}];wps_js.horizontal_bar(wps_js.chart_id("browser-"+r),e.browsers_name,s[0].data,e.browsers_logos),["browser-"+r+"-chart","browser-"+r+"-table"].forEach(s=>{jQuery("#"+s+" .inside").removeAttr("style")});let t=`<div class="title-center">${e.title}</div>
                    <table width="100%" class="o-table">
                        <tr>
                            <td class="wps-text-muted">${wps_js._("version_list")}</td>
                            <td class="wps-text-muted">${wps_js._("visitor_count")}</td>
                            <td class="wps-text-muted">${wps_js._("percentage")}</td>
                        </tr>`;for(let s=0;s<e.browsers_name.length;s++)t+=`
                 <tr>
                    <td>${e.browsers_name[s]}</td>
                    <td>${0<parseInt(e.browsers_value[s])?wps_js.number_format(e.browsers_value[s]):e.browsers_value[s]}</td>
                    <td>${wps_js.number_format(e.browsers_value[s]/e.total*100)}%</td>
                </tr>
                `;t=t+` <tr><td>${wps_js._("total")}</td><td>${wps_js.number_format(e.total)}</td><td></td></tr>`+"</table>";s="#browser-"+r+"-table .inside";jQuery(s).html(t),wps_js.set_equal_height(s,"#browser-"+r+"-chart .inside")},500)},wps_js.error_custom_agent=function(s){};
...
wps_js.devices_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(a=0){var e="";return e+='<div class="o-wrap"><div class="c-chart c-chart--limited-height"><canvas id="'+wps_js.chart_id("devices")+'" height="220"></canvas></div></div>'},meta_box_init:function(a=[]){var e=[{data:a.device_value}];wps_js.horizontal_bar(wps_js.chart_id("devices"),a.device_name,e[0].data,null)}};
wps_js.exclusions_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(s=0){let e=wps_js.is_active("overview_page")?110:210;wps_js.isset(wps_js.global,"request_params","page")&&"exclusions"===wps_js.global.request_params.page&&(e=80);var a="";return a+='<canvas id="'+wps_js.chart_id("exclusions")+'" height="'+e+'"></canvas>'},meta_box_init:function(s=[]){var e;this.show_chart(wps_js.chart_id("exclusions"),s),wps_js.isset(wps_js.global,"request_params","page")&&"exclusions"===wps_js.global.request_params.page&&(e="span[id='number-total-chart-exclusions']",wps_js.exist_tag(e))&&(s=wps_js.sum(Object.values(s.total)),jQuery(e).html(wps_js.number_format(s)))},show_chart:function(s,r=[]){let l="",o=[],n=0;Object.keys(r.exclusions).forEach(function(s){var e,a,t=wps_js.sum(Object.values(r.value[s]));0<t&&(e=r.exclusions[s],a=wps_js.random_color(n),o.push({label:e,data:r.value[s],backgroundColor:"rgba("+a[0]+","+a[1]+","+a[2]+",0.3)",borderColor:"rgba("+a[0]+","+a[1]+","+a[2]+",1)",borderWidth:1,fill:!0,tension:.4}),l+=`<tr><th>${e}</th> <th class="th-center"><span style="color: #9a9494 !important;">${wps_js.number_format(t)}</span></th></tr>`,n++)}),wps_js.exist_tag("table[data-table=exclusions]")&&jQuery(l).insertAfter("table[data-table=exclusions] tr:first"),wps_js.line_chart(s,r.title,r.date,o)}};
wps_js.hits_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(s=0){let a=wps_js.is_active("overview_page")?300:210;wps_js.isset(wps_js.global,"request_params","page")&&"hits"===wps_js.global.request_params.page&&(a=80);var t="";return t+='<div class="o-wrap"><div class="wps-postbox-chart--data"><div class="wps-postbox-chart--items"></div><div class="wps-postbox-chart--previousPeriod">'+wps_js._("previous_period")+'</div></div><div class="wps-postbox-chart--container"><canvas id="'+wps_js.chart_id("hits")+'" height="'+a+'"></canvas></div></div>'},meta_box_init:function(t=[]){this.hits_chart(wps_js.chart_id("hits"),t),wps_js.isset(wps_js.global,"request_params","page")&&"hits"===wps_js.global.request_params.page&&["visits","visitors"].forEach(function(s){var a="span[id^='number-total-chart-"+s+"']";wps_js.exist_tag(a)&&jQuery(a).html(t.total[s])})},hits_chart:function(s,a=[]){document.getElementById(s)&&(a={data:a.data,previousData:a.previousData},wps_js.new_line_chart(a,s))}};
wps_js.hitsmap_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(t=0){return'<div class="o-wrap"><div id="wp-statistics-visitors-map"></div></div>'},meta_box_init:function(r=[]){let s=Array();r.hasOwnProperty("country")&&Object.keys(r.country).forEach(function(e){let o=`<div class='map-html-marker'><div class="map-country-header"><img src='${r.country[e].flag}' alt="${r.country[e].name}" title='${r.country[e].name}' class='log-tools wps-flag'/> ${r.country[e].name} (${r.total_country[e]})</div>`;Object.keys(r.visitor[e]).forEach(function(t){o+=`<p><img src='${r.visitor[e][t].browser.logo}' alt="${r.visitor[e][t].browser.name}" class='wps-flag log-tools' title='${r.visitor[e][t].browser.name}'/> ${r.visitor[e][t].ip} `+(["Unknown","(Unknown)"].includes(r.visitor[e][t].city)?"":"- "+r.visitor[e][t].city)+"</p>"}),o+="</div>",s[e]=o}),jQuery("#wp-statistics-visitors-map").vectorMap({map:"world_en",backgroundColor:"#fff",borderColor:"#7e7e7e",borderOpacity:.6,color:"#e6e5e2",selectedColor:"#9DA3F7",hoverColor:"#404BF2",colors:r.color,onLabelShow:function(t,e,o){void 0!==s[o]?e.html(s[o]):e.html(e.html()+" [0]<hr />")}});const e=jQuery("#wp-statistics-hitsmap-widget"),o=jQuery("#side-sortables"),i=jQuery("#normal-sortables");var t={attributes:!1,childList:!0,subtree:!1};const n=new MutationObserver(function(t){(o.find(e).length||i.find(e).length)&&(window.dispatchEvent(new Event("resize")),n.disconnect())});o.length&&n.observe(document.getElementById("side-sortables"),t),i.length&&n.observe(document.getElementById("normal-sortables"),t)}};
wps_js.models_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(a=0){var e="";return e+='<div class="o-wrap"><div class="c-chart c-chart--limited-height"><canvas id="'+wps_js.chart_id("models")+'" height="220"></canvas></div></div>'},meta_box_init:function(a=[]){var e=[{label:wps_js._("model"),data:a.model_value}];wps_js.horizontal_bar(wps_js.chart_id("models"),a.model_name,e[0].data,null)}};
wps_js.pages_chart_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(t=0){return'<div class="o-wrap"><canvas id="'+wps_js.chart_id("pages-chart")+'" height="80"></canvas></div>'},meta_box_init:function(t=[]){this.show_chart(wps_js.chart_id("pages-chart"),t),wps_js.exist_tag("span[id=number-total-visits]")&&jQuery("span[id=number-total-visits]").html(t.total),wps_js.exist_tag("span[id=number-total-chart-visits]")&&jQuery("span[id=number-total-chart-visits]").html(t.total_dates)},show_chart:function(t,a=[]){wps_js.line_chart(t,a.title,a.date,[{label:wps_js._("visits"),data:a.stat,backgroundColor:"rgba(54, 162, 235, 0.2)",borderColor:"rgba(54, 162, 235, 1)",borderWidth:1,fill:!0,tension:.4}])}};
...
wps_js.platforms_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(t=0){var a="";return a+='<div class="o-wrap"><div class="c-chart c-chart--limited-height"><canvas id="'+wps_js.chart_id("platforms")+'" height="220"></canvas></div></div>'},meta_box_init:function(e=[]){var t=[{label:wps_js._("platform"),data:e.platform_value}];if(wps_js.horizontal_bar(wps_js.chart_id("platforms"),e.platform_name,t[0].data,e.platform_logos),wps_js.exist_tag("#"+wps_js.getMetaBoxKey("platforms-table"))){["platforms-table","platforms"].forEach(t=>{jQuery("#"+wps_js.getMetaBoxKey(t)+" .inside").removeAttr("style")});let a=`<div class="title-center">${e.title}</div>
                    <table width="100%" class="o-table">
                        <tr>
                            <td class="wps-text-muted">${wps_js._("platform")}</td>
                            <td class="wps-text-muted">${wps_js._("visitor_count")}</td>
                            <td class="wps-text-muted">${wps_js._("percentage")}</td>
                        </tr>`;for(let t=0;t<e.platform_name.length;t++)a+=`
                 <tr>
                        <td>${e.platform_name[t]}</td>
                        <td>${0<parseInt(e.platform_value[t])?'<a href="'+e.info.visitor_page+"&platform="+e.platform_name[t]+"&from="+e.from+"&to="+e.to+`" target="_blank"> ${wps_js.number_format(e.platform_value[t])} </a>`:wps_js.number_format(e.platform_value[t])}</td>
                        <td>${wps_js.number_format(e.platform_value[t]/e.total*100)}%</td>
                 </tr>
                `;a=a+` <tr><td>${wps_js._("total")}</td><td>${wps_js.number_format(e.total)}</td><td></td></tr>`+"</table>",jQuery("#"+wps_js.getMetaBoxKey("platforms-table")+" .inside").html(a),wps_js.set_equal_height(".postBox-table .inside",".postBox-chart .inside")}}};
wps_js.post_summary_meta_box={params:function(){return{ID:wps_js.global.page.ID}},view:function(t=[]){var a=void 0!==t.summary&&void 0!==t.summary.postChartData&&null!==t.summary.postChartData&&Object.keys(t.summary.postChartData).length?'<div class="c-wps-post-summary-panel-chart"><canvas id="'+wps_js.chart_id("post_summary")+'" height="100"></canvas></div>':"";return t.hasOwnProperty("content")?'<div class="wps-center" style="padding: 15px;"> '+t.content+"</div>":'<p class="wps-wrap wps-meta-box-header">'+t.output+a},meta_box_init:function(t=[]){t.hasOwnProperty("content")?jQuery("#"+wps_js.getMetaBoxKey("post_summary")+" button[onclick]").remove():void 0!==t.summary&&void 0!==t.summary.postChartData&&null!==t.summary.postChartData&&Object.keys(t.summary.postChartData).length&&this.post_summary_chart(wps_js.chart_id("post_summary"),t.summary)},post_summary_chart:function(t,a=[]){let e=a.postChartData;let s="Visitors",o="#A5AAEA",r;void 0!==a.postChartSettings&&null!==a.postChartSettings&&((a=a.postChartSettings).color&&(o=a.color),a.label)&&(s=a.label);var a={animation:!1,responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{enabled:!1,displayColors:!1,position:"nearest",intersect:!1,external:a=>{var{chart:a,tooltip:s}=a;let o=a.canvas.parentNode.querySelector("div");if(o||((o=document.createElement("div")).classList.add("c-wps-mini-chart-post-summary-tooltip"),a.canvas.parentNode.appendChild(o)),0===s.opacity)o.style.opacity=0;else if(s.body){var r=s.title||[],i=s.body.map(t=>t.lines);let e="<div>";r.forEach(t=>{e+=`<div class="chart-title">${t}</div>`}),i.forEach((t,a)=>{t=t.join(": ");e+=`<div>${t}</div>`}),o.innerHTML=e;var{offsetLeft:r,offsetTop:a,offsetWidth:n,offsetHeight:l}=a.canvas,i=(o.style.opacity=0===i[0].length?0:1,o.offsetWidth);let t=r+s.caretX-i/2;s=a+l;(t=t<r?r:t)+i>r+n&&(t=r+n-i),o.style.left=t+"px",o.style.top=s+"px"}},callbacks:{title:t=>e[t[0].label].fullDate,label:t=>{t=t.formattedValue;return`<div class="content-itemss"> <div class="content-item"><span>${s}</span> <span>${t}</span></div>`}}}},scales:{x:{offset:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:4,fontColor:"#898A8E",fontSize:12,padding:5}},y:{position:"right",beginAtZero:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:5,fontColor:"#898A8E",fontSize:12,padding:8,stepSize:1}}},layout:{padding:{left:0,right:0,top:0,bottom:0}}},t=jQuery("#"+t)[0].getContext("2d"),i=Object.entries(e).map(([,t])=>t.hits),n=i.length<=30?"bar":"line";"line"==n&&((r=t.createLinearGradient(0,0,0,t.canvas.height-10)).addColorStop(0,wps_js.hex_to_rgba(o,1)),r.addColorStop(.5,wps_js.hex_to_rgba(o,.25)),r.addColorStop(.75,wps_js.hex_to_rgba(o,0)),r.addColorStop(1,wps_js.hex_to_rgba(o,0)));new Chart(t,{type:n,data:{labels:Object.entries(e).map(([t])=>t),datasets:[{data:i,backgroundColor:"line"==n?r:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":wps_js.hex_to_rgba(o,.5)}),hoverBackgroundColor:"line"==n?r:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":o}),pointBackgroundColor:o,fill:"line"==n,barPercentage:.9,categoryPercentage:1,tension:.5,minBarLength:1,borderWidth:"line"==n?1:0,pointRadius:"line"==n?0:void 0,pointHoverRadius:"line"==n?5:void 0,borderColor:o}]},options:a})}};
...
wps_js.quickstats_meta_box={view:function(s=[]){let t="";return t=(t=(t=t+wps_js.summary_meta_box.user_online(s)+'<div class="o-table-wrapper"><table width="100%" class="o-table"><tbody>')+wps_js.summary_meta_box.summary_statistics(s)+"</tbody></table></div>")+`<div class="o-wrap"><div class="wps-postbox-chart--data"><div class="wps-postbox-chart--items"></div><div class="wps-postbox-chart--previousPeriod">${wps_js._("previous_period")}</div></div><div class="wps-postbox-chart--container"><canvas id="${wps_js.chart_id("quickstats")}" height="210"></canvas></div></div>`,0==wps_js.global.stats_report_option&&(t+=`<div class="wp-quickstats-widget__enable-email">
                    ...
                    </div>`),t+=`<a href="${wps_js.global.admin_url}/admin.php?page=wps_overview_page" title="${wps_js._("view_detailed_analytics")}" class="wp-quickstats-widget__link">${wps_js._("view_detailed_analytics")}</a>`},meta_box_init:function(s=[]){document.getElementById(wps_js.chart_id("quickstats"))&&wps_js.new_line_chart(s["hits-chart"],wps_js.chart_id("quickstats"))}};
wps_js.recent_meta_box={view:function(s=[]){let t="";return t=(t+='<div class="o-table-wrapper">')+(`<table width="100%" class="o-table wps-new-table"><thead>
        <tr>
        ...
        </tr></thead><tbody>`),s.forEach(function(s,a){t+=`<tr>
            <td class="wps-pd-l">${s.last_view}</td>
            <td class="wps-pd-l">
                ${wps_js.visitor_info(s)}
            </td>
             </td>`+(wps_js.is_active("geo_ip")?`<td class="wps-pd-l">
                <div class="wps-country-flag wps-ellipsis-parent">
                    <a href="" class="wps-tooltip" title="${s.location.country}">
                        <img src="${s.location.flag}" alt="" width="15" height="15">
                    </a>
                     <span class="wps-ellipsis-text" title="${s.location.location}">${s.location.location}</span>
                </div>
             </td>`:"-")+`
             <td class="wps-pd-l">`+(s.referrer&&""!==s.referrer.name?`<div class="wps-referral-link">
                        <a target="_blank" href="${s.referrer.link}" title="${s.referrer.name}" class="wps-link-arrow wps-link-arrow--external">
                            <span>${s.referrer.name}</span>
                        </a>
                        <span class="wps-referral-label">Referral Traffic</span>
                    </div>`:'<span aria-hidden="true">—</span>')+`
            </td>
            <td class="wps-pd-l">`+(s.last_page&&""!==s.last_page.title?`<a target="_blank" href="${s.last_page.link}" title="${s.last_page.title}" class="wps-link-arrow">
                        <span>${s.last_page.title}</span>
                    </a>`:'<span aria-hidden="true">—</span><span class="screen-reader-text">-</span>')+`
            </td>
            <td class="wps-pd-l">
                <a href="${s.single_url}">${s.hits}</a>
            </td>
			</tr>`}),t=t+"</tbody></table>"+"</div>"}};
wps_js.referring_meta_box={view:function(s=[]){let e='<div class="o-table-wrapper">';return e+=`<table width="100%" class="o-table wps-new-table"><thead>
        <tr>
        ...
        </tr></thead><tbody>`,s.referring.forEach(function(s){e+=`<tr>
			<td class="wps-pd-l"><a class="wps-link-arrow" href='//${s.domain}' title='${s.domain}' target="_blank"><span>${s.domain}</span></a></td>
			<td class="wps-pd-l wps-middle-vertical"><a style="justify-content: flex-end;" href="${s.page_link}">${wps_js.formatNumber(s.number)} </a></td>
			</tr>`}),e+="</tbody></table></div>"}};
wps_js.search_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(s=0){var a="";return a+='<div class="o-wrap"><div class="wps-postbox-chart--data"><div class="wps-postbox-chart--items"></div><div class="wps-postbox-chart--previousPeriod">'+wps_js._("previous_period")+'</div></div><div class="wps-postbox-chart--container"><canvas id="'+wps_js.chart_id("search")+'"></canvas></div></div>'},meta_box_init:function(s=[]){wps_js.new_line_chart(s,wps_js.chart_id("search"))}};
wps_js.summary_meta_box={summary_statistics:function(a=[]){let i="<thead>";if(i+='<tr><th width="50%">'+wps_js._("time")+"</th>",["visitors","visits"].forEach(function(s){i+="<th>"+(wps_js.is_active(s)?wps_js._(s):"")+"</th>"}),i=(i+="</tr>")+"</thead>"+"<tbody>",Object.keys(a).length){let e=["today","yesterday","this-week","last-week","this-month","last-month","7days","30days","90days","6months","this-year","total"];for(let t=0;t<e.length;t++)i+=`<tr><td><b>${wps_js._(e[t])}</b></td>`,["visitors","visits"].forEach(function(s){void 0===a[s]?i+="<td></td>":i+="<td>"+(wps_js.is_active(s)?`<a href="${a[s][e[t]].link}"><span class="quickstats-values">${a[s][e[t]].value}</span></a>`:"")+"</td>"}),i+="</tr>";i+="</tbody>"}return i},user_online:function(s=[]){let t="";return s.user_online&&(t=`<div class="c-live">
                <div>
                    <span class="c-live__status"></span>
                    <span class="c-live__title">${wps_js._("online_users")}</span>
                </div>
            <div class="c-live__online">
                <span class="c-live__online--value">${s.user_online.value}</span>
                <a className="c-live__value" href="${s.user_online.link}"><span class="c-live__online--arrow"></span></a>
            </div>`,t+="</div>"),t},view:function(s=[]){let t="";return t=(t=t+this.user_online(s)+'<div class="o-table-wrapper"><table width="100%" class="o-table o-table--wps-summary-stats">')+this.summary_statistics(s)+"</table></div>",0==wps_js.global.stats_report_option&&(t+=`<div class="wp-quickstats-widget__enable-email">
                    <div class="wp-quickstats-widget__enable-email__desc">
                        <span class="wp-quickstats-widget__enable-email__icon"></span>
                        <div>
                            <p>${wps_js._("receive_weekly_email_reports")}</p>
...
wps_js.top_pages_chart_meta_box={placeholder:function(){return wps_js.rectangle_placeholder()},view:function(t=0){var a="";return setTimeout(function(){wps_js.date_picker()},1e3),a+='<div class="o-wrap"><canvas id="'+wps_js.chart_id("top-pages-chart")+'" height="80"></canvas></div>'},meta_box_init:function(t=[]){this.top_pages_chart(wps_js.chart_id("top-pages-chart"),t)},top_pages_chart:function(t,e=[]){let r=[],s=0;Object.keys(e.stat).forEach(function(t){var a=wps_js.random_color(s);r.push({label:t,data:e.stat[t],backgroundColor:"rgba("+a[0]+","+a[1]+","+a[2]+",0.3)",borderColor:"rgba("+a[0]+","+a[1]+","+a[2]+",1)",borderWidth:1,fill:!0,tension:.4}),s++}),wps_js.line_chart(t,e.title,e.date,r)}};
wps_js.top_visitors_meta_box={view:function(s=[]){let a="",t=(a=(a+='<div class="o-table-wrapper">')+(`<table width="100%" class="o-table wps-new-table"><thead>
        <tr>
            <th class="wps-pd-l"><span class="wps-order">${wps_js._("views")}</span></th>
            <th class="wps-pd-l">${wps_js._("visitor_info")}</th>
            `+(wps_js.is_active("geo_ip")?`<th class="wps-pd-l">${wps_js._("location")}</th>`:"")+`
        ...
        </tr></thead><tbody>`),1);return s.data.forEach(function(s){a+=`<tr>
            <td class="wps-pd-l">
                <a href="${s.single_url}">${s.hits}</a>
            </td>
             <td class="wps-pd-l">
            ...
            <td class="wps-pd-l">`+(s.last_page&&""!==s.last_page.title?`<a target="_blank" href="${s.last_page.link}" title="${s.last_page.title}" class="wps-link-arrow">
             ...
             <td class="wps-pd-l">${s.last_view}</td>
			</tr>`,t++}),a=a+"</tbody></table>"+"</div>"}};
wps_js.useronline_meta_box={view:function(s=[]){let i='<div class="o-table-wrapper">';return i+=`<table class="o-table wps-new-table">
           <thead>
                <tr>
                    <th class="wps-pd-l"><span class="wps-order">${wps_js._("last_view")}</span></th>
                    <th class="wps-pd-l">${wps_js._("visitor_info")}</th>
           ...
           </thead><tbody>`,s.forEach(function(s){i+=`<tr>
            <td class="wps-pd-l">${s.last_view}</td>
            <td class="wps-pd-l">
                ${wps_js.visitor_info(s)}
            </td>`+(wps_js.is_active("geo_ip")?`<td class="wps-pd-l">
            ...
            <td class="wps-pd-l">${s.online_time}</td>
            <td class="wps-pd-l">
                 <a href="${s.single_url}">${s.hits}</a>
            </td>
             </tr>`}),i+="</tbody></table></div>"}},wps_js.visitor_info=function(s){var i=wps_js.isset(wps_js.global,"options","track_users")?wps_js.global.options.track_users:null;let t='<ul class="wps-visitor__information--container">';return 0<Object.keys(s.os).length&&(t+=`<li class="wps-visitor__information">
            <div class="wps-tooltip" title="${s.os.name}">
                <img src="${s.os.logo}" width="15" height="15">
            </div>
        </li>`),0<Object.keys(s.browser).length&&(t+=`<li class="wps-visitor__information">
            <div class="wps-tooltip" title="${s.browser.name}">
                <img src="${s.browser.logo}" width="15" height="15">
            </div>
        </li>`),t+=`
    <li class="wps-visitor__information">
        <div>`,s.user&&0<Object.keys(s.user).length?t+=i?`<a href="${s.single_url}">
                <span class="wps-visitor__information__user-img"></span>
            </a>
            <a class="wps-visitor__information__user-text wps-tooltip" title="${s.user.email} (${s.user.role})" href="${s.single_url}">
                <span title="${s.user.name}">${s.user.name}</span>
                <span>#${s.ID}</span>
            </a>`:`<div class="wps-tooltip" data-tooltip-content="#tooltip_user_id">
                <a href="${s.single_url}"><span class="wps-visitor__information__user-img"></span></a>
            </div>
            <div class="wps-tooltip_templates">
                <div id="tooltip_user_id">
                    ...
                    <div>
                        ${wps_js._("name")}: ${s.user.name}
                    </div>

                    <div>
                        ${wps_js._("email")}: ${s.user.email}
                     </div>
...
if(wps_js.isset(wps_js.global,"request_params","page")&&"exclusions"===wps_js.global.request_params.page){let s;s=wps_js.isset(wps_js.global,"request_params","from")&&wps_js.isset(wps_js.global,"request_params","to")?{from:wps_js.global.request_params.from,to:wps_js.global.request_params.to}:{ago:30},jQuery("span[id^='number-total-chart-']").html(wps_js.rectangle_placeholder("wps-text-placeholder")),wps_js.run_meta_box("exclusions",s,!1)}
...
function updateComplianceInfo(s){var a=jQuery(".wps-privacy-mode__items"),t=jQuery(".wps-adminHeader .wps-adminHeader__side .privacy"),i=jQuery(".wps-privacy-status");a.find(".wps-privacy-mode__item").removeClass("loading"),i.removeClass("loading success warning"),i.find(".wps-privacy-status__bar-passed").css("display","none"),i.find(".wps-privacy-status__bar-need-work").css("display","none"),i.addClass(100==s.percentage_ready?"success":"warning"),i.find(".wps-privacy-status__percent-value").text(s.percentage_ready),i.find(".wps-privacy-status__rules-mapped-value").text(s.rules_mapped),i.find(".wps-privacy-status__passed-value").text(s.summary.passed),i.find(".wps-privacy-status__need-work-value").text(s.summary.action_required),0<s.summary.action_required?(a.find(".wps-privacy-mode__item input:checked").next().find(".wps-privacy-mode__content").text(wps_js._("non_privacy_compliant")),a.find(".wps-privacy-mode__item input:checked").parent().addClass("wps-privacy-mode__item--warning"),i.find(".wps-privacy-status__bar-need-work").css("display","block"),i.find(".wps-privacy-status__bar-need-work").css("width",100-s.percentage_ready+"%"),t.addClass("warning")):(a.find(".wps-privacy-mode__item input:checked").next().find(".wps-privacy-mode__content").text(wps_js._("privacy_compliant")),a.find(".wps-privacy-mode__item input:checked").parent().removeClass("wps-privacy-mode__item--warning"),t.removeClass("warning")),0<s.summary.passed&&(i.find(".wps-privacy-status__bar-passed").css("display","block"),i.find(".wps-privacy-status__bar-passed").css("width",s.percentage_ready+"%"))}function updateAuditElement(s,a){s.attr("class","wps-privacy-list__item wps-privacy-list__item--"+a.status),s.find(".wps-privacy-list__icon").attr("class","wps-privacy-list__icon wps-privacy-list__icon--"+a.status),s.find(".wps-privacy-list__button").attr("class","wps-privacy-list__button wps-privacy-list__button--"+a.status),s.find(".wps-privacy-list__text").html(a.title),s.find(".wps-privacy-list__content").html(a.notes),a.hasOwnProperty("action")&&(s.find(".wps-privacy-list__button").attr("class","wps-privacy-list__button wps-privacy-list__button--"+a.action.key),s.find(".wps-privacy-list__button").attr("data-action",a.action.key),s.find(".wps-privacy-list__button").data("action",a.action.key),s.find(".wps-privacy-list__button").text(a.action.value))}function loadAudits(s){const a=jQuery(".wps-privacy-list .wps-privacy-list__items");a.html(""),a.removeClass("loading"),s.forEach(s=>{s=generateAuditElement(s);a.append(s)})}function generateAuditElement(s){let a="",t=s.status,i=s.compliance.value;return s.hasOwnProperty("action")&&(a+=`data-audit="${s.name}" data-action="${s.action.key}"`,t=s.action.key,i=s.action.value),`
            <div id="${s.name}" class="wps-privacy-list__item wps-privacy-list__item--${s.status}">
                <div class="wps-privacy-list__title">
                    <div>
                        <span class="wps-privacy-list__icon wps-privacy-list__icon--${s.status}"></span>
                        <span class="wps-privacy-list__text">${s.title}</span>
                    </div>
                    <a ${a} class="wps-privacy-list__button wps-privacy-list__button--${t}">${i}</a>
                </div>
                <div class="wps-privacy-list__content">${s.notes}</div>
            </div>`}function loadFaqs(s){const a=jQuery(".wps-privacy-questions .wps-privacy-list__items");a.html(""),a.removeClass("loading"),s.forEach(s=>{s=generateFaqElement(s);a.append(s)})}function generateFaqElement(s){return`
            <div class="wps-privacy-list__item wps-privacy-list__item--${s.status}">
                <div class="wps-privacy-list__title">
                    <span class="wps-privacy-list__icon wps-privacy-list__icon--${s.status}"></span>
                    <div>
                        <span>${s.title}</span>
                ...
                <div class="wps-privacy-list__content">${s.notes}</div>
            </div>`}wps_js.isset(wps_js.global,"request_params","page")&&"privacy-audit"===wps_js.global.request_params.page&&(jQuery(document).ready(()=>{var s={wps_nonce:wps_js.global.rest_api_nonce,action:"wp_statistics_getPrivacyStatus"},s=Object.assign(s,wps_js.global.request_params);jQuery.ajax({url:wps_js.global.admin_url+"admin-ajax.php",type:"GET",dataType:"json",data:s,timeout:3e4,success:function({data:s,success:a}){if(0==a)return console.log(s);updateComplianceInfo(s.compliance_status),loadAudits(s.audit_list),loadFaqs(s.faq_list)},error:function(s,a,t){console.log(t)}})}),jQuery(document).on("click",".wps-privacy-list__button[data-action]",s=>{const t=jQuery(s.currentTarget);var s=t.data("audit"),a=t.data("action");const i=jQuery("#"+s);t.hasClass("loading")||("resolve"===a&&alert(wps_js._("privacy_resolve_alert")),t.addClass("loading"),jQuery(".wps-privacy-questions .wps-privacy-list__items").addClass("loading"),jQuery(".wps-privacy-mode__items .wps-privacy-mode__item").addClass("loading"),jQuery(".wps-privacy-status").addClass("loading"),s={wps_nonce:wps_js.global.rest_api_nonce,action:"wp_statistics_updatePrivacyStatus",audit_name:s,audit_action:a},s=Object.assign(s,wps_js.global.request_params),jQuery.ajax({url:wps_js.global.admin_url+"admin-ajax.php",type:"POST",dataType:"json",data:s,timeout:3e4,success:function({data:s,success:a}){if(0==a)return console.log(s);t.removeClass("loading"),updateComplianceInfo(s.compliance_status),loadFaqs(s.faq_list),s.audit_item&&updateAuditElement(i,s.audit_item)},error:function(s,a,t){console.log(t)}}))}));
if(wps_js.isset(wps_js.global,"request_params","page")&&"referrals"===wps_js.global.request_params.page){if(document.getElementById("incomeVisitorChart")){const a=jQuery("#incomeVisitorChart").parent(),b=wps_js.rectangle_placeholder(),c=(a.append(b),Wp_Statistics_Referrals_Object.search_engine_chart_data);c?.data?.datasets&&0!==c.data.datasets.length?(jQuery(".wps-ph-item").remove(),jQuery(".wps-postbox-chart--data").removeClass("c-chart__wps-skeleton--legend"),a.removeClass("c-chart__wps-skeleton"),wps_js.new_line_chart(c,"incomeVisitorChart",null)):(a.html(wps_js.no_results()),jQuery(".wps-ph-item").remove())}jQuery(document).on("click","div#referral-filter",function(e){e.preventDefault(),tb_show("","#TB_inline?&width=430&height=193&inlineId=referral-filter-popup"),setTimeout(function(){var e="#wps-referral-filter-div";wps_js.exist_tag(e+" input[type=submit]")||(jQuery(e).html('<div style="height: 50px;"></div>'+wps_js.line_placeholder(1)),wps_show_referrals_filter(e))},500)});var FORM_ID="#wps-referrals-filter-form";function wps_show_referrals_filter(e){let t='<table class="o-table wps-referrals-filter">';t=(t=t+`<tr><td class="wps-referrals-filter-title">${wps_js._("search_by_referrer")}</td></tr>`+'<tr><td><select name="referrer" class="wps-select2   wps-width-100">')+`<option value=''>${wps_js._("all")}</option>`+"<option value='test'>test</option>";var r=wps_js.getLinkParams("referrer");null!=r&&(t+=`<option value='${r}'  selected>${r}</option>`),t=(t+="</select></td></tr><tr><td></td></tr>")+`<tr><td><input type="submit" value="${wps_js._("filter")}" class="button-primary"> &nbsp; <span class="filter-loading"></span></td></tr>`+"</table>",jQuery(e).html(t),jQuery(".wps-select2").select2({ajax:{delay:500,url:wps_js.global.ajax_url,dataType:"json",data:function(e){var t,e={wps_nonce:wps_js.global.rest_api_nonce,search:e.term,action:"wp_statistics_search_referrers",paged:e.page||1};return wps_js.isset(wps_js.global,"request_params")&&(t=wps_js.global.request_params).page&&(e.page=t.page),e},error:function(e,t,r){console.error("AJAX request error:",t,r)}}})}jQuery(document).on("submit",FORM_ID,function(){let e={select:["referrer"]};Object.keys(e).forEach(function(t){e[t].forEach(e=>{e=jQuery(FORM_ID+" "+t+"[name="+e+"]");e.val().length<1&&e.prop("disabled",!0)})}),jQuery("span.filter-loading").html(wps_js._("please_wait"))})}
function wp_statistics_getParameterValue(t){t=new RegExp("[?&]"+t+"=([^&#]*)").exec(window.location.href);if(t)return t[1]}function wp_statistics_enableTab(t){jQuery(".wp-statistics-settings .wps-optionsMenu .wps-optionsMenuItem").removeClass("current"),jQuery(".wp-statistics-settings .tab-content").removeClass("current"),jQuery("[data-tab="+t+"]").addClass("current"),jQuery("#"+t).addClass("current"),jQuery("#wp-statistics-settings-form").length&&(t=jQuery(location).attr("href")+"&tab="+t,jQuery("#wp-statistics-settings-form").attr("action",t).submit())}if(jQuery(".wp-statistics-settings").length){var current_tab=wp_statistics_getParameterValue("tab");current_tab&&wp_statistics_enableTab(current_tab),jQuery(".wp-statistics-settings .wps-optionsMenu .wps-optionsMenuItem").click(function(){wp_statistics_enableTab(jQuery(this).attr("data-tab"))});const e=document.querySelector('input[name="user_custom_header_ip_method"]'),f=document.getElementById("custom-header");function checkCustomHeader(){f.checked=!0}e&&f&&(f.addEventListener("change",function(){f.checked&&e.focus()}),e.addEventListener("click",checkCustomHeader),e.addEventListener("paste",checkCustomHeader),e.addEventListener("input",checkCustomHeader),e.addEventListener("dragover",checkCustomHeader),e.addEventListener("drop",checkCustomHeader))}function wp_statistics_check_condition_view_option(t,e){jQuery(document).on("change",t,function(t){t.preventDefault();t=jQuery(e);this.checked?t.show("slow"):(t.hide("slow"),t.find("input[type=checkbox]").prop("checked",!1))})}wp_statistics_check_condition_view_option("input[name=wps_referrerspam]","tr.referrerspam_field");
if(wps_js.isset(wps_js.global,"request_params","page")&&"settings"===wps_js.global.request_params.page){if(jQuery("#wp-statistics-settings-form ul.tabs li").click(function(t){t.preventDefault();t=$(this).attr("data-tab");"undefined"!=typeof localStorage&&localStorage.setItem("wp-statistics-settings-active-tab",t)}),"undefined"!=typeof localStorage&&wps_js.isset(wps_js.global,"request_params","save_setting")&&"yes"===wps_js.global.request_params.save_setting){let t=localStorage.getItem("wp-statistics-settings-active-tab");t&&0<t.length&&$("#wp-statistics-settings-form ul.tabs li[data-tab="+t+"]").click()}const a=document.getElementById("wps_addon_settings[customization][show_wps_about_widget_overview]"),b=document.querySelector('label[for="wps_addon_settings[customization][wps_about_widget_title]"]').parentElement.parentElement,c=document.querySelector('label[for="wps_addon_settings[customization][wps_about_widget_content]"]').parentElement.parentElement;function toggleCustomizationDivs(){"yes"===a.value?(b.style.display="table-row",c.style.display="table-row"):(b.style.display="none",c.style.display="none")}a&&(toggleCustomizationDivs(),a.addEventListener("change",toggleCustomizationDivs))}
...
if(wps_js.isset(wps_js.global,"request_params","page")&&"visitors"===wps_js.global.request_params.page){jQuery(document).on("click","div#visitors-filter",function(t){t.preventDefault(),tb_show("","#TB_inline?&width=430&height=520&inlineId=visitors-filter-popup"),setTimeout(function(){var t,s,e="#wps-visitors-filter-form";wps_js.exist_tag(e+" input[type=submit]")||(jQuery(e).html('<div style="height: 50px;"></div>'+wps_js.line_placeholder(5)),t=localStorage.getItem("wp-statistics-visitors-filter")?JSON.parse(localStorage.getItem("wp-statistics-visitors-filter")):{},!wps_js.isset(t,"timestamp")||!wps_js.isset(t,"value")||wps_js.isset(t,"timestamp")&&wps_js.isset(t,"value")?(s={wps_nonce:wps_js.global.rest_api_nonce,action:"wp_statistics_visitors_page_filters"},s=Object.assign(s,wps_js.global.request_params),jQuery.ajax({url:wps_js.global.admin_url+"admin-ajax.php",type:"GET",dataType:"json",data:s,timeout:3e4,success:function(t){wp_statistics_show_visitors_filter(e,t)},error:function(t,s,e){jQuery("span.tb-close-icon").click()}})):wp_statistics_show_visitors_filter(e,t.value))},500)});var FORM_ID="#wp_statistics_visitors_filter_form";function wp_statistics_show_visitors_filter(t,i){let r='<table class="o-table">',a={browsers:["agent","browsers"],country:["location","location"],platform:["platform","platform"],referrer:["referrer","referrer"],user:["user_id","users"]};Object.keys(a).forEach(s=>{r=(r=(r+=`<tr><td>${wps_js._(s)}</td></tr>`)+`<tr><td><select name="${a[s][0]}" class="select2 wps-width-100" data-type-show="select2">`)+`<option value=''>${wps_js._("all")}</option>`;let e=wps_js.getLinkParams(a[s][0]);Object.keys(i[a[s][1]]).forEach(function(t){r+=`<option value='${t}' ${null!=e&&e.replace(/\+/g," ")==t?"selected":""}>${i[a[s][1]][t]}</option>`}),r+="</select></td></tr>"}),r=(r=(r+=`<tr><td>${wps_js._("ip")}</td></tr>`)+`<tr><td><input name="ip" value="${null!=wps_js.getLinkParams("ip")?decodeURIComponent(wps_js.getLinkParams("ip")):""}" class="wps-width-100" placeholder='xxx.xxx.xxx.xxx' autocomplete="off"></td></tr>`+"<tr><td></td></tr>")+`<tr><td><input type="submit" value="${wps_js._("filter")}" class="button-primary"> &nbsp; <span class="filter-loading"></span></td></tr>`+"</table>",jQuery(t).html(r),wps_js.select2()}if(jQuery(document).on("submit",FORM_ID,function(){var t=jQuery(FORM_ID+" input[name=ip]").val();if(0<t.length&&!1===t.includes("#hash#")&&!1===wps_js.isIP(t))return alert(wps_js._("er_valid_ip")),!1;let e={input:["ip"],select:["agent","platform","location","referrer","user_id"]};Object.keys(e).forEach(function(s){e[s].forEach(t=>{t=jQuery(FORM_ID+" "+s+"[name="+t+"]");t.val().length<1&&t.prop("disabled",!0)})});t=wps_js.getLinkParams("order");return null!=t&&jQuery(this).append('<input type="hidden" name="order" value="'+t+'" /> '),jQuery("span.filter-loading").html(wps_js._("please_wait")),!0}),document.getElementById("trafficTrendsChart")){const v=Wp_Statistics_Visitors_Object.traffic_chart_data;wps_js.new_line_chart(v,"trafficTrendsChart",null)}if(document.getElementById("LoggedInUsersChart")){const w=[];wps_js.new_line_chart(w,"LoggedInUsersChart",null)}}
