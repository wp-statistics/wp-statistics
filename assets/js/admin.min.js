...
jQuery(document).ready(function(){const r=jQuery(".js-date-range-picker-btn"),o=jQuery(".js-date-range-picker-input"),l=jQuery(".js-date-range-picker-form");var e=jQuery(".wps-js-calendar-field"),t=wps_js.isset(wps_js.global,"options","wp_timezone")?wps_js.global.options.wp_timezone:null;let c=t;t&&(t.startsWith("+")||t.startsWith("-"))&&(c="UTC"+t),r.length&&moment.updateLocale("en",{week:{dow:parseInt(wps_js._("start_of_week"))}});var a=c?c.startsWith("UTC")||c.startsWith("+")||c.startsWith("-")?([t,a]=c.replace("UTC","").split(":").map(Number),t=60*t+(t<0?-Math.abs(a):a),moment().utcOffset(t)):moment.tz.zone(c)?moment().tz(c):moment().utc():moment().utc();if(r.length&&o.length&&l.length){r.on("click",function(){o.trigger("click")});t={Today:[a.clone().startOf("day"),a.clone().startOf("day")],Yesterday:[a.clone().subtract(1,"days").startOf("day"),a.clone().subtract(1,"days").startOf("day")],"This Week":[a.clone().startOf("week"),a.clone().endOf("week")],"Last Week":[a.clone().subtract(1,"week").startOf("week"),a.clone().subtract(1,"week").endOf("week")],"This Month":[a.clone().startOf("month"),a.clone().endOf("month")],"Last Month":[a.clone().subtract(1,"month").startOf("month"),a.clone().subtract(1,"month").endOf("month")],"Last 7 Days":[a.clone().subtract(6,"days"),a.clone()],"Last 30 Days":[a.clone().subtract(29,"days"),a.clone()],"Last 90 Days":[a.clone().subtract(89,"days"),a.clone()],"Last 6 Months":[a.clone().subtract(6,"months"),a.clone()],"This Year":[a.clone().startOf("year"),a.clone().endOf("year")]};function s(){return new URLSearchParams(window.location.search).get("post_id")}if(r.hasClass("js-date-range-picker-all-time")){let e=moment(0);e=s()?wps_js.global.post_creation_date?moment(wps_js.global.post_creation_date):moment(0):wps_js.global.initial_post_date?moment(wps_js.global.initial_post_date):moment(0),t["All Time"]=[e,moment()]}var n=function(e){const a={d:"DD",j:"D",S:"Do",n:"M",m:"MM",F:"MMMM",M:"MMM",y:"YY",Y:"YYYY"};return e.replace(/([a-zA-Z])/g,e=>a[e]||e)}(r.attr("data-date-format")?r.attr("data-date-format"):"MM/DD/YYYY"),i=moment(wps_js.global.user_date_range.from).format("YYYY-MM-DD"),d=moment(wps_js.global.user_date_range.to).format("YYYY-MM-DD");if(o.daterangepicker({autoApply:!0,ranges:t,startDate:i,endDate:d}),wps_js.isset(wps_js.global,"request_params","from")&&wps_js.isset(wps_js.global,"request_params","to")){let e=wps_js.global.request_params.from;s()&&wps_js.global.post_creation_date&&(e=wps_js.global.post_creation_date);var t=wps_js.global.request_params.to,m=(o.data("daterangepicker").setStartDate(moment(e).format("MM/DD/YYYY")),o.data("daterangepicker").setEndDate(moment(t).format("MM/DD/YYYY")),o.data("daterangepicker").updateCalendars(),o.data("daterangepicker").chosenLabel),p=moment(e),t=moment(t);let a;a=p.year()===t.year()?(g=n.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,""),p.format(g)+" - "+t.format(n)):p.format(n)+" - "+t.format(n),"Custom Range"!==m&&("All Time"!==m?(a=`<span class="wps-date-range">${m}</span>`+a,document.querySelector(".js-date-range-picker-btn").classList.add("custom-range")):a=m),r.find("span").html(a)}else{var g=moment(i),p=moment(d);o.data("daterangepicker").setStartDate(moment(i).format("MM/DD/YYYY")),o.data("daterangepicker").setEndDate(moment(d).format("MM/DD/YYYY")),o.data("daterangepicker").updateCalendars();let e;e=g.year()===p.year()?(t=n.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,""),g.format(t)+" - "+p.format(n)):g.format(n)+" - "+p.format(n);const Y=o.data("daterangepicker").container.find(".ranges li.active").text();o.data("daterangepicker").container.find(".ranges li.active").removeClass("active"),o.data("daterangepicker").container.find('.ranges li[data-range-key="'+Y+'"]').addClass("active"),"Custom Range"!==Y&&("All Time"!==Y?(e=`<span class="wps-date-range">${Y}</span>`+e,document.querySelector(".js-date-range-picker-btn").classList.add("custom-range")):e=e),r.find("span").html(e),o.on("show.daterangepicker",function(e,a){o.data("daterangepicker").container.find(".ranges li.active").removeClass("active"),o.data("daterangepicker").container.find('.ranges li[data-range-key="'+Y+'"]').addClass("active")})}o.on("show.daterangepicker",function(e,a){a=a.container;jQuery(a).addClass(e.target.className)}),o.on("apply.daterangepicker",function(e,a){var t=l.find(".js-date-range-picker-input-from").first(),s=l.find(".js-date-range-picker-input-to").first(),n=a.startDate.utcOffset(c).format("YYYY-MM-DD"),a=a.endDate.utcOffset(c).format("YYYY-MM-DD"),n=(t.val(n),s.val(a),o.data("daterangepicker").chosenLabel);r.find("span").html(n),"All Time"!==n?jQuery.ajax({url:wps_js.global.ajax_url,method:"POST",data:{wps_nonce:wps_js.global.rest_api_nonce,action:"wp_statistics_store_date_range",date:{from:t.val(),to:s.val()}},beforeSend:function(){r.addClass("wps-disabled")},complete:function(e){l.submit()}}):l.submit()})}e.length&&(e.daterangepicker({singleDatePicker:!0,showDropdowns:!0,minYear:1998,maxYear:parseInt((new Date).getFullYear()+1),locale:{format:"YYYY-MM-DD"}}),e.on("show.daterangepicker",function(e,a){a=a.container;jQuery(a).addClass(e.target.className)}),e.on("apply.daterangepicker",function(e,a){jQuery(".wps-today-datepicker").submit()}))});
...
wps_js.exist_tag=function(e){return jQuery(e).length},wps_js.loading_button=function(e){e.classList.add("wps-loading-button")},wps_js.date_picker=function(){var e=jQuery("input[data-wps-date-picker]");e.length&&(e.daterangepicker({singleDatePicker:!0,showDropdowns:!0,minYear:1998,drops:"up",opens:document.getElementById("TB_window")?"center":"right",maxYear:parseInt((new Date).getFullYear()+1),locale:{format:"YYYY-MM-DD"}}),e.on("show.daterangepicker",function(e,t){t=t.container;jQuery(t).addClass(e.target.className)}))},wps_js.formatNumber=function(e,t=0){if(null===e)return null;if(e=parseFloat(e.toString().trim().replace(/[, ]/g,"")),isNaN(e))return null;if(0===e)return"0";t=!t||t<0?0:t;var s=parseInt(e).toPrecision(2).split("e"),s=1===s.length?0:Math.floor(Math.min(s[1].slice(1),14)/3),e=s<1?e.toFixed(0+t):(e/Math.pow(10,3*s)).toFixed(1+t);return(e<0?e:Math.abs(e))+["","K","M","B","T"][s]},wps_js.select2=function(){jQuery("select[data-type-show=select2]").select2()};const wpsSelect2=jQuery(".wps-select2"),wpsBody=jQuery("body"),wpsDropdown=jQuery(".wps-dropdown");if(wpsSelect2.length){const n=jQuery(".wps-filter-page"),o=jQuery(".wps-filter-visitor"),p=wpsBody.hasClass("rtl")?"rtl":"ltr",q=n.length?n:o,r=(e,s)=>{wpsSelect2.select2({dropdownParent:e,dir:p,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown",minimumInputLength:1,ajax:{delay:500,url:wps_js.global.ajax_url,dataType:"json",data:function(e){var t,e={wps_nonce:wps_js.global.rest_api_nonce,search:e.term,action:s,paged:e.page||1};return wps_js.isset(wps_js.global,"request_params")&&((t=wps_js.global.request_params).author_id&&(e.author_id=t.author_id),t.page&&(e.page=t.page),t.pt&&(e.post_type=t.pt),t.pid)&&(e.post_id=t.pid),e},processResults:function(e){return e&&Array.isArray(e.results)?{results:e.results.map(e=>({id:e.id,text:e.text})),pagination:{more:!1}}:(console.error("Expected an array of results but got:",e),{results:[]})},error:function(e,t,s){console.error("AJAX request error:",t,s)}}})};wpsSelect2.select2({dropdownParent:q,dir:p,dropdownAutoWidth:!0,dropdownCssClass:"wps-select2-filter-dropdown"}),wpsSelect2.on("select2:open",()=>wpsDropdown.addClass("active")),wpsSelect2.on("select2:close",()=>wpsDropdown.removeClass("active")),wpsSelect2.on("change",function(){var e=jQuery(this).find("option:selected").val();e&&(window.location.href=e)}),n.length&&(r(n,"wp_statistics_get_page_filter_items"),n.on("click",()=>wpsSelect2.select2("open"))),o.length&&(r(o,"wp_statistics_search_visitors"),o.on("click",()=>wpsSelect2.select2("open")))}wps_js.tooltip=function(){jQuery(".wps-tooltip").tooltipster({theme:"tooltipster-shadow",contentCloning:!0}),jQuery("body").on("mouseenter touchstart",".wps-tooltip:not(.tooltipstered)",function(){$(this).tooltipster({theme:"tooltipster-shadow"}).tooltipster("open")})},wps_js.tooltip(),wps_js.redirect=function(e){window.location.replace(e)},wps_js.horizontal_bar=function(e,s,n,o){e=document.getElementById(e);if(e){var t=e.parentNode,r=e.nextSibling,i=(t.removeChild(e),n.reduce((e,t)=>e+t,0)),a=document.createElement("div");a.classList.add("wps-horizontal-bar");for(let t=0;t<n.length;t++){var l=i?n[t]/i*100:0;let e=l%1==0?l.toFixed(0):l.toFixed(1);e.endsWith(".0")&&(e=e.slice(0,-2));var d=document.createElement("div"),p=(d.classList.add("wps-horizontal-bar__item"),document.createElement("div")),c=(p.classList.add("wps-horizontal-bar__label-image-container"),o&&o[t]&&"undefined"!==o[t]&&((c=document.createElement("img")).src=o[t],c.alt=s[t],c.classList.add("wps-horizontal-bar__image"),p.appendChild(c)),document.createElement("div")),p=(c.innerHTML=s[t],c.setAttribute("title",s[t]),c.classList.add("wps-horizontal-bar__label"),p.appendChild(c),d.appendChild(p),document.createElement("div")),u=(p.classList.add("wps-horizontal-bar__data-percent-container"),document.createElement("div")),u=(u.innerHTML=`<span>${wps_js.formatNumber(n[t])}</span><span>${e}%</span>`,u.classList.add("wps-horizontal-bar__data"),p.appendChild(u),d.appendChild(p),document.createElement("div"));u.classList.add("wps-horizontal-bar__background"),u.style.width=l+"%",d.appendChild(u),a.appendChild(d)}r?t.insertBefore(a,r):t.appendChild(a)}},wps_js.chart_id=function(e){return"wp-statistics-"+e+"-meta-box-chart"},wps_js.wordpress_postbox_ajax=function(e="enable"){var t=jQuery(".postbox .hndle, .postbox .handlediv");"enable"===e?t.on("click",window.postboxes.handle_click):t.off("click",window.postboxes.handle_click)},wps_js.isset=function(t){var s=Array.prototype.slice.call(arguments,1);for(let e=0;e<s.length;e++){if(!t||!t.hasOwnProperty(s[e]))return!1;t=t[s[e]]}return!0},wps_js.number_format=function(e,t,s,n){var o;if(null!=e&&isFinite(e))return t||(t=1<(o=e.toString().split(".").length)?o:0),s=s||".",n=n||",",(o=(e=(e=parseFloat(e).toFixed(t)).replace(".",s)).split(s))[0]=o[0].replace(/\B(?=(\d{3})+(?!\d))/g,n),o.join(s);throw new TypeError("number is not valid")},wps_js.set_equal_height=function(e,t){var s=jQuery(e).height(),n=jQuery(t).height();let o=t,r=s;s<n&&(o=e,r=n),jQuery(o).css("height",r+"px")},wps_js.Create_Half_PostBox=function(e,t){return`<div class="postbox-container wps-postbox-half ${e}"><div class="metabox-holder"><div class="meta-box-sortables"> <div class="postbox" id="${t}"> <div class="inside"></div></div></div></div></div>`},wps_js.isIP=function(e){var t="(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]?|0)";return new RegExp(`^${t}\\.${t}\\.${t}\\.${t}$`).test(e)},wps_js.getLinkParams=function(e,t=!1){t=(t=t||window.location.href).match(new RegExp("(?:[?&]"+e+"=)([^&]+)"));return t?t[1]:null},wps_js.sum=function(e){return e.reduce(function(e,t){return e+t},0)},wps_js.no_results=function(){return'<div class="o-wrap o-wrap--no-data wps-center">'+wps_js._("no_result")+"</div>"},jQuery(document).ready(function(){var e=document.querySelectorAll(".wps-head-filters__item"),t=(e.forEach(function(s){s.classList.remove("loading"),s.addEventListener("click",function(e){var t=s.querySelector(".dropdown-content");t&&t.classList.toggle("show")})}),jQuery(".wps-search-dropdown"));t.on("click",function(e){e.stopPropagation()}),t.on("input",function(){let e=jQuery(this).val().toLowerCase();jQuery(this).parent().find(".dropdown-item").each(function(){-1<(jQuery(this).text()||jQuery(this).innerText).toLowerCase().indexOf(e)?jQuery(this).show():jQuery(this).hide()})}),window.addEventListener("click",function(s){e.forEach(function(e){var t=e.querySelector(".dropdown-content");t&&!e.contains(s.target)&&t.classList.remove("show")})})}),jQuery(document).ready(function(){var e=document.querySelector(".wp-header-end"),t=document.querySelector(".notice.notice-warning.update-nag");e&&t&&e.parentNode.insertBefore(t,e.nextSibling)});
wps_js.hex_to_rgba=function(t,e){t=(t=4===(t="string"!=typeof t||"#"!==t[0]||7!==t.length&&4!==t.length?"#3288D7":t).length?"#"+t[1].repeat(2)+t[2].repeat(2)+t[3].repeat(2):t).replace("#","");var a=parseInt(t.substring(0,2),16),o=parseInt(t.substring(2,4),16),t=parseInt(t.substring(4,6),16);return wps_js.rgba_to_hex(a,o,t,e)},wps_js.rgba_to_hex=function(t,e,a,o){return"#"+t.toString(16).padStart(2,"0")+e.toString(16).padStart(2,"0")+a.toString(16).padStart(2,"0")+Math.round(255*o).toString(16).padStart(2,"0")};const chartColors={Total:"#27A765",Views:"#7362BF",Visitors:"#3288D7",Posts:"#8AC3D0",Other1:"#3288D7",Other2:"#7362BF",Other3:"#8AC3D0"},chartTensionValues=[.1,.3,.5,.7],getOrCreateTooltip=t=>{let e=t.canvas.parentNode.querySelector("div");var a;return e||((e=document.createElement("div")).classList.add("wps-chart-tooltip"),e.style.opacity=1,e.style.pointerEvents="none",e.style.position="absolute",e.style.transition="all .1s ease",(a=document.createElement("table")).style.margin="0px",e.appendChild(a),t.canvas.parentNode.appendChild(e)),e},externalTooltipHandler=(wps_js.setTooltipPosition=function(t,e,a){var{offsetLeft:e,offsetTop:o,clientWidth:r,clientHeight:s}=e.canvas,{caretX:a,caretY:l}=a,n=t.offsetWidth,i=t.offsetHeight,d=16;let c=e+a+d,p=o+l-i/2;(c=c+n+d>e+r?e+a-n-d:c)<e+d&&(c=e+d),(p=p<o+d?o+d:p)+i+d>o+s&&(p=o+s-i-d),t.style.opacity=1,t.style.left=c+"px",t.style.top=p+"px"},(t,s,l,n,i,d)=>{const{chart:c,tooltip:e}=t,p=c.options.plugins.tooltip.unitTime;t=getOrCreateTooltip(c);if(0===e.opacity)t.style.opacity=0;else if(e.body){var a=e.title||[];const h=e.dataPoints[0].dataIndex,u=c.data.datasets;let r="<div>";a.forEach(t=>{var e,a,o;"day"===p?({date:e,day:a}=(s.data||s).labels[h],o=wps_js.isset(wps_js.global,"options","wp_date_format")?wps_js.global.options.wp_date_format:"MM/DD/YYYY",o=phpToMomentFormat(o),r+=`<div class="chart-title">${moment(e).format(o)} (${a})</div>`):"month"===p?r+=`<div class="chart-title">${i[h]}</div>`:r+=`<div class="chart-title">${l[h]}</div>`}),u.forEach((e,a)=>{var a=c.getDatasetMeta(a),o=e.label.includes("(Previous)"),o=(a.hidden||o||(a=e.data[h],r+=`
                <div class="current-data">
                ...
                </div>`),u.find(t=>t.label===e.label+" (Previous)"));if(o){var a=c.getDatasetMeta(u.indexOf(o)),t=document.querySelector(".wps-postbox-chart--previousPeriod"),t=t&&t.classList.contains("wps-line-through");if(!a.hidden&&!t){a=o.data[h]||0;let t=null;void 0===(t=("day"!==p&&"month"===p?d:n)[h])&&(t="N/A"),r+=`
                    ...
                    </div>`}}}),r+="</div>",t.innerHTML=r,wps_js.setTooltipPosition(t,c,e)}}),drawVerticalLinePlugin={id:"drawVerticalLine",beforeDatasetDraw(t){var{ctx:t,scales:{},tooltip:e,chartArea:{top:a,bottom:o}}=t;e&&e._active&&e._active.length&&(e=e._active[0].element.x,t.beginPath(),t.strokeStyle="#A9AAAE",t.lineWidth=1,t.setLineDash([6,6]),t.moveTo(e,a),t.lineTo(e,o),t.stroke(),t.setLineDash([]))}},phpToMomentFormat=t=>{const e={d:"DD",j:"D",S:"Do",n:"M",m:"MM",F:"MMM",M:"MMM",y:"YY",Y:"YYYY"};return t.replace(/([a-zA-Z])/g,t=>e[t]||t)},formatDateRange=(t,e,a,o,r)=>{var s=o.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,"");return"month"===a?(a=o.replace(/D+/g,"").replace(/\/\//g,"/").replace(/^\//,"").replace(/\/$/,"").replace(/\s*,/,"").replace(/-$/,"").trim(),moment(t).format(a)):moment(t).year()===moment(e).year()?moment(t).format(s)+" to "+moment(e).format(o):moment(t).format(o)+" to "+moment(e).format(o)},setMonthDateRange=(t,e,a)=>{var o=a.replace(/,?\s?(YYYY|YY)[-/\s]?,?|[-/\s]?(YYYY|YY)[-/\s]?,?/g,"");return moment(t).year()===moment(e).year()?moment(t).format(o)+" to "+moment(e).format(a):moment(t).format(a)+" to "+moment(e).format(a)},aggregateData=(l,n,i,d,c)=>{if(!(l&&l.length&&n&&n.length))return console.error("Invalid input: labels or datasets are empty."),{aggregatedLabels:[],aggregatedData:n?n.map(()=>[]):[],monthTooltipTitle:[]};if("day"===i)return{aggregatedLabels:l.map(t=>t.formatted_date),aggregatedData:n.map(t=>t.data),monthTooltipTitle:[]};const p=[],h=n.map(()=>[]),u=[],g={};if("week"===i){var t=moment(l[0].date),a=moment(l[l.length-1].date);const s=[];let e=t.clone();for(;e.isSameOrBefore(a);){let t=e.clone().add(6,"days");if(t.isAfter(a)&&(t=a.clone()),s.push({start:e.clone(),end:t,key:e.format("YYYY-[W]WW"),data:n.map(()=>0)}),(e=e.clone().add(7,"days")).isAfter(a))break}l.forEach((t,a)=>{const e=moment(t.date),o=s.find(t=>e.isSameOrAfter(t.start,"day")&&e.isSameOrBefore(t.end,"day"));o&&n.forEach((t,e)=>{o.data[e]+=t.data[a]||0})}),s.forEach(t=>{var e=formatDateRange(t.start,t.end,i,d,c);p.push(e),u.push(setMonthDateRange(t.start,t.end,d)),t.data.forEach((t,e)=>{h[e]||(h[e]=[]),h[e].push(t)})})}else if("month"===i){for(var t=moment(l[0].date),e=moment(l[l.length-1].date),o=t.clone();o.isSameOrBefore(e,"month");){var r=o.format("YYYY-MM");g[r]||(g[r]={startDate:o.clone().startOf("month"),endDate:o.clone().endOf("month"),indices:[]}),o.add(1,"month")}l.forEach((t,e)=>{t=moment(t.date).format("YYYY-MM");g[t]&&g[t].indices.push(e)}),Object.keys(g).forEach(t=>{const{startDate:e,endDate:a,indices:o}=g[t];var r,t=moment.max(e,moment(l[0].date)),s=moment.min(a,moment(l[l.length-1].date));0<o.length&&(r=formatDateRange(t,s,i,d,c),p.push(r),n.forEach((a,t)=>{var e=o.reduce((t,e)=>t+(a.data[e]||0),0);h[t].push(e)}),u.push(setMonthDateRange(t,s,d)))})}return{aggregatedLabels:p,aggregatedData:h,monthTooltipTitle:u}},updateLegend=(d,c,t,p)=>{t=document.getElementById(t);const h=t.parentElement.parentElement.querySelector(".wps-postbox-chart--items");if(h){h.innerHTML="",c.sort((t,e)=>"Total"===t.label?-1:"Total"===e.label?1:"Total (Previous)"===t.label?-1:"Total (Previous)"===e.label?1:0);const u=t.parentElement.parentElement.querySelector(".wps-postbox-chart--previousPeriod");u&&c.some(t=>t.label.includes("(Previous)"))&&(u.style.display="flex",u.style.cursor="pointer",u.addEventListener("click",function(){const a=u.classList.contains("wps-line-through");u.classList.toggle("wps-line-through"),c.forEach((t,e)=>{t.label.includes("(Previous)")&&(d.getDatasetMeta(e).hidden=!a)}),h.querySelectorAll(".previous-data").forEach(t=>{a?t.classList.remove("wps-line-through"):t.classList.add("wps-line-through")}),d.update()})),c.forEach((o,r)=>{if(!o.label.includes("(Previous)")){var e=o.data.reduce((t,e)=>Number(t)+Number(e),0);let t=null,a=null;0<p?.previousData?.datasets.length&&(s=p.previousData.datasets.find((t,e)=>t.label===o.label&&(a=e,!0)))&&s.data&&(t=s.data.reduce((t,e)=>Number(t)+Number(e),0));var s=document.createElement("div"),l=(s.className="wps-postbox-chart--item",null!==t?`
                <div class="previous-data">
                    <span>
                ...
                <div>
                    ...
                    ${l}
                </div>`;const n=s.querySelector(".current-data"),i=(n.addEventListener("click",function(){var t=d.getDatasetMeta(r);t.hidden=!t.hidden,n.classList.toggle("wps-line-through"),d.update()}),s.querySelector(".previous-data"));i&&null!==a&&i.addEventListener("click",function(){var t=d.data.datasets.find((t,e)=>t.label===c[r].label+" (Previous)"&&d.getDatasetMeta(e));t&&(t=d.data.datasets.indexOf(t),(t=d.getDatasetMeta(t)).hidden=!t.hidden,i.classList.toggle("wps-line-through"),t=h.querySelectorAll(".previous-data"),t=Array.from(t).every(t=>t.classList.contains("wps-line-through")),u&&(t?u.classList.add("wps-line-through"):u.classList.remove("wps-line-through")),d.update())}),h.appendChild(s)}})}},deepCopy=t=>JSON.parse(JSON.stringify(t)),chartInstances={},getDisplayTextForUnitTime=(t,e)=>{e=document.querySelector("#"+e).closest(".o-wrap").querySelector(".js-unitTimeSelect");if(e){e=e.querySelector(`.wps-unit-time-chart__option[data-value="${t}"]`);if(e)return e.textContent.trim()}return t};wps_js.new_line_chart=function(l,n,t=null,i="line"){const d=deepCopy(l);var e=wps_js.isset(wps_js.global,"options","wp_date_format")?wps_js.global.options.wp_date_format:"MM/DD/YYYY",e=phpToMomentFormat(e);const c=null!==document.getElementById(n).closest("#dashboard-widgets");var a=l.data.labels.map(t=>t.formatted_date).length;let o=a<=("performance"===i?30:60)?"day":a<=180?"week":"month";var a=1===l.data.labels.length,r=document.querySelector("#"+n).closest(".o-wrap").querySelector(".js-unitTimeSelect");r&&((D=r.querySelector(".wps-unit-time-chart__selected-item"))&&(D.textContent=getDisplayTextForUnitTime(o,n)),r.querySelectorAll(".wps-unit-time-chart__option").forEach(t=>{t.getAttribute("data-value")===o?t.classList.add("selected"):t.classList.remove("selected")}));const p=aggregateData(d.data.labels,d.data.datasets,"day",e,c),h=aggregateData(d.data.labels,d.data.datasets,"week",e,c),u=aggregateData(d.data.labels,d.data.datasets,"month",e,c),g=d.previousData?aggregateData(d.previousData.labels,d.previousData.datasets,"day",e,c):null,m=d.previousData?aggregateData(d.previousData.labels,d.previousData.datasets,"week",e,c):null,v=d.previousData?aggregateData(d.previousData.labels,d.previousData.datasets,"month",e,c):null;let f=("day"==o?p:"week"==o?h:u).aggregatedLabels,b=("day"==o?p:"week"==o?h:u).monthTooltipTitle,y="day"==o?g?g.monthTooltipTitle:[]:"week"==o?m?m.monthTooltipTitle:[]:v?v.monthTooltipTitle:[],w=[],s=[];if(m)for(w=m.aggregatedLabels,s=m.aggregatedData;w.length<f.length;)w.push("N/A"),s.forEach(t=>t.push(0));else w=Array(f.length).fill("N/A"),_&&0<_.length&&Array.isArray(_)&&(s=_.map(()=>Array(f.length).fill(0)));function C(t){var e=getDisplayTextForUnitTime(t,n),a=document.querySelector("#"+n).closest(".o-wrap").querySelector(".js-unitTimeSelect");a&&(a=a.querySelector(".wps-unit-time-chart__selected-item"))&&(a.textContent=e);let o,r;switch(t){case"day":o=p,r=g;break;case"week":o=h,r=m;break;case"month":o=u,r=v;break;default:o=p,r=g}f=o.aggregatedLabels,b=o.monthTooltipTitle,w=r?r.aggregatedLabels:[],y=r?r.monthTooltipTitle:[],0===w.length&&0<f.length&&(w=Array(f.length).fill("N/A"));const s=l.data.datasets.map((t,e)=>{var a=t.type||("performance"===i&&2===e?"bar":"line");return{...t,type:a,data:o.aggregatedData[e],borderColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],backgroundColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],fill:!1,yAxisID:"bar"===a?"y1":"y",borderWidth:"line"===a?2:void 0,pointRadius:"line"===a?0:void 0,pointBorderColor:"line"===a?"transparent":void 0,pointBackgroundColor:"line"===a?chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)]:void 0,pointBorderWidth:"line"===a?2:void 0,hoverPointRadius:"line"===a?6:void 0,hoverPointBorderColor:"line"===a?"#fff":void 0,hoverPointBackgroundColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],hoverPointBorderWidth:"line"===a?4:void 0,tension:"line"===a?chartTensionValues[e%chartTensionValues.length]:void 0,hitRadius:10}});r&&l.previousData.datasets.forEach((t,e)=>{s.push({...t,type:"line",label:t.label+" (Previous)",data:r.aggregatedData[e],borderColor:wps_js.hex_to_rgba(chartColors[t.label]||chartColors["Other"+e],.7),hoverBorderColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],backgroundColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],fill:!1,yAxisID:"y",borderWidth:1,borderDash:[5,5],pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:chartColors[l.data.datasets[e].label]||chartColors["Other"+(e+1)],hoverPointBorderWidth:4,tension:chartTensionValues[e%chartTensionValues.length],hitRadius:10})}),T.data.labels=f,T.options.scales.x.offset=1===T.data.labels.length,T.data.datasets=s,T.options.scales.x.ticks.maxTicksLimit=c?"week"===t?2:4:"week"===t?3:"month"===t?7:9,T.options.plugins.tooltip.unitTime=t,T.options.plugins.tooltip.external=t=>externalTooltipHandler(t,d,f,w,b,y),T.update()}var D=document.getElementById(n).getContext("2d");const _=[];Object.keys(l.data.datasets).forEach((t,e)=>{var a=chartColors[l.data.datasets[t].label]||chartColors["Other"+(e+1)],o=chartTensionValues[e%chartTensionValues.length];let r="line";e={type:r="performance"===i&&2===e?"bar":r,label:l.data.datasets[t].label,data:l.data.datasets[t].data,backgroundColor:a,hoverBackgroundColor:a,hoverPointBackgroundColor:a,yAxisID:"bar"===r?"y1":"y"};"line"===r&&(e.borderColor=a,e.fill=!1,e.borderWidth=2,e.pointRadius=0,e.pointBorderColor="transparent",e.pointBackgroundColor=a,e.pointBorderWidth=2,e.hoverPointRadius=6,e.hoverPointBorderColor="#fff",e.hoverPointBorderWidth=4,e.tension=o,e.hitRadius=10),_.push(e)}),l?.previousData&&Object.keys(l.previousData.datasets).forEach((t,e)=>{var a=chartColors[l.previousData.datasets[t].label]||chartColors["Other"+e],e=chartTensionValues[e%chartTensionValues.length];_.push({type:"line",label:l.previousData.datasets[t].label+" (Previous)",data:l.previousData.datasets[t].data,borderColor:wps_js.hex_to_rgba(a,.7),hoverBorderColor:a,backgroundColor:a,fill:!1,yAxisID:"y",borderWidth:1,borderDash:[5,5],pointRadius:0,pointBorderColor:"transparent",pointBackgroundColor:a,pointBorderWidth:2,hoverPointRadius:6,hoverPointBorderColor:"#fff",hoverPointBackgroundColor:a,hoverPointBorderWidth:4,tension:e,hitRadius:10})});r={maintainAspectRatio:!1,resizeDelay:200,animation:{duration:0},responsive:!0,interaction:{intersect:!1,mode:"index"},plugins:{legend:!1,tooltip:{enabled:!1,external:t=>externalTooltipHandler(t,d,f,w,b,y),unitTime:o}},scales:{x:{offset:a,grid:{display:!1,drawBorder:!1,tickLength:0,drawTicks:!1},border:{color:"transparent",width:0},ticks:{align:"inner",autoSkip:!0,maxTicksLimit:c?"week"==o?2:4:"week"==o?3:"month"==o?7:9,font:{color:"#898A8E",style:"italic",weight:"lighter",size:c?"week"==o?9:11:"week"==o?11:13},padding:8}},y:{min:0,suggestedMax:4,ticks:{maxTicksLimit:c?4:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},border:{color:"transparent",width:0},type:"linear",position:"right",grid:{display:!0,tickMarkLength:0,drawBorder:!1,tickColor:"#EEEFF1",color:"#EEEFF1"},gridLines:{drawTicks:!1},title:{display:!1}}}};"performance"===i&&2<l.data.datasets.length&&(r.scales.y1={type:"linear",position:"left",border:{color:"transparent",width:0},grid:{display:!1,drawBorder:!1,tickLength:0},ticks:{maxTicksLimit:7,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},title:{display:!0,text:wps_js._("published")+" Posts",color:"#898A8E",fontSize:13}},r.scales.y={border:{color:"transparent",width:0},ticks:{maxTicksLimit:9,fontColor:"#898A8E",fontSize:13,fontStyle:"italic",fontFamily:'"Roboto",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif',fontWeight:"lighter ",padding:8,lineHeight:15,stepSize:1},position:"right",grid:{display:!0,borderDash:[5,5],tickColor:"#EEEFF1",color:"#EEEFF1"},title:{display:!0,text:wps_js._("visits"),color:"#898A8E",fontSize:13}});const T=new Chart(D,{type:"performance"===i&&2<l.data.datasets.length?"bar":"line",data:{labels:[],datasets:[]},plugins:[drawVerticalLinePlugin],options:Object.assign({},r,t)});return updateLegend(T,_,n,l),C(o),chartInstances[n]={chart:T,updateChart:C},chartInstances[n]},document.body.addEventListener("click",function(t){const e=t.target.closest(".wps-unit-time-chart__selected-item");var a=t.target.closest(".wps-unit-time-chart__option");if(e)a||(document.querySelectorAll(".js-unitTimeSelect.open").forEach(t=>{t!==e&&t.parentElement.classList.remove("open")}),e.parentElement.classList.toggle("open")),t.stopImmediatePropagation();else if(a){const e=a.closest(".js-unitTimeSelect");var o,r=a.getAttribute("data-value");e&&((o=e.querySelector(".wps-unit-time-chart__selected-item"))&&(o.textContent=a.textContent.trim()),e.querySelectorAll(".wps-unit-time-chart__option").forEach(t=>t.classList.remove("selected")),a.classList.add("selected"),e.classList.remove("open"),o=e.closest(".o-wrap").querySelector(".wps-postbox-chart--container").querySelector("canvas").getAttribute("id"),chartInstances[o])&&chartInstances[o].updateChart(r),t.stopImmediatePropagation()}else document.querySelectorAll(".js-unitTimeSelect.open").forEach(t=>{t.classList.remove("open")})});
...
wps_js.render_wp_statistics_post_summary_widget=function(o,s){if(o&&o.response){if(wps_js.metaBoxInner(s).html(o.response.output),o.response?.data){s=o.response.data;{var[o,s=[]]=["postSummaryChart",s];let e=s.postChartData;let a="Visitors",i="#A5AAEA",t;void 0!==s.postChartSettings&&null!==s.postChartSettings&&((s=s.postChartSettings).color&&(i=s.color),s.label)&&(a=s.label);var s={animation:!1,responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{enabled:!1,displayColors:!1,position:"nearest",intersect:!1,external:e=>{var{chart:e,tooltip:i}=e;let o=e.canvas.parentNode.querySelector("div");if(o||((o=document.createElement("div")).classList.add("c-wps-mini-chart-post-summary-tooltip"),e.canvas.parentNode.appendChild(o)),0===i.opacity)o.style.opacity=0;else if(i.body){var s=i.title||[],r=i.body.map(t=>t.lines);let a="<div>";s.forEach(t=>{a+=`<div class="chart-title">${t}</div>`}),r.forEach((t,e)=>{t=t.join(": ");a+=`<div>${t}</div>`}),o.innerHTML=a;var{offsetLeft:s,offsetTop:e,offsetWidth:n,offsetHeight:l}=e.canvas,r=(o.style.opacity=0===r[0].length?0:1,o.offsetWidth);let t=s+i.caretX-r/2;i=e+l;(t=t<s?s:t)+r>s+n&&(t=s+n-r),o.style.left=t+"px",o.style.top=i+"px"}},callbacks:{title:t=>e[t[0].label].fullDate,label:t=>{t=t.formattedValue;return`<div class="content-itemss"> <div class="content-item"><span>${a}</span> <span>${t}</span></div>`}}}},scales:{x:{offset:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:3,fontColor:"#898A8E",fontSize:10,padding:5}},y:{position:"right",beginAtZero:!0,grid:{display:!1},border:{color:"transparent",width:0},ticks:{align:"inner",maxTicksLimit:5,fontColor:"#898A8E",fontSize:10,padding:8,stepSize:1}}},layout:{padding:{left:0,right:0,top:0,bottom:0}}},o=jQuery("#"+o)[0].getContext("2d"),r=Object.entries(e).map(([,t])=>t.hits),n=r.length<=30?"bar":"line";"line"==n&&((t=o.createLinearGradient(0,0,0,o.canvas.height-10)).addColorStop(0,wps_js.hex_to_rgba(i,1)),t.addColorStop(.5,wps_js.hex_to_rgba(i,.25)),t.addColorStop(.75,wps_js.hex_to_rgba(i,0)),t.addColorStop(1,wps_js.hex_to_rgba(i,0)));new Chart(o,{type:n,data:{labels:Object.entries(e).map(([t])=>t),datasets:[{data:r,backgroundColor:"line"==n?t:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":wps_js.hex_to_rgba(i,.5)}),hoverBackgroundColor:"line"==n?t:Object.entries(e).map(([,t])=>{return 0===t.hits?"#000000b3":i}),pointBackgroundColor:i,fill:"line"==n,barPercentage:.9,categoryPercentage:1,tension:.5,minBarLength:1,borderWidth:"line"==n?1:0,pointRadius:"line"==n?0:void 0,pointHoverRadius:"line"==n?5:void 0,borderColor:i}]},options:s})}}wps_js.initDatePickerHandlers()}};
...
wps_js.render_wp_statistics_hourly_usage_widget=function(a,t){if(a&&a.response&&wps_js.metaBoxInner(t).html(a.response.output),a.response?.data){t=a.response.data;const v={data:t.data,previousData:t.previousData};a=document.getElementById("hourly-usage-chart").getContext("2d");let i={Views:"#7362BF",Visitors:"#3288D7"};const g=[];Object.keys(v.data.datasets).forEach((a,t)=>{var e=i[v.data.datasets[a].label];g.push({type:"bar",label:v.data.datasets[a].label,data:v.data.datasets[a].data,backgroundColor:wps_js.hex_to_rgba(e,.5),fill:!1,yAxisID:"y",hitRadius:10})}),v?.previousData&&Object.keys(v.previousData.datasets).forEach((a,t)=>{var e,s=v.previousData.datasets[a].label;g.push({type:"bar",label:v.previousData.datasets[a].label+" (Previous)",data:v.previousData.datasets[a].data,backgroundColor:(a=wps_js.hex_to_rgba(i[s],.5),s=document.createElement("canvas"),e=s.getContext("2d"),s.width=5,s.height=5,e.fillStyle=a,e.fillRect(0,0,s.width,s.height),e.strokeStyle="white",e.lineWidth=2,e.beginPath(),e.moveTo(s.width,0),e.lineTo(0,s.height),e.stroke(),e.createPattern(s,"repeat")),fill:!1,yAxisID:"y",pointRadius:0,hitRadius:10})});var t={maintainAspectRatio:!1,resizeDelay:200,animation:{duration:0},responsive:!0,interaction:{intersect:!1,mode:"index"},plugins:{legend:!1,tooltip:{enabled:!1,external:a=>{{g;var t=i,e=v;const{chart:c,tooltip:p}=a;if(a=getOrCreateTooltip(c),0===p.opacity)a.style.opacity=0;else if(p.body){const u=p.dataPoints[0].dataIndex,h=c.data.datasets;let i="<div>";var s=h.filter(a=>!a.label.includes("(Previous)")),o=h.filter(a=>a.label.includes("(Previous)")),r=(new Date).getHours(),l=e.data.labels[u].hour,n=parseInt(l.match(/\d+/)[0]),l=l.includes("PM"),l=12===n?l?12:0:l?n+12:n,n=s.some(a=>0<a.data[u]),d=o.some(a=>0<a.data[u]),l=l<=r,r=l&&(n||!n&&!d)?e.data.labels[u].formatted_date+" ("+e.data.labels[u].hour+")":e.previousData.labels[u].formatted_date+" ("+e.data.labels[u].hour+")";if(i+=`<div class="chart-title">${r}</div>`,l&&(n||!n&&!d)&&s.forEach(a=>{var t;c.getDatasetMeta(h.indexOf(a)).hidden||(t=a.data[u],i+=`
                        <div class="current-data">
                            <div>
                        ...
                        </div>`)}),!l||d){const b=Object.values(t);o.forEach((a,t)=>{var e=c.getDatasetMeta(h.indexOf(a)),s=a.label.replace(" (Previous)","");e.hidden||(e=a.data[u],i+=`
                        <div class="previous-data">
                            <div>
                                 <span class="previous-data__colors">
                                    <span class="previous-data__color" style="background-color:${wps_js.hex_to_rgba(b[t],.5)};"></span>
                                    <span class="previous-data__color" style="background-color: ${wps_js.hex_to_rgba(b[t],.5)}"></span>
                                 </span>
                                 ${s} 
                            </div>
                            <span class="current-data__value">${e.toLocaleString()}</span>
                        </div>`)})}i+="</div>",a.innerHTML=i,wps_js.setTooltipPosition(a,c,p)}}},callbacks:{title:a=>a[0].label,label:a=>a.formattedValue}}},scales:{x:{offset:!0,grid:{display:!1,drawBorder:!1,tickLength:0,drawTicks:!1},border:{color:"transparent",width:0},ticks:{align:"inner",autoSkip:!1,maxRotation:90,minRotation:90,callback:function(a,t){return" "+this.getLabelForValue(a)},font:{color:"#898A8E",style:"italic",size:window.innerWidth<768?8:13},padding:window.innerWidth<768?3:8}},y:{min:0,ticks:{maxTicksLimit:7,font:{color:"#898A8E",style:"italic",size:window.innerWidth<768?8:13},padding:window.innerWidth<768?2:8,lineHeight:window.innerWidth<768?10:15,stepSize:1},border:{color:"transparent",width:0},type:"linear",position:"right",grid:{display:!0,tickMarkLength:0,drawBorder:!1,tickColor:"#EEEFF1",color:"#EEEFF1"},gridLines:{drawTicks:!1},title:{display:!1}}}},e=v.data.labels.map(a=>a.hour);const o=new Chart(a,{type:"bar",data:{labels:e,datasets:g},options:t});{const r=document.getElementById("hourly-usage-chart").parentElement.parentElement.querySelector(".wps-postbox-chart--items");if(r){r.innerHTML="",g.sort((a,t)=>"Total"===a.label?-1:"Total"===t.label?1:"Total (Previous)"===a.label?-1:"Total (Previous)"===t.label?1:0);a=document.querySelectorAll(".wps-postbox-chart--previousPeriod");if(0<a.length){let t=!1;g.forEach(a=>{a.label.includes("(Previous)")&&(t=!0)}),t&&a.forEach(a=>{a.style.display="flex"})}g.forEach((a,t)=>{if(!a.label.includes("(Previous)")){a.data.reduce((a,t)=>Number(a)+Number(t),0);var e=document.createElement("div");e.className="wps-postbox-chart--item",e.innerHTML=`
                            <span class="current-data">
                                 <span class="wps-postbox-chart--item--color" style="border-color: ${a.backgroundColor}"></span> ${a.label}
                            </span>
                           `;const s=e.querySelector(".current-data");s.addEventListener("click",function(){var a=o.getDatasetMeta(t);a.hidden=!a.hidden,s.classList.toggle("wps-line-through"),o.update()}),r.appendChild(e)}})}}}wps_js.initDatePickerHandlers()};
wps_js.render_wp_statistics_hitsmap_widget=function(s,a){if(s?.response){a=a.replace(/_/g,"-");const{output:t,data:e}=s.response;let i=Array(),o={};if(wps_js.metaBoxInner(a).html(t),0<e?.codes?.length){const l={},d=(e.codes.forEach((s,a)=>{var t=Number(e.raw_data[a])||0,r=e.data[a];l[s.toLowerCase()]={label:e.labels[a],flag:e.flags[a],visitors_raw:t,visitors:r}}),Math.max(1,...Object.values(l).map(s=>s.visitors_raw)));Object.keys(l).forEach(s=>{var a=l[s],t=a.visitors_raw/d,r=Math.round(235-185*t),e=Math.round(245-109*t),t=Math.round(255-40*t);o[s]=`rgb(${r}, ${e}, ${t})`,i[s]=`<div class='map-html-marker'>
                ...
                </div>`})}jQuery("#wp-statistics-visitors-map").vectorMap({map:"world_en",backgroundColor:"#fff",borderColor:"#fff",borderOpacity:.6,color:"#e6e6e6",selectedColor:"#596773",hoverColor:"#596773",colors:o,onLabelShow:function(s,a,t){t=t.toLowerCase();if(i[t])a.html(i[t]);else{const r=wps_js.global.assets_url+`/images/flags/${t}.svg`,e=a.text();fetch(r).then(s=>{s=s.ok?`<img src='${r}' alt="${e}" title="${e}" class='log-tools wps-flag'/>`:"";a.html(`
            ...
            `)}).catch(s=>{console.error("Error fetching the image:",s),a.html(`
                <div class='map-html-marker'>
                    <div class="map-country-header">
                        <span>${e}</span>
                    </div>
            ...
            <div class="wps-audit-card__header">
                <div class="wps-audit-card__top">
                    <div class="wps-audit-card__details">
                        ...
                        <div>
                            <h3 class="wps-audit-card__title">${s.title}</h3>
                            <p class="wps-audit-card__summary">${s.summary}</p>
                        </div>
                    </div>
                    <div class="wps-audit-card__status">
                        <span class="wps-audit-card__status-indicator"></span>`;return"warning"===s.status&&(t+=`<span class="wps-audit-card__status-text">${wps_js._("action_required")}</span>`),t+=`
                        <button class="wps-audit-card__toggle" aria-expanded="false"></button>
                    </div>
                </div>
            </div>
...
if(wps_js.isset(wps_js.global,"request_params","page")&&"referrals"===wps_js.global.request_params.page){function renderChart(e,t){var r,s;document.getElementById(e)&&(r=jQuery("#"+e).parent(),s=wps_js.rectangle_placeholder(),r.append(s),t?.data?.datasets&&0!==t.data.datasets.length?(jQuery(".wps-ph-item").remove(),jQuery(".wps-postbox-chart--data").removeClass("c-chart__wps-skeleton--legend"),r.removeClass("c-chart__wps-skeleton"),wps_js.new_line_chart(t,e,null)):(r.html(wps_js.no_results()),jQuery(".wps-ph-item").remove()))}if("undefined"!=typeof Wp_Statistics_Referrals_Object){const f=Wp_Statistics_Referrals_Object.source_category_chart_data,g=(renderChart("sourceCategoriesChart",f),Wp_Statistics_Referrals_Object.social_media_chart_data),h=(renderChart("socialMediaChart",g),Wp_Statistics_Referrals_Object.search_engine_chart_data);renderChart("incomeVisitorChart",h)}jQuery(document).on("click","div#referral-filter",function(e){e.preventDefault(),tb_show(wps_js._("filters"),"#TB_inline?&width=430&height=205&inlineId=referral-filter-popup"),setTimeout(function(){var e="#wps-referral-filter-div";wps_js.exist_tag(e+" button[type=submit]")||(jQuery(e).html('<div style="height: 50px;"></div>'+wps_js.line_placeholder(1)),wps_show_referrals_filter(e))},500)});var FORM_ID="#wps-referrals-filter-form";function wps_show_referrals_filter(e){var t=null===wps_js.getLinkParams("referrer")?"disabled":"";let r='<table class="o-table wps-referrals-filter">';r=(r=r+`<tr><td colspan="2" class="wps-referrals-filter-title">${wps_js._("referrer")}</td></tr>`+'<tr><td colspan="2" class="wps-referrals-filter-content"><select name="referrer" class="wps-select2   wps-width-100">')+`<option value=''>${wps_js._("all")}</option>`+"<option value='test'>test</option>";var s=wps_js.getLinkParams("referrer");null!=s&&(r+=`<option value='${s}'  selected>${s}</option>`),r=(r+="</select></td></tr>")+`<tr class="wps-tb-window-footer"><td><button class="js-reset-filter wps-reset-filter" type="button" ${t}>${wps_js._("reset")}</button></td><td><button type="submit" class="button-primary">${wps_js._("apply")}</button></td></tr>`+"</table>",jQuery(e).html(r),jQuery(".wps-select2").select2({ajax:{delay:500,url:wps_js.global.ajax_url,dataType:"json",data:function(e){var t,e={wps_nonce:wps_js.global.rest_api_nonce,search:e.term,action:"wp_statistics_search_referrers",paged:e.page||1};return wps_js.isset(wps_js.global,"request_params")&&(t=wps_js.global.request_params).page&&(e.page=t.page),e},error:function(e,t,r){console.error("AJAX request error:",t,r)}}})}jQuery(document).on("submit",FORM_ID,function(){let e={select:["referrer"]};Object.keys(e).forEach(function(t){e[t].forEach(e=>{e=jQuery(FORM_ID+" "+t+"[name="+e+"]");e.val().length<1&&e.prop("disabled",!0)})}),jQuery(".wps-tb-window-footer .button-primary").html(wps_js._("loading")).addClass("loading")}),jQuery(document).on("click",".js-reset-filter",function(){var e=new URL(window.location.href);e.searchParams.delete("referrer"),window.location.href=e.toString()})}
...
document.addEventListener("click",function(a){if(wps_js.isset(wps_js.global,"request_params","page")&&("privacy-audit"===wps_js.global.request_params.page||"tracker-debugger"===wps_js.global.request_params.page)&&!a.target.closest(".js-openModal-wps-modal-privacy-audit-confirmation")&&!a.target.closest("a[data-action]")){var e=a.target.closest(".wps-audit-card__header");if(e){a.preventDefault();const s=e.closest(".wps-audit-card");s&&(a=document.querySelectorAll(".wps-audit-card"),e=s.classList.contains("wps-audit-card--expanded"),a.forEach(a=>{a!==s&&(a.classList.remove("wps-audit-card--expanded"),a.classList.add("wps-audit-card--collapsed"),a=a.querySelector(".wps-audit-card__toggle"))&&a.setAttribute("aria-expanded","false")}),e?(s.classList.remove("wps-audit-card--expanded"),s.classList.add("wps-audit-card--collapsed"),(a=s.querySelector(".wps-audit-card__toggle"))&&a.setAttribute("aria-expanded","false")):(s.classList.remove("wps-audit-card--collapsed"),s.classList.add("wps-audit-card--expanded"),(e=s.querySelector(".wps-audit-card__toggle"))&&e.setAttribute("aria-expanded","true")))}}});
if(wps_js.isset(wps_js.global,"request_params","page")&&"visitors"===wps_js.global.request_params.page){jQuery(document).on("click","div#visitors-filter",function(t){t.preventDefault(),tb_show(wps_js._("filters"),"#TB_inline?&width=430&height=510&inlineId=visitors-filter-popup"),setTimeout(function(){var t,s,e="#wps-visitors-filter-form";wps_js.exist_tag(e+" button[type=submit]")||(jQuery(e).html('<div style="height: 50px;"></div>'+wps_js.line_placeholder(5)),t=localStorage.getItem("wp-statistics-visitors-filter")?JSON.parse(localStorage.getItem("wp-statistics-visitors-filter")):{},!wps_js.isset(t,"timestamp")||!wps_js.isset(t,"value")||wps_js.isset(t,"timestamp")&&wps_js.isset(t,"value")?(s={wps_nonce:wps_js.global.rest_api_nonce,action:"wp_statistics_visitors_page_filters"},s=Object.assign(s,wps_js.global.request_params),jQuery.ajax({url:wps_js.global.admin_url+"admin-ajax.php",type:"GET",dataType:"json",data:s,timeout:3e4,success:function(t){wp_statistics_show_visitors_filter(e,t)},error:function(t,s,e){jQuery("span.tb-close-icon").click()}})):wp_statistics_show_visitors_filter(e,t.value))},500)});var FORM_ID="#wp_statistics_visitors_filter_form";function wp_statistics_show_visitors_filter(t,i){let r='<table class="o-table">',a={browsers:["agent","browsers"],country:["location","location"],platform:["platform","platform"],referrer:["referrer","referrer"],user:["user_id","users"]};Object.keys(a).forEach(s=>{r=(r=(r+=`<tr><td>${wps_js._(s)}</td></tr>`)+`<tr><td><select name="${a[s][0]}" class="select2 wps-width-100" data-type-show="select2">`)+`<option value=''>${wps_js._("all")}</option>`;let e=wps_js.getLinkParams(a[s][0]);Object.keys(i[a[s][1]]).forEach(function(t){r+=`<option value='${t}' ${null!=e&&e.replace(/\+/g," ")==t?"selected":""}>${i[a[s][1]][t]}</option>`}),r+="</select></td></tr>"}),r=(r=(r+=`<tr><td>${wps_js._("ip_hash")}</td></tr>`)+`<tr><td><input placeholder="${wps_js._("ip_hash_placeholder")}" name="ip" value="${null!=wps_js.getLinkParams("ip")?decodeURIComponent(wps_js.getLinkParams("ip")):""}" class="wps-width-100" placeholder='' autocomplete="off"></td></tr>`+"<tr><td></td></tr>")+`<tr class="wps-tb-window-footer"><td></td><td><button type="submit" class="button-primary">${wps_js._("filter")}</button></td></tr>`+"</table>",jQuery(t).html(r),wps_js.select2()}if(jQuery(document).on("submit",FORM_ID,function(){let t={input:["ip"],select:["agent","platform","location","referrer","user_id"]};Object.keys(t).forEach(function(s){t[s].forEach(t=>{t=jQuery(FORM_ID+" "+s+"[name="+t+"]");t.val().length<1&&t.prop("disabled",!0)})});var s=wps_js.getLinkParams("order");return null!=s&&jQuery(this).append('<input type="hidden" name="order" value="'+s+'" /> '),jQuery(".wps-tb-window-footer .button-primary").html(wps_js._("loading")).addClass("loading"),!0}),document.getElementById("trafficTrendsChart")){const u=Wp_Statistics_Visitors_Object.traffic_chart_data;wps_js.new_line_chart(u,"trafficTrendsChart",null)}if(document.getElementById("LoggedInUsersChart")){const v=Wp_Statistics_Visitors_Object.logged_in_chart_data;wps_js.new_line_chart(v,"LoggedInUsersChart",null)}}
