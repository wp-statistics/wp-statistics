    ...
    return (
        <div>
            <p>
                ...
                In total, it has been viewed {data.totalViews} times by {data.totalVisitors} visitors, with '{data.topReferrer}' leading with {data.topReferrerCount} referrals. For more detailed insights, visit the <a href={data.contentAnalyticsUrl} target="_blank">analytics section</a>.
            </p>
        </div>
    );
};
