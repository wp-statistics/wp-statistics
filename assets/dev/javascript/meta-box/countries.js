wps_js.countries_meta_box = {
    ...
    view: function (args = []) {
        let t = '';
        t += `<table width="100%" class="o-table o-table--link table-stats wps-report-table"><tbody>
        <tr>
            <td width="10%"></td>
        ...
        args.countries.forEach(function (value) {
			...
			<td><a href="${value['link']}" title="${value['name']}" target="_blank">${wps_js.number_format(value['number'])} <svg width="10" height="10" fill="none" xmlns="http://www.w3.org/2000/svg">
