wps_js.countries_meta_box = {
    ...
    view: function (args = []) {
        ...
        args.countries.forEach(function (value) {
			...
			<td style="text-align: right !important;"><a href="${value['link']}" title="${value['name']}" target="_blank">${wps_js.number_format(value['number'])} <svg width="10" height="10" fill="none" xmlns="http://www.w3.org/2000/svg">
