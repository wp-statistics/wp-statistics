wps_js.words_meta_box = {
    ...
    view: function (args = []) {
        ...
        args.forEach(function (value) {
            ...
            <td style="text-align: right !important;"><a href="${value['browser']['link']}" title="${value['browser']['name']}"><img src="${value['browser']['logo']}" alt="${value['browser']['name']}" title='${value['browser']['name']}' class="wps-flag log-tools"/> ${value['browser']['name']}</a></td>
