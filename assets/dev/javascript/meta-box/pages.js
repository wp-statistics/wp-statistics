wps_js.pages_meta_box = {
    ...
    view: function (args = []) {
        ...
        args.pages.forEach(function (value) {
			...
			<td><a href="${siteUrl}${value['str_url']}" title="${value['title']}" class='wps-text-wrap' target="_blank">${value['title']} <span class="dashicons dashicons-external" style="font-size: 15px; vertical-align: middle"></span></a></td>
