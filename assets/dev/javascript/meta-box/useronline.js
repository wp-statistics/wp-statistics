wps_js.useronline_meta_box = {
    ...
    view: function (args = []) {
        ...
        t += `<table class="o-table table-stats wps-report-table wps-table-fixed">
        <tr>
        ...
        args.forEach(function (value) {
            ...
            <td style='text-align: left !important'><a href='` + (value['hash_ip'] ? '#' : value['ip']['link']) + `'>` + (value['hash_ip'] ? value['hash_ip'] : value['ip']['value']) + `</a></td>
			</tr>`;
        });
