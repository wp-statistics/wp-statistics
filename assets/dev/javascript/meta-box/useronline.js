wps_js.useronline_meta_box = {
    ...
    view: function (args = []) {
        ...
        args.forEach(function (value) {
            ...
            <td><a href='${value['single_url']}'>` + (value['hash_ip'] ? value['hash_ip'] : value['ip']['value']) + `</a></td>`
                + (typeof value['user'] != 'undefined' ? `<td><a href='` + wps_js.global.admin_url + `user-edit.php?user_id=` + value['user']['ID'] + `'>` + value['user']['name'] + ` (ID: #` + value['user']['ID'] + `)</a></td>` : `<td>-</td>`) +
                `</tr>`;
        });
