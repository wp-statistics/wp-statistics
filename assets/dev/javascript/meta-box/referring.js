wps_js.referring_meta_box = {
    ...
    view: function (args = []) {
        ...
        <tr>
            <th style="text-align: left !important;">${wps_js._('address')}</th>
            <th style="text-align: right !important;">${wps_js.meta_box_lang('referring', 'references')}</th>
        </tr></thead><tbody>`;

        args.referring.forEach(function (value) {
            t += `<tr>
			<td style="text-align: left !important;">` + wps_js.site_icon(value['domain']) + ` <a href='//${value['domain']}' title='${value['title']}' target="_blank">${value['domain']} <span class="dashicons dashicons-external" style="font-size: 15px; vertical-align: middle"></span></a></td>
			<td style="text-align: right !important;" class="wps-middle-vertical"><a style="justify-content: flex-end;" href="${value['page_link']}">${value['number']} 
