if (wps_js.isset(wps_js.global, 'request_params', 'page') && wps_js.global.request_params.page === "overview-new") {
    ...
    function initDatePickerHandlers() {
        ...
        const datePickerInput = jQuery('.js-datepicker-input');
        if (datePickerInput.length) {
            ...
            jQuery(document).off('click', '.js-custom-datepicker').on('click', '.js-custom-datepicker', function(e) {
                e.preventDefault();
                const input = jQuery(this).siblings('.js-datepicker-input');
                if (input.length) {
                    input.trigger('click');
                }
            });
            ...
            datePickerInput.on('apply.daterangepicker', function(ev, picker) {
                ...
                jQuery('.hs-filter-range').text(picker.startDate.format('MMM D, YYYY') + ' - ' + picker.endDate.format('MMM D, YYYY'));
        ...
        // Handle filter button clicks (excluding more/close buttons)
        jQuery(document).off('click', '.c-footer__filters__list-item:not(.js-show-more-filters):not(.js-close-more-filters):not(.js-custom-datepicker)').on('click', '.c-footer__filters__list-item:not(.js-show-more-filters):not(.js-close-more-filters):not(.js-custom-datepicker)', function() {
