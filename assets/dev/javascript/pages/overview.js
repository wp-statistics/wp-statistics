        ...
        let PostBox = `
            ...
            <div class="inside">
                ...
                <span class="dashicons dashicons-dismiss"></span>
                    ...
                    <a href="${wps_js.global.overview.ads['link']}?url=${window.location.href}" title="${wps_js.global.overview.ads['title']}" ${(wps_js.global.overview.ads['_target'] == "yes" ? ' target="_blank"' : '')}>
