...
function wp_statistics_enableTab(tab_id) {
    jQuery('.wp-statistics-settings .wps-settingsMenu .wps-settingsMenuItem').removeClass('current');
...
if (jQuery('.wp-statistics-settings').length) {
    ...
    jQuery('.wps-adminHeader__burgerIcon').click(function () {
        jQuery('.wps-settingsMenu').slideToggle();
    });
    ...
    jQuery('.wp-statistics-settings .wps-settingsMenu .wps-settingsMenuItem').click(function () {
