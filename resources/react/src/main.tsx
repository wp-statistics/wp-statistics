...
const syncAdminMenu = () => {
  ...
  const isLicenseRoute = hash.startsWith('#/license')
  ...
  submenuItems.forEach((item) => {
    ...
    const isLicenseLink = href.includes('#/license')
