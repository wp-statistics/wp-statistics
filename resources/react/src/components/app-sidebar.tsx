...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar variant="sidebar" collapsible="icon" {...props}>
      ...
      <SidebarFooter className="fixed bottom-0 left-(--wp-admin-sidebar-width) z-20 w-(--sidebar-width) shrink-0 border-t border-border bg-sidebar transition-[width] duration-200 ease-linear group-data-[collapsible=icon]:w-(--sidebar-width-icon)">
