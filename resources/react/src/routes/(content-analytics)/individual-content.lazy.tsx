  ...
  const contentMetrics = useMemo(() => {
    ...
    const metrics: MetricItem[] = [
      ...
      },
      {
        ...
        ...(isCompareEnabled ? calcPercentage(entryPage, prevEntryPage) : {}),
      ...
      },
      {
        ...
        ...(isCompareEnabled ? calcPercentage(exitPage, prevExitPage) : {}),
      ...
      },
      {
        ...
        ...(isCompareEnabled ? calcPercentage(exitRate, prevExitRate) : {}),
