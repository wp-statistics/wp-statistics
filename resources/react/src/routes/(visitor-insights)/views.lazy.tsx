...
function RouteComponent() {
  ...
  const {
    ...
    ...getViewsQueryOptions({
      ...
      columns: VIEWS_DEFAULT_API_COLUMNS,
    }),
  ...
  const {
    ...
    defaultApiColumns: VIEWS_DEFAULT_API_COLUMNS,
    columnConfig: VIEWS_COLUMN_CONFIG,
    sorting,
  ...
  return (
    <div className="min-w-0">
      <div className="flex items-center justify-between px-4 py-3 ">
        <h1 className="text-2xl font-semibold text-neutral-800">{__('Views', 'wp-statistics')}</h1>
