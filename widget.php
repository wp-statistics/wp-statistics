...
class WPStatistics_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $widget_options['wvisit_widget'] ) {
			echo '<li>';
			echo '<label>' . __( 'Last 7 Days Visits', 'wp_statistics' ) . ': </label>';
		...
		if ( $widget_options['mvisit_widget'] ) {
			echo '<li>';
			echo '<label>' . __( 'Last 30 Days Visits', 'wp_statistics' ) . ': </label>';
		...
		if ( $widget_options['ysvisit_widget'] ) {
			echo '<li>';
			echo '<label>' . __( 'Last 365 Days Visits', 'wp_statistics' ) . ': </label>';
		...
		if ( $widget_options['ttvisit_widget'] ) {
			echo '<li>';
			echo '<label>' . __( 'Total Visits', 'wp_statistics' ) . ': </label>';
		...
		if ( $widget_options['ttvisitor_widget'] ) {
			echo '<li>';
			echo '<label>' . __( 'Total Visitors', 'wp_statistics' ) . ': </label>';
	...
	public function form( $instance ) {
        ...
        <ul>
            ...
            <li>
                ...
                <label for="ser_widget"><?php _e( 'Search Engine Referrals', 'wp_statistics' ); ?></label></li>
