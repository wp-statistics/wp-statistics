...
class RecordUserPageVisits extends ResolvableAudit
{
    ...
    public static function getUnpassedStateInfo()
    {
        return [
            ...
            'notes' => __('<p>This status means that individual user page visits and WordPress user IDs are being actively tracked. While this functionality provides valuable insights into user behavior, it’s important to handle the collected data responsibly.</p><p><b>Why is this important?</b></p>
