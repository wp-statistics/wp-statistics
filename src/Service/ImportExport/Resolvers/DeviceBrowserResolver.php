...
/**
 * Resolver for device_browsers lookup table.
 *
 * Resolves browser name (e.g., 'Chrome', 'Firefox') to device_browser_id.
 *
 * @since 15.0.0
 */
class DeviceBrowserResolver extends AbstractResolver
{
    /**
     * Table name.
     *
    ...
    {
        return new DeviceBrowserRecord();
    }
}
