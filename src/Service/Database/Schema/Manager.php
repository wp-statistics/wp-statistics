    ...
    private static $tablesSchema = [
        ...
        'device_browser_versions' => [
            ...
            'constraints' => [
                ...
                'KEY version (version)',
                'UNIQUE KEY uk_device_browser_versions (browser_id, version)',
            ],
        ],
        'device_browsers'         => [
            'columns'     => [
        ...
        'sessions'                => [
            ...
            'constraints' => [
                ...
                'KEY idx_sessions_started_at_id (started_at, ID)',
        ...
        'summary'                 => [
            ...
            'constraints' => [
                'PRIMARY KEY (ID)',
                'UNIQUE KEY uk_summary_date_resource (date, resource_uri_id)',
                'KEY resource_uri_id (resource_uri_id)',
            ],
        ],
        'summary_totals'          => [
        ...
        'events'                  => [
            ...
            'constraints' => [
                'PRIMARY KEY (ID)',
                'KEY session_id (session_id)',
                'KEY session_id_event_name (session_id, event_name)',
                'KEY resource_uri_id (resource_uri_id)',
