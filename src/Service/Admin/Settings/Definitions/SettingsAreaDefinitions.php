                    ...
                    'tracker-config' => [
                        ...
                        'fields'      => [
                            ...
                            'tracker_rate_limit' => [
                                ...
                                'label'       => __('Rate Limiting', 'wp-statistics'),
                                'description' => __('Limit the number of tracking requests per IP address per minute. Protects against bot floods and endpoint abuse.', 'wp-statistics'),
                                'default'     => false,
                                'order'       => 30,
                            ],
                            'tracker_rate_limit_threshold' => [
                                ...
                                'label'        => __('Requests Per Minute', 'wp-statistics'),
