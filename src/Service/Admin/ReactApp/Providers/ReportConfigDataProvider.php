    ...
    private function getSingleContentConfig()
    {
        return [
            ...
            'queries'          => [
                [
                    'id'          => 'content_metrics',
                    'sources'     => ['visitors', 'views', 'bounce_rate', 'avg_time_on_page', 'entry_page', 'exit_page', 'exit_rate', 'comments'],
                    'group_by'    => [],
                    'format'      => 'flat',
                    'show_totals' => true,
                    'compare'     => true,
    ...
    private function getSingleUrlConfig()
    {
        return [
            ...
            'queries'          => [
                [
                    'id'          => 'url_metrics',
                    'sources'     => ['visitors', 'views', 'bounce_rate', 'avg_time_on_page', 'entry_page', 'exit_page', 'exit_rate'],
                    'group_by'    => [],
                    'format'      => 'flat',
                    'show_totals' => true,
                    'compare'     => true,
    ...
    private function getOverviewConfig()
    {
        return [
            ...
            'metrics'          => [
                ...
                [
                    'id'         => 'session-duration',
                    'label'      => esc_html__('Session Duration', 'wp-statistics'),
                    'queryId'    => 'metrics',
                ...
                [
                    ...
                    'label'      => esc_html__('Views/Session', 'wp-statistics'),
                    'queryId'    => 'metrics',
                ...
                [
                    'id'         => 'searches',
                    'label'      => esc_html__('Searches', 'wp-statistics'),
                    'queryId'    => 'metrics',
                    'valueField' => 'searches',
                    'source'     => 'totals',
                    'format'     => 'compact_number',
            ...
            'widgets'          => [
                [
                    'id'             => 'metrics-overview',
                    'label'          => esc_html__('Metrics Overview', 'wp-statistics'),
                    'type'           => 'metrics',
                    'defaultSize'    => 12,
                ...
                [
                    'id'             => 'traffic-trends',
                    'label'          => esc_html__('Traffic Trends', 'wp-statistics'),
                    'type'           => 'chart',
                    'defaultSize'    => 12,
                    'allowedSizes'   => [6, 8, 12],
                    'queryId'        => 'traffic_trends',
                    'chartConfig'    => [
                        'metrics'          => [
                            ['key' => 'visitors', 'label' => esc_html__('Visitors', 'wp-statistics'), 'color' => 'var(--chart-1)'],
                            ['key' => 'views', 'label' => esc_html__('Views', 'wp-statistics'), 'color' => 'var(--chart-2)'],
                        ],
                        'timeframeSupport' => true,
                    ],
                ],
                [
                    ...
                    'linkType'            => 'analytics-route',
                    'columnHeaders'       => [
                        'left'  => esc_html__('Page', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'                => ['to' => '/top-pages'],
                ],
                [
                    'id'                  => 'top-referrers',
                    'label'               => esc_html__('Top Referrers', 'wp-statistics'),
                    'type'                => 'bar-list',
                    'defaultSize'         => 6,
                    'allowedSizes'        => [4, 6, 8, 12],
                    'queryId'             => 'top_referrers',
                    ...
                    'valueField'          => 'visitors',
                    'columnHeaders'       => [
                        'left'  => esc_html__('Referrer', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'                => ['to' => '/referrers'],
                ],
                [
                    ...
                    'linkParamField' => 'country_code',
                    'columnHeaders'  => [
                        'left'  => esc_html__('Country', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'           => ['to' => '/countries'],
                ],
                [
                    'id'                  => 'top-search-engines',
                    'label'               => esc_html__('Top Search Engines', 'wp-statistics'),
                    'type'                => 'bar-list',
                    'defaultSize'         => 6,
                    'allowedSizes'        => [4, 6, 8, 12],
                    'queryId'             => 'top_search_engines',
                    ...
                    'valueField'          => 'visitors',
                    'columnHeaders'       => [
                        'left'  => esc_html__('Search Engine', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                ...
                [
                    ...
                    'iconSlugField'   => 'browser_name',
                    'columnHeaders'   => [
                        'left'  => esc_html__('Browser', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'            => ['to' => '/browsers'],
                ],
                [
                    ...
                    'iconSlugField'       => 'country_code',
                    'columnHeaders'       => [
                        'left'  => esc_html__('Visitor', 'wp-statistics'),
                        'right' => esc_html__('Views', 'wp-statistics'),
                    ],
                ...
                [
                    ...
                    'valueField'          => 'visitors',
                    'columnHeaders'       => [
                        'left'  => esc_html__('Social Media', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                ...
                [
                    'id'             => 'top-cities',
                    'label'          => esc_html__('Top Cities', 'wp-statistics'),
                    'type'           => 'bar-list',
                    'defaultSize'    => 6,
                    'defaultVisible' => false,
                    'allowedSizes'   => [4, 6, 8, 12],
                    ...
                    'iconSlugField'  => 'country_code',
                    'columnHeaders'  => [
                        'left'  => esc_html__('City', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'           => ['to' => '/cities'],
                ],
                [
                    'id'             => 'top-os',
                    'label'          => esc_html__('Top Operating Systems', 'wp-statistics'),
                    'type'           => 'bar-list',
                    'defaultSize'    => 6,
                    'defaultVisible' => false,
                    'allowedSizes'   => [4, 6, 8, 12],
                    ...
                    'iconSlugField'  => 'os_name',
                    'columnHeaders'  => [
                        'left'  => esc_html__('Operating System', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'           => ['to' => '/operating-systems'],
                ],
                [
                    'id'             => 'top-device-categories',
                    'label'          => esc_html__('Top Device Categories', 'wp-statistics'),
                    'type'           => 'bar-list',
                    'defaultSize'    => 6,
                    'defaultVisible' => false,
                    'allowedSizes'   => [4, 6, 8, 12],
                    ...
                    'iconSlugField'  => 'device_type_name',
                    'columnHeaders'  => [
                        'left'  => esc_html__('Device', 'wp-statistics'),
                        'right' => esc_html__('Visitors', 'wp-statistics'),
                    ],
                    'link'           => ['to' => '/device-categories'],
                ],
            ...
            'widgetCategories' => [
                ...
                [
                    'label'   => esc_html__('Geographic', 'wp-statistics'),
