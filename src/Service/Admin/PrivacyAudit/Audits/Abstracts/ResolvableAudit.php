...
abstract class ResolvableAudit extends BaseAudit
{
    ...
    public static function getStatus()
    {
        ...
        $status = Option::getOptionGroup(PrivacyStatusOption::KEY, static::$optionKey, 'action_required');
    ...
    {
        Option::saveOptionGroup(static::$optionKey, 'resolved', PrivacyStatusOption::KEY);
    }
    ...
    {
        Option::saveOptionGroup(static::$optionKey, 'action_required', PrivacyStatusOption::KEY);
    }
