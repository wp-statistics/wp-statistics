...
class ReferralsSearchEngines extends BaseMetabox
{
    protected $key = 'referrals_search_engines';
    ...
    public function getData()
    {
        ...
        $output = View::load('metabox/referrals_search_engines', ['data' => $data], true);
