...
class SearchEngineChartDataProvider extends AbstractChartDataProvider
{
    ...
    public function getData()
    {
        ...
        $data       = $this->visitorsModel->getReferrers(array_merge($this->args, ['source_channel' => ['search', 'paid_search'], 'per_page' => '']));
        $prevData   = $this->visitorsModel->getReferrers(array_merge($this->args, ['date' => $prevPeriod, 'source_channel' => ['search', 'paid_search'], 'per_page' => '']));
