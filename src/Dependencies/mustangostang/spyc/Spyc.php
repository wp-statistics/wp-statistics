...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return \WP_Statistics_Spyc::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_load_file')) {
  ...
  function spyc_load_file ($file) {
    return \WP_Statistics_Spyc::YAMLLoad($file);
  }
}
...
if (!function_exists('spyc_dump')) {
  ...
  function spyc_dump ($data) {
    return \WP_Statistics_Spyc::YAMLDump($data, false, false, true);
  }
}

if (!class_exists('WP_Statistics_Spyc')) {
...
/**
   ...
   * or:
   * <code>
   *   $array = \WP_Statistics_Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
 ...
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = \WP_Statistics_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = \WP_Statistics_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
