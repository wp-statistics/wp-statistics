...
class WP_Statistics_ParseTest extends PHPUnit_Framework_TestCase {
...
dog', $this->yaml['many_lines']);
    ...
    public function testKeysInMappedValueException() {
        ...
        \WP_Statistics_Spyc::YAMLLoad('x: y: z:');
    }
    ...
    public function testAngleQuotes() {
      $Quotes = \WP_Statistics_Spyc::YAMLLoad(__DIR__.'/quotes.yaml');
    ...
    public function testFailingColons() {
      $Failing = \WP_Statistics_Spyc::YAMLLoad(__DIR__.'/failing1.yaml');
    ...
    public function testMultipleArrays() {
      ...
      $this->assertSame($expected, \WP_Statistics_Spyc::YAMLLoad("- - - x"));
    }

    public function testElementWithEmptyHash()
    {
        $element = "hash: {}\narray: []";
        $yaml = \WP_Statistics_Spyc::YAMLLoadString($element);
