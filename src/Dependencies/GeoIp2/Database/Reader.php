 ...
 * {@link \WP_Statistics\Dependencies\GeoIp2\Exception\AddressNotFoundException} exception will be
 * thrown. If an invalid IP address is passed to one of the methods, a
 * SPL {@link \InvalidArgumentException} will be thrown. If the database is
 * corrupt or invalid, a {@link \WP_Statistics\Dependencies\MaxMind\Db\Reader\InvalidDatabaseException}
 * will be thrown.
 */
class Reader implements ProviderInterface
{
     ...
     *
     * @throws \WP_Statistics\Dependencies\GeoIp2\Exception\AddressNotFoundException  if the address is
     *                                                     not in the database
     * @throws \WP_Statistics\Dependencies\MaxMind\Db\Reader\InvalidDatabaseException if the database
     *                                                     is corrupt or invalid
     *
    ...
    private function getRecord($class, $type, $ipAddress)
    {
        ...
        if (!\is_array($record)) {
            ...
            // WP_Statistics\Dependencies\MaxMind\Db\Reader will throw a
            // WP_Statistics\Dependencies\MaxMind\Db\Reader\InvalidDatabaseException, but occasionally
