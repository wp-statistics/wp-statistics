...
/**
 * PSR-4 autoloader implementation for the WP_Statistics\Dependencies\DeviceDetector namespace.
...
{
    if (false === strpos($class, 'WP_Statistics\Dependencies\DeviceDetector\\')) {
        return;
    }

    $namespaceMap = ['WP_Statistics\Dependencies\DeviceDetector\\' => __DIR__ . '/'];
