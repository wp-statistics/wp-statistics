...
namespace WP_Statistics\Dependencies\DeviceDetector\Parser\Client;
...
use WP_Statistics\Dependencies\DeviceDetector\Parser\Client\Browser\Engine;
use WP_Statistics\Dependencies\DeviceDetector\Parser\Client\Hints\BrowserHints;
...
class Browser extends AbstractClientParser
{
    ...
    public function parse(): ?array
    {
        ...
        if (!empty($browserFromClientHints['name']) && !empty($browserFromClientHints['version'])) {
            ...
            // Fix mobile browser WP_Statistics_names e.g. Chrome => Chrome Mobile
