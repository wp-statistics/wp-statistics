...
export function wpI18n(options: { textDomain: string }): Plugin {
  return {
    ...
    closeBundle() {
      ...
      // You can use WP-CLI: wp i18n make-pot . languages/wp-statistics.pot --include="resources/react/src"
      // Or use gettext tools directly on the source files
      console.log(`\n✓ Build complete. To extract translations, run:`)
      console.log(`  wp i18n make-pot . languages/${options.textDomain}.pot --include="resources/react/src"\n`)
    },
  }
}
