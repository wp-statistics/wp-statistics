				...
				'attrs'         => array(
					array(
						...
						'options'     => array(
							...
							'searches'       => __( 'Searches', 'wp_statistics' ),
							'postcount'      => __( 'Post Count', 'wp_statistics' ),
							'pagecount'      => __( 'Page Count', 'wp_statistics' ),
							'commentcount'   => __( 'Comment Count', 'wp_statistics' ),
							'spamcount'      => __( 'Spam Count', 'wp_statistics' ),
							'usercount'      => __( 'User Count', 'wp_statistics' ),
							'postaverage'    => __( 'Post Average', 'wp_statistics' ),
							'commentaverage' => __( 'Comment Average', 'wp_statistics' ),
							'useraverage'    => __( 'User Average', 'wp_statistics' ),
							'lpd'            => __( 'Last Post Date', 'wp_statistics' ),
						),
					),
					array(
