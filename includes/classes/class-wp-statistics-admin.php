...
class WP_Statistics_Admin {
	...
	public function __construct() {
		...
		// Add privacy content in the Privacy Policy Guide page.
	...
	/**
	 *
	 * Register the WP-Statistics template for a privacy policy.
	 *
	...
	public function privacy_policy_template() {
		...
		$content = __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'wp-statistics' ) . "\n";

		wp_add_privacy_policy_content( 'WP Statistics', wpautop( $content ) );
	}
}