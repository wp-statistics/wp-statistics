...
class Admin_Assets
{
    ...
    public function admin_styles()
    {
        ...
        if (Menus::in_page('overview') || Menus::in_page('pages') || Menus::in_page('visitors') || Menus::in_page('geographic') || (in_array($screen_id, array('dashboard')) and !Option::get('disable_dashboard'))) {
