...
class Admin_Assets
{
    ...
    public function admin_scripts($hook)
    {
        ...
        // Load Packages
        wp_enqueue_script('chartjs-adapter-moment', self::url('../../assets/packages/chartjs/chart-matrix.min.js'), array('chartjs', 'momentjs'), '1.0.0', true);
        wp_enqueue_script('chartjs-matrix', self::url('../../assets/packages/chartjs/chart-matrix.min.js'), array('chartjs'), '1.2.0', true);
       
        // Load Admin Js
        wp_enqueue_script(self::$prefix, self::url('../../assets/js/admin.min.js'), array('chartjs', 'momentjs','chartjs-adapter-moment'), self::version(), ['in_footer' => true]);
