...
class Admin_Assets
{
    ...
    public function admin_styles()
    {
        ...
        // Load Select2
        if (Menus::in_page('visitors') || Menus::in_page('settings') || Menus::in_page('referrals') || Menus::in_page('link_tracker') || Menus::in_page('download_tracker') || Menus::in_page('pages')) {
