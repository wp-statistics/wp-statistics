<div class="wrap wps-wrap about-wrap full-width-layout">
    <div class="wp-statistics-welcome">
        ...
        <nav class="nav-tab-wrapper wp-clearfix" aria-label="wp-statistics-welcome-nav-tab">
            <a href="<?php echo add_query_arg('tab', 'whats-news', $pageUrl); ?>" class="nav-tab <?php echo((!isset($_GET['tab']) || (isset($_GET['tab']) and $_GET['tab'] == "whats-news")) ? "nav-tab-active" : ""); ?>" data-tab="whats-news"><?php _e('New Product', 'wp-statistics'); ?></a>
            <a href="<?php echo add_query_arg('tab', 'addons', $pageUrl); ?>" class="nav-tab <?php echo((isset($_GET['tab']) and $_GET['tab'] == "addons") ? "nav-tab-active" : ""); ?>" data-tab="addons"><?php _e('Add-Ons', 'wp-statistics'); ?></a>
            <a href="<?php echo add_query_arg('tab', 'credit', $pageUrl); ?>" class="nav-tab <?php echo((isset($_GET['tab']) and $_GET['tab'] == "credit") ? "nav-tab-active" : ""); ?>" data-tab="credit"><?php _e('Credits', 'wp-statistics'); ?></a>
            <a href="<?php echo add_query_arg('tab', 'changelog', $pageUrl); ?>" class="nav-tab <?php echo((isset($_GET['tab']) and $_GET['tab'] == "changelog") ? "nav-tab-active" : ""); ?>" data-tab="changelog"><?php _e('Changelog', 'wp-statistics'); ?></a>
