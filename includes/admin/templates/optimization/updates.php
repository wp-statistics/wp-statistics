            ...
            <table class="form-table">
                ...
                <tr valign="top" data-id="update_country_data_tr">
                    ...
                    <td>
                        ...
                        <button id="populate-submit-button" class="wps-button wps-button--danger-outline js-openModal-setting-confirmation" type="button" value="1" name="populate-submit"><?php esc_html_e('Refresh Country Data', 'wp-statistics'); ?></button>
            ...
            <table class="form-table">
                ...
                <tr valign="top" data-id="update_source_channel_data_tr">
                    ...
                    <td>
                        ...
                        <button class="wps-button wps-button--danger-outline js-openModal-setting-confirmation" type="button" value="1" name="populate-source-channel-submit"><?php esc_html_e('Update Source Channel', 'wp-statistics'); ?></button>
            ...
            <table class="form-table">
                ...
                <tr valign="top" data-id="convert_ip_addresses_to_hash_tr">
                    ...
                    <td>
                        ...
                        <button class="wps-button wps-button--danger-outline js-openModal-setting-confirmation" type="button" value="1" name="hash-ips-submit"><?php esc_html_e('Initiate Conversion', 'wp-statistics'); ?></button>
