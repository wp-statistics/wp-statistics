    ...
    <div class="postbox">
        <table class="form-table">
            ...
            <tr data-id="update_source_channel_data_tr">
                ...
                <td>
                    <button id="populate-source-channel-submit" class="wps-button wps-button--danger-outline js-openModal-setting-confirmation wps-mt-0" type="button" value="1" name="populate-source-channel-submit"><?php esc_html_e('Update Source Channel', 'wp-statistics'); ?></button>
    ...
    <div class="postbox">
        <table class="form-table">
            ...
            <tr data-id="convert_ip_addresses_to_hash_tr">
                ...
                <td>
                    <button id="hash-ips-submit" class="wps-button wps-button--danger-outline js-openModal-setting-confirmation wps-mt-0" type="button" value="1" name="hash-ips-submit"><?php esc_html_e('Initiate Conversion', 'wp-statistics'); ?></button>
