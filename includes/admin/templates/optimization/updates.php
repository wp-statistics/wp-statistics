                    ...
                    <tbody>
                        <tr valign="top">
                            <th scope="row" colspan="2">
                                <h3><?php _e('GeoLocation Settings', 'wp-statistics'); ?></h3>
                            </th>
                        </tr>
        ...
        <form action="<?php echo admin_url('admin.php?page=wps_optimization_page&tab=updates') ?>" method="post">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row" colspan="2">
                            <h3><?php _e('IP Address Management', 'wp-statistics'); ?></h3>
                        </th>
                    </tr>

                    <tr valign="top">
                        <th scope="row">
                            <label for="hash-ips-submit"><?php _e('Convert IP Addresses to Hash', 'wp-statistics'); ?></label>
                        </th>
