        ...
        <form action="<?php echo esc_url(admin_url('admin.php?page=wps_optimization_page&tab=updates')) ?>" method="post">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="hidden" id="populate-submit"  name="submit" value="1"/>
                        <button class="button button-primary" type="submit" value="1" name="populate-submit"><?php esc_html_e('Refresh Country Data', 'wp-statistics'); ?></button>
        ...
        <form action="<?php echo esc_url(admin_url('admin.php?page=wps_optimization_page&tab=updates')) ?>" method="post">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input id="populate-source-channel-submit" type="hidden" name="submit" value="1"/>
                        <button class="button button-primary" type="submit" value="1" name="populate-source-channel-submit"><?php esc_html_e('Update Source Channel', 'wp-statistics'); ?></button>
        ...
        <form action="<?php echo esc_url(admin_url('admin.php?page=wps_optimization_page&tab=updates')) ?>" method="post">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input id="hash-ips-submit" type="hidden" name="submit" value="1"/>
                        <button class="button button-primary" type="submit" value="1" name="hash-ips-submit" onclick="return confirm('<?php esc_html_e('This will replace all IP addresses in the database with hash values and cannot be undo, are you sure?', 'wp-statistics'); ?>')"><?php esc_html_e('Initiate Conversion', 'wp-statistics'); ?></button>
