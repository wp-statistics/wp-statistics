<div class="wps-adminHeader">
    <img class="wps-adminHeader__logo" src="<?php echo esc_url(WP_STATISTICS_URL . 'assets/images/white-header-icon.png'); ?>"/>

    <div class="wps-adminHeader__menuFlex">
        <a href="" class="wps-adminHeader__menuItem">
    ...
    <div class="wps-adminHeader__activation">
        <span></span>
        <?php _e('License Status: 1 0f 1 activated', 'wp-statistics'); ?>
    </div>
