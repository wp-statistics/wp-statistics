        ...
        <table class="form-table <?php echo !$isRealTimeStatsActive ? 'form-table--preview' : '' ?>">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description">
                        <?php echo esc_html(sprintf(__('Select \'Yes\' to exclude all posts from the real-time statistics. For detailed logs, ensure "Record User Page Visits" are activated in <a href="%s">WP Statistics Settings</a>.', 'wp-statistics'), admin_url('admin.php?page=wps_settings_page&tab=general-settings'))); ?>
                    </p>
                </td>
            </tr>
