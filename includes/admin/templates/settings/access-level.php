        ...
        <tbody>
            <tr valign="top">
                <th scope="row" colspan="2">
                    <h3><?php _e('Access Control', 'wp-statistics'); ?></h3>
                </th>
            </tr>
            <?php
            ...
            <tr valign="top">
                <th scope="row" colspan="2">
                    <p class="description"><?php echo sprintf(__('For a deeper understanding of user roles and capabilities in WordPress, you can refer to the <a target=_blank href="%s">WordPress Roles and Capabilities</a> page.', 'wp-statistics'), 'https://wordpress.org/support/article/roles-and-capabilities/'); ?></p>
