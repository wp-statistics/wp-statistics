    ...
    <table class="form-table">
        ...
        <tr data-id="views_column_user_list_tr" data-view="visitors_log_tr">
            ...
            <td>
                ...
                <p class="description"><?php esc_html_e('Display the "Views" column in the admin user list, showing the view count related to each logged-in WordPress user. Requires "Track Logged-In User Activity" to be enabled.', 'wp-statistics'); ?></p>
            </td>
        </tr>
...
<?php submit_button(__('Update', 'wp-statistics'), 'wps-button wps-button--primary', 'submit', '', array('id' => 'display_submit', 'OnClick' => "var wpsCurrentTab = getElementById('wps_current_tab'); wpsCurrentTab.value='display-settings'")); ?>
