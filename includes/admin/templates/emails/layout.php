...
// Set Title For Email
$site_name   = parse_url(get_site_url())['host'];
$email_title = apply_filters('wp_statistics_email_title', __('Email from', 'wp-statistics') . ' ' . $site_name);
...
$copyright = apply_filters('wp_statistics_email_footer_copyright', '<table role="presentation" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                        <tr>
                            <td class="content-block" style="color: #999999; font-size: 12px; padding-bottom: 10px; padding-top: 10px; text-align: center; vertical-align: top;">
                                <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Generated by: <a href="https://wp-statistics.com" style="color: #999999; font-size: 12px; text-align: center; text-decoration: underline;">WP Statistics</a></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>');
...
$advanced_reporting_ad = is_plugin_active('wp-statistics-advanced-reporting/wp-statistics-advanced-reporting.php') ? '' :
    '<div class="advanced-report-section" style="padding: 0;margin: 0;box-sizing: border-box;-webkit-font-smoothing: antialiased;border: 1px solid #979797;">
                                ...
                                <h3 style="padding: 0;margin: 30px auto 10px auto;box-sizing: border-box;-webkit-font-smoothing: antialiased;text-align: center;color: #4a4a4a;font-size: 16px;line-height: 1.6;font-weight: 700;">Are you looking for more reports with charts?</h3>
                                <p style="padding: 0;margin: auto;box-sizing: border-box;-webkit-font-smoothing: antialiased;color: #585858;text-align: center;line-height: 1.4;font-size: 14px;margin-bottom: 20px;max-width: 90%;">
                                    A summary of stats, hits, search engine referrals, top referrals,
                                    pages and more in your email!
                                </p>
                
                                <a target="_blank" href="https://wp-statistics.com/product/wp-statistics-advanced-reporting/" style="width: 225px;padding: 12px 10px;margin: 40px auto;box-sizing: border-box;-webkit-font-smoothing: antialiased;background-color: #404bf2;display: block;text-align: center;font-weight: 700;font-size: 14px;color: white;text-decoration: none;">Unlock Advanced Reporting</a>
                            </div>';
