<div class="postbox-container" id="wps-big-postbox">
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox" id="<?php echo esc_attr(\WP_STATISTICS\Meta_Box::getMetaBoxKey('top-pages-chart')); ?>">
                <div class="postbox-header postbox-toggle">
                    ...
                    <button class="handlediv" type="button" aria-expanded="true">
                        <span class="screen-reader-text"><?php printf(__('Toggle panel: Top 5 Trending Pages', 'wp-statistics')); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped	 ?></span>
...
<div class="postbox-container wps-postbox-full">
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox" id="<?php echo esc_html(\WP_STATISTICS\Meta_Box::getMetaBoxKey('pages')); ?>">
                <div class="postbox-header postbox-toggle">
                    <h2 class="hndle wps-d-inline-block"><span><?php echo esc_attr($title); ?></span></h2>
                    <button class="handlediv" type="button" aria-expanded="true">
                        <span class="screen-reader-text"><?php printf(__('Toggle panel: %s', 'wp-statistics'), esc_attr($title)); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped	 ?></span>
                        <span class="toggle-indicator" aria-hidden="true"></span>
                    </button>
                </div>
                <div class="inside">
                    ...
                    <?php
                    if (empty($lists)) {
                        echo '<div class="o-wrap o-wrap--no-data">'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped	
                        esc_html_e('No recent data available.', 'wp-statistics'); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped	
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <a href="<?php echo esc_url($li['hits_page']); ?>">
                                                <?php printf(__('View analytics | %s visits'), esc_html($li['number'])) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped	 ?>
