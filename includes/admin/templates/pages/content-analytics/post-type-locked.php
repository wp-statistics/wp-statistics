<div class="wps-premium-box-feature">
    ...
    <a target="_blank" class="button button-primary" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/product/wp-statistics-data-plus?utm_source=wp-statistics&utm_medium=link&utm_campaign=dp-content-analytics'); ?>">
        <?php echo esc_html__('Upgrade Now.', 'wp-statistics') ?>
    </a>
</div>
<div class="wps-premium-box-image">
    <img  src="<?php echo esc_url(WP_STATISTICS_URL . 'assets/images/content.png'); ?>"/>
</div>