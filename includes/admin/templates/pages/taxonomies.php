            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <table class="widefat table-stats wps-summary-stats" id="summary-stats">
                        ...
                        <tr>
                            <th></th>
                            <th width="15%"><?php _e('Count', 'wp-statistics'); ?></th>
                        </tr>
                        ...
                        <?php } else { ?>
                            <div id="wp-statistics-pages-widget">
                                <table width="100%" class="o-table">
                                    <tbody>
                                    <tr>
                                        <td width='5%'><?php _e('ID', 'wp-statistics'); ?></td>
                                        <td><?php _e('Title', 'wp-statistics'); ?></td>
                                        <td width='15%'><?php _e('Visits', 'wp-statistics'); ?></td>
                                    </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left">
                                                <a href="<?php echo esc_url($hitsPage); ?>">
                                                    <?php printf(__('View analytics | %s visits'), $item['count_visit']) ?>
