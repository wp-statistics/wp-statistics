                                ...
                                <thead>
                                    <tr>
                                        <th class="wps-pd-l">
                                            ...
                                            <span class="wps-tooltip" title="OS Tooltip"><i class="wps-tooltip-icon info"></i></span>
                                        </th>
                                        <th class="wps-pd-l">
                                ...
                                <tbody>
                                    <?php foreach ($data['visitors'] as $item) : ?>
                                        <tr>
                                            ...
                                            <td class="view-more">
                                                <a target="_blank" href="<?php echo esc_url(Menus::admin_url('devices', ['type' => 'single-platform', 'platform' => $item->platform])); ?>" title="<?php esc_html_e('View Details', 'wp-statistics'); ?>">
