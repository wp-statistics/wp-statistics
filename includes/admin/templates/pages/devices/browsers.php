                                ...
                                <thead>
                                    <tr>
                                        <th class="wps-pd-l">
                                            ...
                                            <span class="wps-tooltip" title="Browser Tooltip"><i class="wps-tooltip-icon info"></i></span>
                                        </th>
                                        <th class="wps-pd-l">
                                ...
                                <tbody>
                                    <?php foreach ($data['visitors'] as $item) : ?>
                                        <tr>
                                            ...
                                            <td class="view-more">
                                                <a target="_blank" href="<?php echo esc_url(Menus::admin_url('devices', ['type' => 'single-browser', 'browser' => $item->agent])); ?>" title="<?php esc_html_e('View Details', 'wp-statistics'); ?>">
