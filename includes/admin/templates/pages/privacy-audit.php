<div class="wps-privacy-audit">
    ...
    Admin_Template::get_template(array('layout/info-box', 'layout/privacy-audit/compliance-status', 'layout/privacy-audit/privacy-audits', 'layout/privacy-audit/privacy-faqs'), $args);
    ?>
</div>
