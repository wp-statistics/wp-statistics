<div class="wps-privacy-audit">
    ...
    Admin_Template::get_template(array('layout/info-box', 'layout/privacy-audit/privacy-status', 'layout/privacy-audit/privacy-monitor', 'layout/privacy-audit/privacy-info'), $args);
    ?>
</div>
