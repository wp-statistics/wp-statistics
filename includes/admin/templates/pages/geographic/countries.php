                                    ...
                                    <?php foreach ($data['countries'] as $item) : ?>
                                        <tr>
                                            ...
                                            <td class="-table__cell o-table__cell--right view-more">
                                                <a href="<?php echo esc_url(Menus::admin_url('geographic', ['type' => 'single-country', 'country' => $item->country, 'from' => \WP_Statistics\Utils\Request::get('from', date('Y-m-d', strtotime('-29 days'))), 'to' => \WP_Statistics\Utils\Request::get('to', date('Y-m-d'))])) ?>" title="<?php esc_html_e('View Details', 'wp-statistics'); ?>">
