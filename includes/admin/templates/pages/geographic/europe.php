                                    ...
                                    <?php foreach ($data['countries'] as $item) : ?>
                                        <tr>
                                            ...
                                            <td class="-table__cell o-table__cell--right view-more">
                                                <a href="<?php echo esc_url(add_query_arg(['type' => 'single-country', 'country' => $item->country], \WP_STATISTICS\Menus::admin_url('geographic'))) ?>" title="<?php esc_html_e('View Details', 'wp-statistics'); ?>">
