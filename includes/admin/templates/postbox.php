<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        <div id="wps-plugins-support" class="postbox">
            <h2 class="hndle"><span><?php esc_html_e('Stay Connected', 'wp-statistics'); ?></span></h2>

            <div class="inside">
                <form action="https://dashboard.mailerlite.com/forms/421827/86962232715379904/share" method="get" target="_blank" novalidate>
                    <p><?php esc_html_e('Subscribe to our newsletter and be the first to know about new updates and features.', 'wp-statistics'); ?></p>
                    <input name="fields[email]" type="email" class="ltr" value="<?php bloginfo('admin_email'); ?>">
                    <input type="hidden" name="ml-submit" value="1">
                    <input type="hidden" name="anticsrf" value="true">
                    <input type="submit" value="<?php esc_html_e('Subscribe', 'wp-statistics'); ?>" name="subscribe" class="button">
                </form>
            </div>
        </div>
    </div>
