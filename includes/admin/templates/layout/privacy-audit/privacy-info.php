    ...
    <div class="postbox-container wps-half-card">
        <div class="postbox wps-postbox-wrap wps-privacy-questions">
            ...
            <div class="wps-privacy-list__items">
                ...
                // Item 1
                $question1 = esc_html__('Does WP Statistics require consent?', 'wp-statistics');
                $summary1  = esc_html__('User Consent Not Required.', 'wp-statistics');
                ...
                Admin_Template::get_template(array('layout/privacy-audit/faq-section'), $args1);

                // Item 2
                $question2 = esc_html__('Does WP Statistics require consent?', 'wp-statistics');
                $summary2  = esc_html__('User Consent Required.', 'wp-statistics');
                $content2  = __('<p>Your current settings indicate that WP Statistics is configured to collect personal data. In this case, it is essential to obtain user consent to comply with privacy laws and regulations. For detailed information on which settings may necessitate user consent and how to adjust them, please refer to the <b>Privacy Audit</b> section of this page.</p>', 'wp-statistics');
                $args2     = array(
                    'type_class'    => 'warning',
