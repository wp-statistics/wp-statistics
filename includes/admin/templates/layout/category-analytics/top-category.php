                        ...
                        foreach ($data['top_viewing'] as $post) : ?>
                            <a class="wps-category-tabs__item" href="<?php echo esc_url(Menus::admin_url('content-analytics', ['type' => 'single', 'post_id' => $post->ID])) ?>">
                                ...
                                <div class="wps-category-tabs__item--content">
                                    ...
                                    <span><?php echo esc_html(Helper::formatNumberWithUnit($post->views)); ?><?php esc_html_e('pageviews', 'wp-statistics') ?></span>
                                </div>
                            </a>
                            <?php $counter++;
                        endforeach;
                    ...
                    if (!empty($data['recent'])) {
                        ...
                        foreach ($data['recent'] as $post) : ?>
                            <a class="wps-category-tabs__item" href="<?php echo esc_url(add_query_arg(['type' => 'single', 'post_id' => $post->ID])) ?>">
                                ...
                                <div class="wps-category-tabs__item--content">
                                    <h3 class="wps-ellipsis-parent"><span class="wps-ellipsis-text"><?php echo esc_html($post->post_title); ?></span></h3>
                                    <span><?php echo esc_html(Helper::formatNumberWithUnit($post->views)); ?><?php esc_html_e('published contents', 'wp-statistics') ?></span>
                                </div>
                            </a>
                            <?php $counter++;
                        endforeach;
