                            ...
                            <?php foreach ($terms as $term) : ?>
                                <a class="wps-tabs-item" href="<?php echo esc_url(Menus::admin_url('category-analytics', ['type' => 'single', 'term_id' => $term['term_id']])) ?>">
                                    <div class="wps-content-tabs__item--content">
                                        ...
                                        <span><span class="wps-content-tabs__item--count"><?php /* translators: %s: string value */ echo esc_html($term['posts_count']); ?></span><?php echo sprintf(esc_html__('published %s', 'wp-statistics'), strtolower($postType)) ?></span>; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    </div>
                                </a>
                            <?php endforeach; ?>
                        </div>
