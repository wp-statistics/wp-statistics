...
<div class="wps-content-analytics-header">
    ...
    <div>
        ...
        <div class="wps-content-analytics-header__info">
            ...
            <?php if (!empty(get_the_modified_date('Y-m-d', $postId))) : ?>
                <span class="wps-content-analytics-header__date_updated"><span><?php  echo esc_html__('Updated on: ', 'wp-statistics') ?></span><?php get_the_modified_date(Helper::getDefaultDateFormat(true), $postId) ?></span>
            <?php endif; ?>
