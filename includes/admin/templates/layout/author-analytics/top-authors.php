<div class="wps-card">
                    ...
                    foreach ($users as $name => $pageviews) : ?>
                        <a class="wps-author-tabs__item" href="<?php echo esc_url(admin_url('admin.php?page=wps_author-analytics_page&author_id=1')); ?>">
                            ...
                            <div class="wps-author-tabs__item--content">
                                ...
                                <span><?php echo esc_html($pageviews); ?> <?php esc_html_e('page views', 'wp-statistics') ?></span>
                            </div>
                        </a>
                        <?php $counter++;?>
                    <?php endforeach; ?>
                ...
                <div class="wps-author-tabs__content">
                    ...
                    foreach ($users as $name => $pageviews) : ?>
                        <a class="wps-author-tabs__item" href="">
                            ...
                            <div class="wps-author-tabs__item--content">
                                <h3><?php echo esc_html($name); ?></h3>
                                <span><?php echo esc_html($pageviews); ?> <?php esc_html_e('page publish', 'wp-statistics') ?></span>
                            </div>
                        </a>
                        <?php $counter++;?>
                    <?php endforeach; ?>
                ...
                <div class="wps-author-tabs__content">
                    ...
                    foreach ($users as $name => $pageviews) : ?>
                        <a class="wps-author-tabs__item" href="">
                            ...
                            <div class="wps-author-tabs__item--content">
                                <h3><?php echo esc_html($name); ?></h3>
                                <span><?php echo esc_html($pageviews) . ' ' . esc_html__('comments/post', 'wp-statistics'); ?> </span>
                            </div>
                        </a>
                        <?php $counter++;?>
                    <?php endforeach; ?>
                ...
                <div class="wps-author-tabs__content">
                    ...
                    foreach ($users as $name => $pageviews) : ?>
                        <a class="wps-author-tabs__item" href="">
                            ...
                            <div class="wps-author-tabs__item--content">
                                <h3><?php echo esc_html($name); ?></h3>
                                <span><?php echo esc_html($pageviews); ?> <?php esc_html_e('views/post', 'wp-statistics') ?></span>
                            </div>
                        </a>
                        <?php $counter++;?>
                    <?php endforeach; ?>
                ...
                <div class="wps-author-tabs__content">
                    ...
                    foreach ($users as $name => $pageviews) : ?>
                        <a class="wps-author-tabs__item" href="">
                            ...
                            <div class="wps-author-tabs__item--content">
                                <h3><?php echo esc_html($name); ?></h3>
                                <span><?php echo esc_html($pageviews); ?> <?php esc_html_e('words/post', 'wp-statistics') ?></span>
                            </div>
                        </a>
                        <?php $counter++;?>
                    <?php endforeach; ?>
    ...
    <div class="c-footer">
        <div class="c-footer__more">
            <a href="<?php echo esc_url(admin_url('admin.php?page=wps_author-analytics_page&report=authors')); ?>" class="c-footer__more__link" title="<?php esc_html_e('See all authors', 'wp-statistics') ?>"><?php esc_html_e('See all authors', 'wp-statistics') ?></a>
        </div>
    </div>
</div>