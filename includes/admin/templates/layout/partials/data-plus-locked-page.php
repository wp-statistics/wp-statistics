<div class="wps-premium-box-feature">
    ...
    <a data-target="wp-statistics-data-plus" class="wps-show-premium-modal js-wps-openPremiumModal button button-primary" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/product/wp-statistics-data-plus?utm_source=wp-statistics&utm_medium=link&utm_campaign=dp-'.$campaign); ?>">
