...
<div class="wrap">
    ...
    <div><?php wp_statistics_date_range_selector( WP_STATISTICS_TOP_SEARCHED_PHRASES, $daysToDisplay, null, null, $phrase_field ); ?></div>
    ...
    <ul class="subsubsub">
		<?php if ( $phrase ) { ?>
            <li class="all"><a <?php if ( ! $phrase ) {
					echo 'class="current"';
				} ?>href="?page=<?php echo WP_STATISTICS_TOP_SEARCHED_PHRASES . $date_args; ?>"><?php _e( 'All', 'wp-statistics' ); ?></a>
            </li>
            |
            <li>
                <a class="current" href="?page=<?php echo WP_STATISTICS_TOP_SEARCHED_PHRASES; ?>&referr=<?php echo esc_html( $phrase ) . $date_args; ?>"> <?php echo htmlentities( $title, ENT_QUOTES ); ?>
                    <span class="count">(<?php echo $total; ?>)</span></a></li>
		<?php } else { ?>
            <li class="all"><a <?php if ( ! $phrase ) {
					echo 'class="current"';
				} ?>href="?page=<?php echo WP_STATISTICS_TOP_SEARCHED_PHRASES . $date_args; ?>"><?php _e( 'All', 'wp-statistics' ); ?>
                    <span class="count">(<?php echo $total; ?>)</span></a></li>
		<?php } ?>
    </ul>
