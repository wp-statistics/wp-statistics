...
?>
				<div class="postbox">
					...
					<div class="inside">
						...
						<div>
							<br/><?php echo sprintf(__('This product includes GeoLite2 data created by MaxMind, available from %s.', 'wp_statistics'), '<a href="http://www.maxmind.com" target=_blank>http://www.maxmind.com</a>'); ?>
						</div>
					</div>
				</div>
<?php		
