...
// TODO: Optimize this function
    ...
    public static function send_mail($to, $subject, $content, $email_template = true, $args = array())
    {
        ...
        $emailTitle = sprintf(
            __('<span style="font-family: \'Roboto\', Arial, Helvetica, sans-serif;'.$title_style.'">Sent from </span><a style="color: #175DA4;text-decoration: underline" href="https://%1$s">%1$s</a>', 'wp-statistics'),
