...
class License
{
    ...
    public static function is_request($type)
    {
        switch ($type) {
            case 'admin':
                return \WP_STATISTICS\is_admin();
            case 'ajax':
                return defined('DOING_AJAX');
            case 'cron':
                return defined('DOING_CRON');
            case 'wp-cli':
                return defined('WP_CLI') && \WP_STATISTICS\WP_CLI;
            case 'frontend':
                return (!\WP_STATISTICS\is_admin() || defined('DOING_AJAX')) && !defined('DOING_CRON') && !self::is_rest_request();
        }
    }
    ...
    public static function is_login_page()
    {
        ...
        if (defined('WP_CLI') && \WP_STATISTICS\WP_CLI) {
            return false;
        }
    ...
    public static function is_active_cache_plugin()
    {
        ...
        return \WP_STATISTICS\apply_filters('wp_statistics_cache_status', $use);
    }
    ...
    public static function is_gutenberg()
    {
        ...
        return ((method_exists($current_screen, 'is_block_editor') && $current_screen->is_block_editor()) || (function_exists('is_gutenberg_page')) && \WP_STATISTICS\is_gutenberg_page());
    }
    ...
    {
        return \WP_STATISTICS\get_bloginfo('version');
    }
    ...
    public static function get_site_title_by_url($url)
    {
        ...
        //Get Body Page
        $html = License::get_html_page($url);
        if ($html === false) {
            return false;
        }
    ...
    {
        $first_day = License::get_date_install_plugin();
        return ($first_day === false ? 30 : (int)\WP_STATISTICS\TimeZone::getNumberDayBetween($first_day));
    }
    ...
    public static function send_mail($to, $subject, $content, $email_template = true, $args = array())
    {
        ...
        // Email from
        $from_name  = \WP_STATISTICS\get_bloginfo('name');
        $from_email = \WP_STATISTICS\get_bloginfo('admin_email');
        ...
        $template_arg = array(
            ...
            'logo'        => '',
            'content'     => $content,
            'site_url'    => \WP_STATISTICS\home_url(),
            'site_title'  => \WP_STATISTICS\get_bloginfo('name'),
            'footer_text' => '',
    ...
    {
        $taxonomies = array('category' => \WP_STATISTICS\__("Category", "wp-statistics"), "post_tag" => \WP_STATISTICS\__("Tags", "wp-statistics"));
    ...
    public static function getLastPostDate()
    {
        ...
        $date_format = \WP_STATISTICS\get_option('date_format');
    ...
    public static function displayAdminNotices()
    {
        foreach ((array)self::$admin_notices as $notice) :
            ...
            <div class="notice notice-<?php echo \WP_STATISTICS\esc_attr($notice['class']); ?> <?php echo \WP_STATISTICS\esc_attr($dismissible); ?>">
                <p>
    ...
    public static function getHitsDefaultParams()
    {
        ...
        //track all page
        $params['track_all'] = (\WP_STATISTICS\Pages::is_track_all_page() === true ? 1 : 0);
        ...
        //page url
        $params['page_uri'] = \WP_STATISTICS\Pages::get_page_uri();

        //Get User id
        $params['user_id'] = \WP_STATISTICS\User::get_user_id();
