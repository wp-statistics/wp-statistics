        ...
        <table width="100%" class="o-table wps-new-table">
            ...
            foreach ($data as $item) :
                ...
                <tr>
                    ...
                    <td class="wps-pd-l wps-middle-vertical"><a href="<?php echo esc_url(Menus::admin_url('visitors', ['location' => $item->country, 'from' => $filters['date']['from'], 'to' => $filters['date']['to']])) ?>" target="_blank"><?php echo esc_html($item->visitors) ?></a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
