            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="<?php echo Menus::admin_url('visitors', array_merge(['tab' => 'visitors'], DateRange::get($key))); ?>"><span class="quickstats-values" title="<?php echo esc_html($visitors); ?>"><?php echo esc_html(Helper::formatNumberWithUnit($visitors, 1)) ?></span></a></td>
                        <td><a href="<?php echo Menus::admin_url('visitors', array_merge(['tab' => 'views'], DateRange::get($key))); ?>"><span class="quickstats-values" title="<?php echo esc_html($hits); ?>"><?php echo esc_html(Helper::formatNumberWithUnit($hits, 1)) ?></span></a></td>
                    </tr>
                <?php endfor; ?>
            </tbody>
        </table>
