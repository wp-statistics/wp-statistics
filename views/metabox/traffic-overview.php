        ...
        <table width="100%" class="o-table o-table--wps-summary-stats">
            ...
            <?php foreach ($data['summary'] as $key => $item) :
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <a href="<?php echo esc_url(Menus::admin_url('visitors', array_merge(['tab' => 'visitors'], $item['date']))) ?>"><span class="quickstats-values" title="<?php echo esc_attr($itemData['current']['visitors']); ?>"><?php echo esc_html(Helper::formatNumberWithUnit($itemData['current']['visitors'], 1)) ?></span></a>
                    ...
                    <td>
                        <div>
                            <a href="<?php echo esc_url(Menus::admin_url('visitors', array_merge(['tab' => 'views'], $item['date']))) ?>"><span class="quickstats-values" title="<?php echo esc_attr($itemData['current']['views']); ?>"><?php echo esc_html(Helper::formatNumberWithUnit($itemData['current']['views'], 1)) ?></span></a>
