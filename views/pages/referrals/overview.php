...
<div class="metabox-holder wps-referral-overview">
    <div class="postbox-container" id="wps-postbox-container-1">
        ...
        View::load("components/charts/horizontal-bar", $topCountries);

        $topBrowser = [
            'title'     => esc_html__('Top Browsers', 'wp-statistics'),
            'unique_id' => 'referral-top-browser'
        ];
        View::load("components/charts/horizontal-bar", $topBrowser);

        $deviceType = [
            'title'     => esc_html__('Device Type', 'wp-statistics'),
            'unique_id' => 'referral-device-type'
        ];
        View::load("components/charts/horizontal-bar", $deviceType);
    ...
    <div class="postbox-container" id="wps-postbox-container-2">
        ...
        View::load("components/charts/top-referrer", $visitor);
        ?>

        <div class="wps-card">
            <div class="wps-card__title">
                <h2>
                    <?php esc_html_e('Top Source Categories', 'wp-statistics') ?>
                </h2>
            </div>
        ...
        View::load("components/charts/top-referrer", $engines);
        ...
        View::load("components/charts/top-referrer", $socials);
        ?>

        <div class="wps-card">
            <div class="wps-card__title">
                <h2>
                    <?php esc_html_e('Latest Referrals', 'wp-statistics') ?>
                </h2>
            </div>
            <?php
