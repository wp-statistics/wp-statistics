...
<div class="wps-wrap__main">
    ...
    <div class="wps-lock-page wps-lock-page--container">
        ...
        <div class="wps-lock-page__actions">
            <a target="_blank" class="wps-lock-page__action wps-lock-page__action--premium" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/pricing?utm_source=wp-statistics&utm_medium=link&utm_campaign=dp-' . $campaign) ?>">
                <?php echo $premium_btn_title; ?>
            </a>
            <a data-target="<?php echo $addon_slug ?>" class="wps-lock-page__action wps-lock-page__action--learn-more js-wps-openPremiumModal"><?php echo $more_title ?></a>
        </div>
