<div class="wps-wrap__main">
    ...
    <div class="wps-lock-page wps-lock-page--container">
        ...
        <div class="wps-lock-page__actions">
            <a target="_blank" class="wps-lock-page__action wps-lock-page__action--premium" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/product/'.$addon_slug.'?utm_source=wp-statistics&utm_medium=link&utm_campaign=dp-'.$campaign); ?>">
