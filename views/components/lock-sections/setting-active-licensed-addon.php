...
<div class="wps-premium-feature__info wps-premium-feature__info--premium-user">
     <?php /* translators: %s: string value */ echo sprintf(esc_attr__('Your license includes the %s, but it’s not installed yet. Go to the Add-ons page to install and activate it, so you can start using all its features.', 'wp-statistics'),esc_html($addon_title)); ?>
</div>
