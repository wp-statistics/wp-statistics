...
<div class="wps-premium-feature__buttons">
    <a class="button button-primary" target="_blank" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/pricing?utm_source=wp-statistics&utm_medium=link&utm_campaign='. esc_html($campaign)) ?>"><?php esc_html_e('Unlock Everything with Premium', 'wp-statistics') ?></a>
