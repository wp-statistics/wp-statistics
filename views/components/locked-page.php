<div class="wps-premium-box-feature">
    ...
    <a class="button button-primary" target="_blank" href="<?php echo esc_url(WP_STATISTICS_SITE_URL . '/add-ons/wp-statistics-data-plus/?utm_source=wp-statistics&utm_medium=link&utm_campaign=dp-'.$campaign); ?>">
        <?php echo esc_html__('Upgrade Now.', 'wp-statistics'); ?>
    </a>
</div>
<div class="wps-premium-box-image">
    <img alt="<?php echo esc_html__('DataPlus features', 'wp-statistics'); ?>" src="<?php echo esc_url(WP_STATISTICS_URL . $src); ?>"/>
</div>