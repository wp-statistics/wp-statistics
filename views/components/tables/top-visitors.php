                            ...
                            <td class="wps-pd-l">
                                ...
                                if (!empty($page)) :?>
                                    <div class="wps-entry-page">
                                        ...
                                        <?php if ($campaign) : ?>
                                            <span class="wps-campaign-label wps-tooltip" title="<?php echo esc_attr__('Campaign:', 'wp-statistics') . ' ' . esc_attr(Helper::plainText($campaign)); ?>"><?php echo esc_html(Helper::plainText($campaign)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php
                                else :
