...
<div class="wps-audit-card__suggestion wps-mb-16">
    ...
    <div class="wps-audit-card__suggestion-text">
        <?php echo esc_html__('WP Statistics distinguishes itself by utilizing a cookieless tracking mechanism. This means the plugin can provide accurate analytics insights without storing any data on visitors’ devices, thereby respecting user privacy and reducing regulatory burdens for website owners.') ?>
    </div>
</div>
