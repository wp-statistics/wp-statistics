...
<div class="wps-audit-card__suggestion wps-mb-16">
    ...
    <div class="wps-audit-card__suggestion-text">
        <ol>
            <li><?php echo wp_kses_post(__('<b>Privacy Risks:</b> Without anonymization, IP addresses are considered Personally Identifiable Information (PII) and could pose privacy risks to your users.', 'wp-statistics')) ?></li>
            <li><?php echo wp_kses_post(__('<b>Legal Compliance:</b> Storing complete IP addresses may affect your compliance with privacy laws such as GDPR, requiring careful consideration and potentially additional safeguards.', 'wp-statistics')) ?></li>
        </ol>
    </div>
</div>
<div class="wps-audit-card__suggestion wps-mb-16">
