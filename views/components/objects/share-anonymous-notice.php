...
$activationTime = Option::get('activation_time');

if (!Option::get('share_anonymous_data') && !in_array('share_anonymous_data', get_option('wp_statistics_dismissed_notices', [])) && (time() > $activationTime + 7 * DAY_IN_SECONDS)) {
    $notice = [
