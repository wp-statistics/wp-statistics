...
<div class="wps-author-analytics--header">
    ...
    <div class="wps-author-analytics--header__desc">
        ...
        <div class="wps-author-analytics--header__info">
            ...
            <a href="<?php echo Menus::admin_url('pages', ['tab' => 'top', 'author_id' => $authorId, 'pt' => 'post']); ?>"><?php echo esc_html__('View Author Posts', 'wp-statistics') ?></a>; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
