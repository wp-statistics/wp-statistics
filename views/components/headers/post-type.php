...
<div class="wps-content-analytics-header">
    ...
    <div>
        <div class="wps-content-analytics-header__title">
            ...
            <a href="<?php echo get_the_permalink($postId) ?>" target="_blank" title="<?php echo get_the_title($postId) ?>"></a>
        </div>
        <div class="wps-content-analytics-header__info">
            <!-- @todo add custom classes -->
            <!-- <span class="wps-content-analytics-header__type wps-content-analytics-header__type--custom">--><?php //echo esc_html($postTypeSingular) ?><!--</span>-->
            <!-- <span class="wps-content-analytics-header__type wps-content-analytics-header__type--page">--><?php //echo esc_html($postTypeSingular) ?><!--</span>-->
            <span class="wps-content-analytics-header__type wps-content-analytics-header__type--post"><?php echo esc_html($postTypeSingular) ?></span>
            ...
            <span class="wps-content-analytics-header__author">
                <span><?php echo esc_html__('Author:', 'wp-statistics') ?></span> <a href="<?php echo Menus::admin_url('author-analytics', ['type' => 'single-author', 'author_id' => $postAuthor]) ?>"><?php echo get_the_author_meta('display_name', $postAuthor) ?></a>
            </span>
        </div>
        <div class="wps-content-analytics-header__tags">
            ...
            <!-- @todo should add a condition and link -->
            <a href="" class="wps-content-analytics-header__tags--more"><?php echo esc_html__('Show more', 'wp-statistics') ?></a>
        </div>
    </div>
</div>