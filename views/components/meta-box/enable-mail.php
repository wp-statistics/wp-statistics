...
<div class="wp-quickstats-widget__enable-email">
    <div class="wp-quickstats-widget__enable-email__desc"><span class="wp-quickstats-widget__enable-email__icon"></span>
        <div>
            ...
            <a href="<?php echo esc_url(Menus::admin_url('settings', ['tab' => 'notifications-settings'])) ?>" aria-label="<?php esc_attr_e('Enable Now', 'wp-statistics'); ?>"><?php esc_html_e('Enable Now', 'wp-statistics'); ?></a>
        </div>
    </div>
