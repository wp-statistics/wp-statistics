...
<div class="wps-addon__download__item">
    ...
    <div class="wps-addon__download__item--actions">
        <?php if (!$addOn->isInstalled() || $addOn->isUpdateAvailable()) : ?>
            ...
            <a class="wps-postbox-addon__button button-retry-addon-download" href="#" data-slug="<?php echo esc_attr($addOn->getSlug()); ?>" title="<?php esc_html_e('Retry', 'wp-statistics'); ?>"><?php esc_html_e('Retry', 'wp-statistics'); ?></a>
        ...
        <?php elseif ($addOn->isInstalled()) : ?>
            <a class="wps-postbox-addon__button button-activate-addon" href="#" data-slug="<?php echo esc_attr($addOn->getSlug()); ?>" title="<?php esc_html_e('Active', 'wp-statistics'); ?>"><?php esc_html_e('Active', 'wp-statistics'); ?></a>
        <?php endif; ?>
